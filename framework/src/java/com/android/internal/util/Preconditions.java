...
public class Preconditions {
    ...
    public static void checkCallAuthorization(boolean z, java.lang.String str, java.lang.Object... objArr) {
        if (!z) {
    ...
    public static float[] checkArrayElementsInRange(float[] fArr, float f, float f2, java.lang.String str) {
        ...
        for (int i = 0; i < fArr.length; i++) {
            ...
            if (java.lang.Float.isNaN(f3)) {
                throw new java.lang.IllegalArgumentException(str + android.inputmethodservice.navigationbar.NavigationBarInflaterView.SIZE_MOD_START + i + "] must not be NaN");
            }
            if (f3 < f) {
