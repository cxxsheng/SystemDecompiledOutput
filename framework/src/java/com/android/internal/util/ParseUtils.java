...
public final class ParseUtils {
    ...
    public static int parseIntWithBase(java.lang.String str, int i, int i2) {
        if (str == null) {
            return i2;
        }
        try {
    ...
    public static long parseLongWithBase(java.lang.String str, int i, long j) {
        if (str == null) {
            return j;
        }
        try {
    ...
    public static float parseFloat(java.lang.String str, float f) {
        if (str == null) {
            return f;
        }
        try {
    ...
    public static double parseDouble(java.lang.String str, double d) {
        if (str == null) {
            return d;
        }
        try {
