...
public class ConcurrentUtils {
    public static final java.util.concurrent.Executor DIRECT_EXECUTOR = new com.android.internal.util.ConcurrentUtils.DirectExecutor();

    private ConcurrentUtils() {
    }

    public static java.util.concurrent.ExecutorService newFixedThreadPool(int i, final java.lang.String str, final int i2) {
        return java.util.concurrent.Executors.newFixedThreadPool(i, new java.util.concurrent.ThreadFactory() { // from class: com.android.internal.util.ConcurrentUtils.1
            ...
            public java.lang.Thread newThread(final java.lang.Runnable runnable) {
                return new java.lang.Thread(str + this.threadNum.incrementAndGet()) { // from class: com.android.internal.util.ConcurrentUtils.1.1
