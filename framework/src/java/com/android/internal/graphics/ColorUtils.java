...
public final class ColorUtils {
    ...
    public static int calculateMinimumBackgroundAlpha(int i, int i2, float f) {
        ...
        return binaryAlphaSearch(i, alphaComponent, f, new com.android.internal.graphics.ColorUtils.ContrastCalculator() { // from class: com.android.internal.graphics.ColorUtils$$ExternalSyntheticLambda1
            ...
            public final double calculateContrast(int i3, int i4, int i5) {
                ...
                calculateContrast = com.android.internal.graphics.ColorUtils.calculateContrast(i3, com.android.internal.graphics.ColorUtils.setAlphaComponent(com.android.internal.graphics.ColorUtils.blendARGB(alphaComponent2, i4, i5 / 255.0f), 255));
    ...
    public static int calculateMinimumAlpha(int i, int i2, float f) {
        ...
        com.android.internal.graphics.ColorUtils.ContrastCalculator contrastCalculator = new com.android.internal.graphics.ColorUtils.ContrastCalculator() { // from class: com.android.internal.graphics.ColorUtils$$ExternalSyntheticLambda0
            @Override // com.android.internal.graphics.ColorUtils.ContrastCalculator
            public final double calculateContrast(int i3, int i4, int i5) {
                double calculateContrast;
                calculateContrast = com.android.internal.graphics.ColorUtils.calculateContrast(com.android.internal.graphics.ColorUtils.setAlphaComponent(i3, i5), i4);
                return calculateContrast;
            }
        };
    ...
    private static int binaryAlphaSearch(int i, int i2, float f, com.android.internal.graphics.ColorUtils.ContrastCalculator contrastCalculator) {
        int i3 = 255;
        int i4 = 0;
    ...
    public static com.android.internal.graphics.cam.Cam colorToCAM(int i) {
        return com.android.internal.graphics.cam.Cam.fromInt(i);
    }

    public static int CAMToColor(float f, float f2, float f3) {
        return com.android.internal.graphics.cam.Cam.getInt(f, f2, f3);
    }
