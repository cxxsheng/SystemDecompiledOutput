...
public interface IResultReceiver extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements com.android.internal.os.IResultReceiver {
        ...
        public static com.android.internal.os.IResultReceiver asInterface(android.os.IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            android.os.IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof com.android.internal.os.IResultReceiver)) {
                return (com.android.internal.os.IResultReceiver) queryLocalInterface;
            }
            return new com.android.internal.os.IResultReceiver.Stub.Proxy(iBinder);
        }
        ...
        private static class Proxy implements com.android.internal.os.IResultReceiver {
            ...
            public java.lang.String getInterfaceDescriptor() {
                return com.android.internal.os.IResultReceiver.Stub.DESCRIPTOR;
            }
            ...
            public void send(int i, android.os.Bundle bundle) throws android.os.RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(com.android.internal.os.IResultReceiver.Stub.DESCRIPTOR);
                    obtain.writeInt(i);
