...
public class SHA1Digest extends com.android.internal.org.bouncycastle.crypto.digests.GeneralDigest implements com.android.internal.org.bouncycastle.crypto.digests.EncodableDigest {
    ...
    public SHA1Digest(com.android.internal.org.bouncycastle.crypto.digests.SHA1Digest sHA1Digest) {
        super(sHA1Digest);
        this.X = new int[80];
        copyIn(sHA1Digest);
    }
    ...
    public SHA1Digest(byte[] bArr) {
        ...
        this.xOff = com.android.internal.org.bouncycastle.util.Pack.bigEndianToInt(bArr, 36);
        for (int i = 0; i != this.xOff; i++) {
            this.X[i] = com.android.internal.org.bouncycastle.util.Pack.bigEndianToInt(bArr, (i * 4) + 40);
        }
    }

    private void copyIn(com.android.internal.org.bouncycastle.crypto.digests.SHA1Digest sHA1Digest) {
        this.H1 = sHA1Digest.H1;
        this.H2 = sHA1Digest.H2;
        this.H3 = sHA1Digest.H3;
        this.H4 = sHA1Digest.H4;
        this.H5 = sHA1Digest.H5;
        java.lang.System.arraycopy(sHA1Digest.X, 0, this.X, 0, sHA1Digest.X.length);
    ...
    public com.android.internal.org.bouncycastle.util.Memoable copy() {
        return new com.android.internal.org.bouncycastle.crypto.digests.SHA1Digest(this);
    }

    @Override // com.android.internal.org.bouncycastle.util.Memoable
    public void reset(com.android.internal.org.bouncycastle.util.Memoable memoable) {
        com.android.internal.org.bouncycastle.crypto.digests.SHA1Digest sHA1Digest = (com.android.internal.org.bouncycastle.crypto.digests.SHA1Digest) memoable;
        super.copyIn((com.android.internal.org.bouncycastle.crypto.digests.GeneralDigest) sHA1Digest);
        copyIn(sHA1Digest);
    }
    ...
    public byte[] getEncodedState() {
        ...
        com.android.internal.org.bouncycastle.util.Pack.intToBigEndian(this.xOff, bArr, 36);
        for (int i = 0; i != this.xOff; i++) {
            com.android.internal.org.bouncycastle.util.Pack.intToBigEndian(this.X[i], bArr, (i * 4) + 40);
        }
        return bArr;
    }
}
