...
public abstract class Mod {
    ...
    public static void add(int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4) {
        ...
        if (com.android.internal.org.bouncycastle.math.raw.Nat.add(length, iArr2, iArr3, iArr4) != 0) {
            com.android.internal.org.bouncycastle.math.raw.Nat.subFrom(length, iArr, iArr4);
        }
    }
    ...
    public static int modOddInverse(int[] iArr, int[] iArr2, int[] iArr3) {
        int length = iArr.length;
        int numberOfLeadingZeros = (length << 5) - com.android.internal.org.bouncycastle.util.Integers.numberOfLeadingZeros(iArr[length - 1]);
        ...
        return com.android.internal.org.bouncycastle.math.raw.Nat.equalTo(i, iArr7, 1) & com.android.internal.org.bouncycastle.math.raw.Nat.equalToZero(i, iArr8);
    }
    ...
    public static boolean modOddInverseVar(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        java.lang.System.arraycopy(iArr9, 0, iArr7, 0, i);
        int i2 = i - 1;
        int numberOfLeadingZeros2 = (-1) - (com.android.internal.org.bouncycastle.util.Integers.numberOfLeadingZeros(iArr8[i2] | 1) - (((i * 30) + 2) - numberOfLeadingZeros));
        int inverse32 = inverse32(iArr9[0]);
        int maximumDivsteps = getMaximumDivsteps(numberOfLeadingZeros);
        int i3 = i;
        int i4 = 0;
        while (!com.android.internal.org.bouncycastle.math.raw.Nat.isZero(i3, iArr8)) {
        ...
        if (!com.android.internal.org.bouncycastle.math.raw.Nat.isOne(i12, iArr7)) {
            return z;
        }
        if (i14 < 0) {
            add30(i, iArr5, iArr9);
    ...
    public static int[] random(int[] iArr) {
        ...
        } while (com.android.internal.org.bouncycastle.math.raw.Nat.gte(length, create, iArr));
        return create;
    }

    public static void subtract(int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4) {
        int length = iArr.length;
        if (com.android.internal.org.bouncycastle.math.raw.Nat.sub(length, iArr2, iArr3, iArr4) != 0) {
            com.android.internal.org.bouncycastle.math.raw.Nat.addTo(length, iArr, iArr4);
        }
    }
    ...
    private static int divsteps30Var(int i, int i2, int i3, int[] iArr) {
        ...
        int i12 = i;
        while (true) {
            int numberOfTrailingZeros = com.android.internal.org.bouncycastle.util.Integers.numberOfTrailingZeros(((-1) << i11) | i6);
