...
public class DLSequence extends com.android.internal.org.bouncycastle.asn1.ASN1Sequence {
    ...
    public DLSequence(com.android.internal.org.bouncycastle.asn1.ASN1Encodable aSN1Encodable) {
        super(aSN1Encodable);
        this.bodyLength = -1;
    }

    public DLSequence(com.android.internal.org.bouncycastle.asn1.ASN1EncodableVector aSN1EncodableVector) {
        super(aSN1EncodableVector);
        this.bodyLength = -1;
    }

    public DLSequence(com.android.internal.org.bouncycastle.asn1.ASN1Encodable[] aSN1EncodableArr) {
        super(aSN1EncodableArr);
        this.bodyLength = -1;
    }

    DLSequence(com.android.internal.org.bouncycastle.asn1.ASN1Encodable[] aSN1EncodableArr, boolean z) {
