...
public class DLExternal extends com.android.internal.org.bouncycastle.asn1.ASN1External {
    public DLExternal(com.android.internal.org.bouncycastle.asn1.ASN1EncodableVector aSN1EncodableVector) {
        super(aSN1EncodableVector);
    }

    public DLExternal(com.android.internal.org.bouncycastle.asn1.ASN1ObjectIdentifier aSN1ObjectIdentifier, com.android.internal.org.bouncycastle.asn1.ASN1Integer aSN1Integer, com.android.internal.org.bouncycastle.asn1.ASN1Primitive aSN1Primitive, com.android.internal.org.bouncycastle.asn1.DERTaggedObject dERTaggedObject) {
    ...
    void encode(com.android.internal.org.bouncycastle.asn1.ASN1OutputStream aSN1OutputStream, boolean z) throws java.io.IOException {
        ...
        if (this.directReference != null) {
            byteArrayOutputStream.write(this.directReference.getEncoded(com.android.internal.org.bouncycastle.asn1.ASN1Encoding.DL));
        }
        if (this.indirectReference != null) {
            byteArrayOutputStream.write(this.indirectReference.getEncoded(com.android.internal.org.bouncycastle.asn1.ASN1Encoding.DL));
        }
        if (this.dataValueDescriptor != null) {
            byteArrayOutputStream.write(this.dataValueDescriptor.getEncoded(com.android.internal.org.bouncycastle.asn1.ASN1Encoding.DL));
        }
        byteArrayOutputStream.write(new com.android.internal.org.bouncycastle.asn1.DLTaggedObject(true, this.encoding, this.externalContent).getEncoded(com.android.internal.org.bouncycastle.asn1.ASN1Encoding.DL));
