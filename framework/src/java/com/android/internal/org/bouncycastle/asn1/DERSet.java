...
public class DERSet extends com.android.internal.org.bouncycastle.asn1.ASN1Set {
    private int bodyLength;

    public static com.android.internal.org.bouncycastle.asn1.DERSet convert(com.android.internal.org.bouncycastle.asn1.ASN1Set aSN1Set) {
        return (com.android.internal.org.bouncycastle.asn1.DERSet) aSN1Set.toDERObject();
    }
    ...
    public DERSet(com.android.internal.org.bouncycastle.asn1.ASN1Encodable aSN1Encodable) {
        super(aSN1Encodable);
        this.bodyLength = -1;
    }

    public DERSet(com.android.internal.org.bouncycastle.asn1.ASN1EncodableVector aSN1EncodableVector) {
        super(aSN1EncodableVector, true);
        this.bodyLength = -1;
    }

    public DERSet(com.android.internal.org.bouncycastle.asn1.ASN1Encodable[] aSN1EncodableArr) {
        super(aSN1EncodableArr, true);
        this.bodyLength = -1;
    }

    DERSet(boolean z, com.android.internal.org.bouncycastle.asn1.ASN1Encodable[] aSN1EncodableArr) {
    ...
    private static boolean checkSorted(boolean z) {
        if (!z) {
            throw new java.lang.IllegalStateException("DERSet elements should always be in sorted order");
        }
        return z;
    }
}
