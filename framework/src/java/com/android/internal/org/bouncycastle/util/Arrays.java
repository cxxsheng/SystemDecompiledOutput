...
public final class Arrays {
    ...
    public static int hashCode(java.lang.Object[] objArr) {
        ...
        while (true) {
            length--;
            if (length >= 0) {
                i = (i * 257) ^ com.android.internal.org.bouncycastle.util.Objects.hashCode(objArr[length]);
            } else {
                return i;
            }
        }
    ...
    public static boolean[] copyOfRange(boolean[] zArr, int i, int i2) {
        ...
        java.lang.System.arraycopy(zArr, i, zArr2, 0, java.lang.Math.min(zArr.length - i, length));
        return zArr2;
    }
    ...
    public static byte[] copyOfRange(byte[] bArr, int i, int i2) {
        int length = getLength(i, i2);
        byte[] bArr2 = new byte[length];
        java.lang.System.arraycopy(bArr, i, bArr2, 0, java.lang.Math.min(bArr.length - i, length));
        return bArr2;
    }
    ...
    public static char[] copyOfRange(char[] cArr, int i, int i2) {
        ...
        java.lang.System.arraycopy(cArr, i, cArr2, 0, java.lang.Math.min(cArr.length - i, length));
        return cArr2;
    }
    ...
    public static int[] copyOfRange(int[] iArr, int i, int i2) {
        ...
        java.lang.System.arraycopy(iArr, i, iArr2, 0, java.lang.Math.min(iArr.length - i, length));
        return iArr2;
    }
    ...
    public static long[] copyOfRange(long[] jArr, int i, int i2) {
        ...
        java.lang.System.arraycopy(jArr, i, jArr2, 0, java.lang.Math.min(jArr.length - i, length));
        return jArr2;
    }
    ...
    public static short[] copyOfRange(short[] sArr, int i, int i2) {
        ...
        java.lang.System.arraycopy(sArr, i, sArr2, 0, java.lang.Math.min(sArr.length - i, length));
        return sArr2;
    }

    public static java.math.BigInteger[] copyOfRange(java.math.BigInteger[] bigIntegerArr, int i, int i2) {
        int length = getLength(i, i2);
        java.math.BigInteger[] bigIntegerArr2 = new java.math.BigInteger[length];
        java.lang.System.arraycopy(bigIntegerArr, i, bigIntegerArr2, 0, java.lang.Math.min(bigIntegerArr.length - i, length));
        return bigIntegerArr2;
    }
    ...
    public static byte[] concatenate(byte[][] bArr) {
        ...
        for (int i4 = 0; i4 != bArr.length; i4++) {
            java.lang.System.arraycopy(bArr[i4], 0, bArr2, i3, bArr[i4].length);
            i3 += bArr[i4].length;
        }
        return bArr2;
    }
    ...
    public static class Iterator<T> implements java.util.Iterator<T> {
        ...
        public T next() {
            if (this.position == this.dataArray.length) {
                throw new java.util.NoSuchElementException("Out of elements: " + this.position);
            }
