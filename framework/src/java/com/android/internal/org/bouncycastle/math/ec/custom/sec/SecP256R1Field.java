...
public class SecP256R1Field {
    ...
    public static void addExt(int[] iArr, int[] iArr2, int[] iArr3) {
        if (com.android.internal.org.bouncycastle.math.raw.Nat.add(16, iArr, iArr2, iArr3) != 0 || ((iArr3[15] >>> 1) >= Integer.MAX_VALUE && com.android.internal.org.bouncycastle.math.raw.Nat.gte(16, iArr3, PExt))) {
            com.android.internal.org.bouncycastle.math.raw.Nat.subFrom(16, PExt, iArr3);
        }
    }
    ...
    public static void multiplyAddToExt(int[] iArr, int[] iArr2, int[] iArr3) {
        if (com.android.internal.org.bouncycastle.math.raw.Nat256.mulAddTo(iArr, iArr2, iArr3) != 0 || ((iArr3[15] >>> 1) >= Integer.MAX_VALUE && com.android.internal.org.bouncycastle.math.raw.Nat.gte(16, iArr3, PExt))) {
            com.android.internal.org.bouncycastle.math.raw.Nat.subFrom(16, PExt, iArr3);
        }
    }
    ...
    public static void reduce32(int i, int[] iArr) {
        ...
        if (j != 0 || (iArr[7] == -1 && com.android.internal.org.bouncycastle.math.raw.Nat256.gte(iArr, P))) {
            addPInvTo(iArr);
        }
    }
    ...
    public static void subtractExt(int[] iArr, int[] iArr2, int[] iArr3) {
        if (com.android.internal.org.bouncycastle.math.raw.Nat.sub(16, iArr, iArr2, iArr3) != 0) {
            com.android.internal.org.bouncycastle.math.raw.Nat.addTo(16, PExt, iArr3);
        }
    }
