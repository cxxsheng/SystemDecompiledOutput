...
class LongArray implements java.lang.Cloneable {
    ...
    public LongArray(long[] jArr, int i, int i2) {
        if (i == 0 && i2 == jArr.length) {
            ...
            java.lang.System.arraycopy(jArr, i, this.m_ints, 0, i2);
        }
    }
    ...
    void copyTo(long[] jArr, int i) {
        java.lang.System.arraycopy(this.m_ints, 0, jArr, i, this.m_ints.length);
    }
    ...
    private static int bitLength(long j) {
        ...
        if (i4 == 0) {
            ...
            int i6 = i4 >>> 8;
            i = i6 == 0 ? bitLengths[i4] + 16 : bitLengths[i6] + android.hardware.biometrics.face.AcquiredInfo.FIRST_FRAME_RECEIVED;
        }
        return i2 + i;
    }
    ...
    private long[] resizedInts(int i) {
        ...
        java.lang.System.arraycopy(this.m_ints, 0, jArr, 0, java.lang.Math.min(this.m_ints.length, i));
        return jArr;
    }
    ...
    public java.math.BigInteger toBigInteger() {
        ...
        if (usedLength == 0) {
            return com.android.internal.org.bouncycastle.math.ec.ECConstants.ZERO;
        }
        int i = usedLength - 1;
    ...
    public com.android.internal.org.bouncycastle.math.ec.LongArray addOne() {
        if (this.m_ints.length == 0) {
            return new com.android.internal.org.bouncycastle.math.ec.LongArray(new long[]{1});
        }
        long[] resizedInts = resizedInts(java.lang.Math.max(1, getUsedLength()));
        resizedInts[0] = 1 ^ resizedInts[0];
        return new com.android.internal.org.bouncycastle.math.ec.LongArray(resizedInts);
    }

    private void addShiftedByBitsSafe(com.android.internal.org.bouncycastle.math.ec.LongArray longArray, int i, int i2) {
        int i3 = (i + 63) >>> 6;
        int i4 = i2 >>> 6;
        int i5 = i2 & 63;
        if (i5 == 0) {
    ...
    public void addShiftedByWords(com.android.internal.org.bouncycastle.math.ec.LongArray longArray, int i) {
    ...
    public com.android.internal.org.bouncycastle.math.ec.LongArray modMultiplyLD(com.android.internal.org.bouncycastle.math.ec.LongArray longArray, int i, int[] iArr) {
        int i2;
        int i3;
        com.android.internal.org.bouncycastle.math.ec.LongArray longArray2;
        com.android.internal.org.bouncycastle.math.ec.LongArray longArray3;
        long[] jArr;
        int i4;
        int degree = degree();
        if (degree == 0) {
        ...
        iArr2[1] = i8;
        java.lang.System.arraycopy(longArray3.m_ints, 0, jArr3, i8, i6);
        int i10 = 2;
        int i11 = i8;
        while (i10 < 16) {
            i11 += i8;
    ...
    public com.android.internal.org.bouncycastle.math.ec.LongArray modMultiply(com.android.internal.org.bouncycastle.math.ec.LongArray longArray, int i, int[] iArr) {
        int i2;
        int i3;
        com.android.internal.org.bouncycastle.math.ec.LongArray longArray2;
        com.android.internal.org.bouncycastle.math.ec.LongArray longArray3;
        ...
        iArr2[1] = i9;
        java.lang.System.arraycopy(longArray3.m_ints, 0, jArr3, i9, i7);
        int i11 = 2;
        int i12 = i9;
    ...
    public com.android.internal.org.bouncycastle.math.ec.LongArray modMultiplyAlt(com.android.internal.org.bouncycastle.math.ec.LongArray longArray, int i, int[] iArr) {
        int i2;
        int i3;
        com.android.internal.org.bouncycastle.math.ec.LongArray longArray2;
        com.android.internal.org.bouncycastle.math.ec.LongArray longArray3;
        ...
        java.lang.System.arraycopy(longArray3.m_ints, 0, jArr2, i4, i5);
        int i12 = i4;
        int i13 = 1;
        while (i13 < 8) {
            int i14 = i12 + i7;
        ...
        while (true) {
            ...
            if ((i22 & 1) != 0) {
                distribute(jArr2, iArr2[i22], iArr2[i22 - 1], iArr2[1], i6);
            } else {
                addShiftedUp(jArr2, iArr2[i22 >>> 1], jArr2, iArr2[i22], i6, 16);
            }
            i21 = i22;
        }
    }

    public com.android.internal.org.bouncycastle.math.ec.LongArray modReduce(int i, int[] iArr) {
        long[] clone = com.android.internal.org.bouncycastle.util.Arrays.clone(this.m_ints);
        return new com.android.internal.org.bouncycastle.math.ec.LongArray(clone, 0, reduceInPlace(clone, 0, clone.length, i, iArr));
    }

    public com.android.internal.org.bouncycastle.math.ec.LongArray multiply(com.android.internal.org.bouncycastle.math.ec.LongArray longArray, int i, int[] iArr) {
        int i2;
        int i3;
        com.android.internal.org.bouncycastle.math.ec.LongArray longArray2;
        com.android.internal.org.bouncycastle.math.ec.LongArray longArray3;
        ...
        if (i5 == 1) {
            ...
            long[] jArr2 = new long[i7];
            multiplyWord(j, longArray3.m_ints, i6, jArr2, 0);
            return new com.android.internal.org.bouncycastle.math.ec.LongArray(jArr2, 0, i7);
        }
        int i8 = ((i3 + 7) + 63) >>> 6;
        int[] iArr2 = new int[16];
        int i9 = i8 << 4;
        ...
        while (true) {
            ...
            if (i14 != 0) {
                ...
                return new com.android.internal.org.bouncycastle.math.ec.LongArray(jArr7, 0, i7);
            }
        }
    }
    ...
    public void reduce(int i, int[] iArr) {
        ...
        if (reduceInPlace < jArr.length) {
            ...
            java.lang.System.arraycopy(jArr, 0, this.m_ints, 0, reduceInPlace);
        }
    }

    private static com.android.internal.org.bouncycastle.math.ec.LongArray reduceResult(long[] jArr, int i, int i2, int i3, int[] iArr) {
        return new com.android.internal.org.bouncycastle.math.ec.LongArray(jArr, i, reduceInPlace(jArr, i, i2, i3, iArr));
    }
    ...
    private static int reduceInPlace(long[] jArr, int i, int i2, int i3, int[] iArr) {
        ...
        int i5 = i2 << 6;
        int min = java.lang.Math.min(i5, (i3 << 1) - 1);
        int i6 = i5 - min;
        int i7 = i2;
        while (i6 >= 64) {
            i7--;
        ...
        int max = java.lang.Math.max(i3, i8 + 64);
        int min2 = (i6 + java.lang.Math.min(min - max, i3 - i9)) >> 6;
        if (min2 > 1) {
            int i10 = i7 - min2;
    ...
    public com.android.internal.org.bouncycastle.math.ec.LongArray modSquare(int i, int[] iArr) {
        int usedLength = getUsedLength();
        if (usedLength == 0) {
            return this;
        }
        ...
        return new com.android.internal.org.bouncycastle.math.ec.LongArray(jArr, 0, reduceInPlace(jArr, 0, i2, i, iArr));
    }

    public com.android.internal.org.bouncycastle.math.ec.LongArray modSquareN(int i, int i2, int[] iArr) {
        int usedLength = getUsedLength();
        if (usedLength == 0) {
            return this;
        }
        ...
        java.lang.System.arraycopy(this.m_ints, 0, jArr, 0, usedLength);
        while (true) {
            i--;
            if (i >= 0) {
                ...
                return new com.android.internal.org.bouncycastle.math.ec.LongArray(jArr, 0, usedLength);
            }
        }
    }

    public com.android.internal.org.bouncycastle.math.ec.LongArray square(int i, int[] iArr) {
        int usedLength = getUsedLength();
        if (usedLength == 0) {
            return this;
        }
        ...
        return new com.android.internal.org.bouncycastle.math.ec.LongArray(jArr, 0, i2);
    }
    ...
    private static long interleave3(long j) {
        return (interleave3_21to63(((int) (j >>> 42)) & android.media.audio.common.AudioChannelLayout.INDEX_MASK_21) << 2) | (Long.MIN_VALUE & j) | interleave3_21to63(((int) j) & android.media.audio.common.AudioChannelLayout.INDEX_MASK_21) | (interleave3_21to63(((int) (j >>> 21)) & android.media.audio.common.AudioChannelLayout.INDEX_MASK_21) << 1);
    }
    ...
    private static long interleave3_13to65(int i) {
        return ((INTERLEAVE5_TABLE[i >>> 7] & 4294967295L) << 35) | (4294967295L & INTERLEAVE5_TABLE[i & 127]);
    }
    ...
    private static long interleave4_16to64(int i) {
        return ((INTERLEAVE4_TABLE[i >>> 8] & 4294967295L) << 32) | (4294967295L & INTERLEAVE4_TABLE[i & 255]);
    }

    private static long interleave2_32to64(int i) {
        return ((((INTERLEAVE2_TABLE[i >>> 24] << 16) | INTERLEAVE2_TABLE[(i >>> 16) & 255]) & 4294967295L) << 32) | (4294967295L & (INTERLEAVE2_TABLE[i & 255] | (INTERLEAVE2_TABLE[(i >>> 8) & 255] << 16)));
    }

    public com.android.internal.org.bouncycastle.math.ec.LongArray modInverse(int i, int[] iArr) {
        int degree = degree();
        if (degree == 0) {
        ...
        com.android.internal.org.bouncycastle.math.ec.LongArray longArray = (com.android.internal.org.bouncycastle.math.ec.LongArray) clone();
        int i3 = (i + 63) >>> 6;
        com.android.internal.org.bouncycastle.math.ec.LongArray longArray2 = new com.android.internal.org.bouncycastle.math.ec.LongArray(i3);
        reduceBit(longArray2.m_ints, 0, i, i, iArr);
        com.android.internal.org.bouncycastle.math.ec.LongArray longArray3 = new com.android.internal.org.bouncycastle.math.ec.LongArray(i3);
        longArray3.m_ints[0] = 1;
        com.android.internal.org.bouncycastle.math.ec.LongArray longArray4 = new com.android.internal.org.bouncycastle.math.ec.LongArray(i3);
        int[] iArr2 = new int[2];
        iArr2[0] = degree;
        iArr2[1] = i + 1;
        com.android.internal.org.bouncycastle.math.ec.LongArray[] longArrayArr = {longArray, longArray2};
        int[] iArr3 = new int[2];
        iArr3[0] = 1;
        iArr3[1] = 0;
        com.android.internal.org.bouncycastle.math.ec.LongArray[] longArrayArr2 = {longArray3, longArray4};
        int i4 = iArr2[1];
        int i5 = iArr3[1];
        int i6 = i4 - iArr2[0];
        while (true) {
    ...
    public boolean equals(java.lang.Object obj) {
        if (!(obj instanceof com.android.internal.org.bouncycastle.math.ec.LongArray)) {
            return false;
        }
        com.android.internal.org.bouncycastle.math.ec.LongArray longArray = (com.android.internal.org.bouncycastle.math.ec.LongArray) obj;
        int usedLength = getUsedLength();
    ...
    public java.lang.Object clone() {
        return new com.android.internal.org.bouncycastle.math.ec.LongArray(com.android.internal.org.bouncycastle.util.Arrays.clone(this.m_ints));
    }
    ...
    public java.lang.String toString() {
        ...
        int i = usedLength - 1;
        java.lang.StringBuffer stringBuffer = new java.lang.StringBuffer(java.lang.Long.toBinaryString(this.m_ints[i]));
        while (true) {
            i--;
            if (i >= 0) {
                java.lang.String binaryString = java.lang.Long.toBinaryString(this.m_ints[i]);
