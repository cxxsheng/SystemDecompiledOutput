...
public class MD4Digest extends com.android.internal.org.bouncycastle.crypto.digests.GeneralDigest {
    ...
    public MD4Digest(com.android.internal.org.bouncycastle.crypto.digests.MD4Digest mD4Digest) {
        super(mD4Digest);
        this.X = new int[16];
        copyIn(mD4Digest);
    }

    private void copyIn(com.android.internal.org.bouncycastle.crypto.digests.MD4Digest mD4Digest) {
        super.copyIn((com.android.internal.org.bouncycastle.crypto.digests.GeneralDigest) mD4Digest);
        this.H1 = mD4Digest.H1;
        this.H2 = mD4Digest.H2;
        this.H3 = mD4Digest.H3;
        this.H4 = mD4Digest.H4;
        java.lang.System.arraycopy(mD4Digest.X, 0, this.X, 0, mD4Digest.X.length);
    ...
    public com.android.internal.org.bouncycastle.util.Memoable copy() {
        return new com.android.internal.org.bouncycastle.crypto.digests.MD4Digest(this);
    }

    @Override // com.android.internal.org.bouncycastle.util.Memoable
    public void reset(com.android.internal.org.bouncycastle.util.Memoable memoable) {
        copyIn((com.android.internal.org.bouncycastle.crypto.digests.MD4Digest) memoable);
    }
}
