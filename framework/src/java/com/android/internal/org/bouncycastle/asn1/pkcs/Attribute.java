...
public class Attribute extends com.android.internal.org.bouncycastle.asn1.ASN1Object {
    ...
    public static com.android.internal.org.bouncycastle.asn1.pkcs.Attribute getInstance(java.lang.Object obj) {
        if (obj == null || (obj instanceof com.android.internal.org.bouncycastle.asn1.pkcs.Attribute)) {
            return (com.android.internal.org.bouncycastle.asn1.pkcs.Attribute) obj;
        }
        if (obj instanceof com.android.internal.org.bouncycastle.asn1.ASN1Sequence) {
            return new com.android.internal.org.bouncycastle.asn1.pkcs.Attribute((com.android.internal.org.bouncycastle.asn1.ASN1Sequence) obj);
        }
        throw new java.lang.IllegalArgumentException("unknown object in factory: " + obj.getClass().getName());
    }

    public Attribute(com.android.internal.org.bouncycastle.asn1.ASN1Sequence aSN1Sequence) {
