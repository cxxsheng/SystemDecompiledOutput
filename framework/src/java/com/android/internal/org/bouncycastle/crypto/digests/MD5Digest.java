...
public class MD5Digest extends com.android.internal.org.bouncycastle.crypto.digests.GeneralDigest implements com.android.internal.org.bouncycastle.crypto.digests.EncodableDigest {
    ...
    public MD5Digest(byte[] bArr) {
        ...
        this.xOff = com.android.internal.org.bouncycastle.util.Pack.bigEndianToInt(bArr, 32);
        for (int i = 0; i != this.xOff; i++) {
            this.X[i] = com.android.internal.org.bouncycastle.util.Pack.bigEndianToInt(bArr, (i * 4) + 36);
        }
    }

    public MD5Digest(com.android.internal.org.bouncycastle.crypto.digests.MD5Digest mD5Digest) {
        super(mD5Digest);
        this.X = new int[16];
        copyIn(mD5Digest);
    }

    private void copyIn(com.android.internal.org.bouncycastle.crypto.digests.MD5Digest mD5Digest) {
        super.copyIn((com.android.internal.org.bouncycastle.crypto.digests.GeneralDigest) mD5Digest);
        this.H1 = mD5Digest.H1;
        this.H2 = mD5Digest.H2;
        this.H3 = mD5Digest.H3;
        this.H4 = mD5Digest.H4;
        java.lang.System.arraycopy(mD5Digest.X, 0, this.X, 0, mD5Digest.X.length);
    ...
    public com.android.internal.org.bouncycastle.util.Memoable copy() {
        return new com.android.internal.org.bouncycastle.crypto.digests.MD5Digest(this);
    }

    @Override // com.android.internal.org.bouncycastle.util.Memoable
    public void reset(com.android.internal.org.bouncycastle.util.Memoable memoable) {
        copyIn((com.android.internal.org.bouncycastle.crypto.digests.MD5Digest) memoable);
    }
    ...
    public byte[] getEncodedState() {
        ...
        com.android.internal.org.bouncycastle.util.Pack.intToBigEndian(this.xOff, bArr, 32);
        for (int i = 0; i != this.xOff; i++) {
            com.android.internal.org.bouncycastle.util.Pack.intToBigEndian(this.X[i], bArr, (i * 4) + 36);
        }
        return bArr;
    }
}
