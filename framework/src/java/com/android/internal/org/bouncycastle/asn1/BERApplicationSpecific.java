...
public class BERApplicationSpecific extends com.android.internal.org.bouncycastle.asn1.ASN1ApplicationSpecific {
    BERApplicationSpecific(boolean z, int i, byte[] bArr) {
        super(z, i, bArr);
    }

    public BERApplicationSpecific(int i, com.android.internal.org.bouncycastle.asn1.ASN1Encodable aSN1Encodable) throws java.io.IOException {
        this(true, i, aSN1Encodable);
    }

    public BERApplicationSpecific(boolean z, int i, com.android.internal.org.bouncycastle.asn1.ASN1Encodable aSN1Encodable) throws java.io.IOException {
    ...
    private static byte[] getEncoding(boolean z, com.android.internal.org.bouncycastle.asn1.ASN1Encodable aSN1Encodable) throws java.io.IOException {
        byte[] encoded = aSN1Encodable.toASN1Primitive().getEncoded(com.android.internal.org.bouncycastle.asn1.ASN1Encoding.BER);
        if (z) {
            return encoded;
        }
    ...
    public BERApplicationSpecific(int i, com.android.internal.org.bouncycastle.asn1.ASN1EncodableVector aSN1EncodableVector) {
    ...
    private static byte[] getEncodedVector(com.android.internal.org.bouncycastle.asn1.ASN1EncodableVector aSN1EncodableVector) {
        ...
        for (int i = 0; i != aSN1EncodableVector.size(); i++) {
            try {
                byteArrayOutputStream.write(((com.android.internal.org.bouncycastle.asn1.ASN1Object) aSN1EncodableVector.get(i)).getEncoded(com.android.internal.org.bouncycastle.asn1.ASN1Encoding.BER));
