...
public class PersistableBundleUtils {
    ...
    public static final com.android.server.vcn.repackaged.util.PersistableBundleUtils.Serializer<java.lang.Integer> INTEGER_SERIALIZER = new com.android.server.vcn.repackaged.util.PersistableBundleUtils.Serializer() { // from class: com.android.server.vcn.repackaged.util.PersistableBundleUtils$$ExternalSyntheticLambda0
        ...
        public final android.os.PersistableBundle toPersistableBundle(java.lang.Object obj) {
            return com.android.server.vcn.repackaged.util.PersistableBundleUtils.lambda$static$0((java.lang.Integer) obj);
        }
    };
    public static final com.android.server.vcn.repackaged.util.PersistableBundleUtils.Deserializer<java.lang.Integer> INTEGER_DESERIALIZER = new com.android.server.vcn.repackaged.util.PersistableBundleUtils.Deserializer() { // from class: com.android.server.vcn.repackaged.util.PersistableBundleUtils$$ExternalSyntheticLambda1
        ...
        public final java.lang.Object fromPersistableBundle(android.os.PersistableBundle persistableBundle) {
            return com.android.server.vcn.repackaged.util.PersistableBundleUtils.lambda$static$1(persistableBundle);
        }
    };
    public static final com.android.server.vcn.repackaged.util.PersistableBundleUtils.Serializer<java.lang.String> STRING_SERIALIZER = new com.android.server.vcn.repackaged.util.PersistableBundleUtils.Serializer() { // from class: com.android.server.vcn.repackaged.util.PersistableBundleUtils$$ExternalSyntheticLambda2
        @Override // com.android.server.vcn.repackaged.util.PersistableBundleUtils.Serializer
        public final android.os.PersistableBundle toPersistableBundle(java.lang.Object obj) {
            return com.android.server.vcn.repackaged.util.PersistableBundleUtils.lambda$static$2((java.lang.String) obj);
        }
    };
    public static final com.android.server.vcn.repackaged.util.PersistableBundleUtils.Deserializer<java.lang.String> STRING_DESERIALIZER = new com.android.server.vcn.repackaged.util.PersistableBundleUtils.Deserializer() { // from class: com.android.server.vcn.repackaged.util.PersistableBundleUtils$$ExternalSyntheticLambda3
        @Override // com.android.server.vcn.repackaged.util.PersistableBundleUtils.Deserializer
        public final java.lang.Object fromPersistableBundle(android.os.PersistableBundle persistableBundle) {
            return com.android.server.vcn.repackaged.util.PersistableBundleUtils.lambda$static$3(persistableBundle);
        }
    };
    ...
    static /* synthetic */ android.os.PersistableBundle lambda$static$0(java.lang.Integer num) {
        android.os.PersistableBundle persistableBundle = new android.os.PersistableBundle();
        persistableBundle.putInt(INTEGER_KEY, num.intValue());
        return persistableBundle;
    }

    static /* synthetic */ java.lang.Integer lambda$static$1(android.os.PersistableBundle persistableBundle) {
    ...
    static /* synthetic */ android.os.PersistableBundle lambda$static$2(java.lang.String str) {
        android.os.PersistableBundle persistableBundle = new android.os.PersistableBundle();
        persistableBundle.putString(STRING_KEY, str);
        return persistableBundle;
    }

    static /* synthetic */ java.lang.String lambda$static$3(android.os.PersistableBundle persistableBundle) {
        java.util.Objects.requireNonNull(persistableBundle, "PersistableBundle is null");
    ...
    public static <T> android.os.PersistableBundle fromList(java.util.List<T> list, com.android.server.vcn.repackaged.util.PersistableBundleUtils.Serializer<T> serializer) {
        android.os.PersistableBundle persistableBundle = new android.os.PersistableBundle();
    ...
    public static <T> java.util.List<T> toList(android.os.PersistableBundle persistableBundle, com.android.server.vcn.repackaged.util.PersistableBundleUtils.Deserializer<T> deserializer) {
    ...
    public static <K, V> android.os.PersistableBundle fromMap(java.util.Map<K, V> map, com.android.server.vcn.repackaged.util.PersistableBundleUtils.Serializer<K> serializer, com.android.server.vcn.repackaged.util.PersistableBundleUtils.Serializer<V> serializer2) {
        android.os.PersistableBundle persistableBundle = new android.os.PersistableBundle();
    ...
    public static <K, V> java.util.LinkedHashMap<K, V> toMap(android.os.PersistableBundle persistableBundle, com.android.server.vcn.repackaged.util.PersistableBundleUtils.Deserializer<K> deserializer, com.android.server.vcn.repackaged.util.PersistableBundleUtils.Deserializer<V> deserializer2) {
        int i = persistableBundle.getInt(COLLECTION_SIZE_KEY);
    ...
    public static byte[] toDiskStableBytes(android.os.PersistableBundle persistableBundle) throws java.io.IOException {
        java.io.ByteArrayOutputStream byteArrayOutputStream = new java.io.ByteArrayOutputStream();
        persistableBundle.writeToStream(byteArrayOutputStream);
        return byteArrayOutputStream.toByteArray();
    }

    public static android.os.PersistableBundle fromDiskStableBytes(byte[] bArr) throws java.io.IOException {
    ...
    public static class LockingReadWriteHelper {
        ...
        public LockingReadWriteHelper(java.lang.String str) {
            this.mPath = (java.lang.String) java.util.Objects.requireNonNull(str, "fileName was null");
        }
        ...
        public void writeToDisk(android.os.PersistableBundle persistableBundle) throws java.io.IOException {
    ...
    public static android.os.PersistableBundle minimizeBundle(android.os.PersistableBundle persistableBundle, java.lang.String... strArr) {
    ...
    public static int getHashCode(android.os.PersistableBundle persistableBundle) {
        if (persistableBundle == null) {
            return -1;
        }
    ...
    public static boolean isEqual(android.os.PersistableBundle persistableBundle, android.os.PersistableBundle persistableBundle2) {
    ...
    public static class PersistableBundleWrapper {
        ...
        public PersistableBundleWrapper(android.os.PersistableBundle persistableBundle) {
            this.mBundle = (android.os.PersistableBundle) java.util.Objects.requireNonNull(persistableBundle, "Bundle was null");
        }
        ...
        public int hashCode() {
            return com.android.server.vcn.repackaged.util.PersistableBundleUtils.getHashCode(this.mBundle);
        }

        public boolean equals(java.lang.Object obj) {
            if (!(obj instanceof com.android.server.vcn.repackaged.util.PersistableBundleUtils.PersistableBundleWrapper)) {
                return false;
            }
            return com.android.server.vcn.repackaged.util.PersistableBundleUtils.isEqual(this.mBundle, ((com.android.server.vcn.repackaged.util.PersistableBundleUtils.PersistableBundleWrapper) obj).mBundle);
        }
