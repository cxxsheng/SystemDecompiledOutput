...
public class ImsConfig {
    ...
    private static final java.lang.String TAG = "ImsConfig";
    private boolean DBG = true;
    private final android.telephony.ims.aidl.IImsConfig miConfig;
    ...
    public ImsConfig(android.telephony.ims.aidl.IImsConfig iImsConfig) {
        this.miConfig = iImsConfig;
    }

    public int getProvisionedValue(int i) throws com.android.ims.ImsException {
        return getConfigInt(i);
    }

    public int getConfigInt(int i) throws com.android.ims.ImsException {
        try {
            int configInt = this.miConfig.getConfigInt(i);
            if (this.DBG) {
                com.android.telephony.Rlog.d(TAG, "getInt(): item = " + i + ", ret =" + configInt);
            }
            return configInt;
        } catch (android.os.RemoteException e) {
            throw new com.android.ims.ImsException("getInt()", e, 131);
        }
    }

    public java.lang.String getProvisionedStringValue(int i) throws com.android.ims.ImsException {
        return getConfigString(i);
    }

    public java.lang.String getConfigString(int i) throws com.android.ims.ImsException {
        try {
            java.lang.String configString = this.miConfig.getConfigString(i);
            if (this.DBG) {
                com.android.telephony.Rlog.d(TAG, "getConfigString(): item = " + i + ", ret =" + configString);
            }
            return configString;
        } catch (android.os.RemoteException e) {
            throw new com.android.ims.ImsException("getConfigString()", e, 131);
        }
    }

    public int setProvisionedValue(int i, int i2) throws com.android.ims.ImsException {
        return setConfig(i, i2);
    }

    public int setProvisionedStringValue(int i, java.lang.String str) throws com.android.ims.ImsException {
        return setConfig(i, str);
    }

    public int setConfig(int i, int i2) throws com.android.ims.ImsException {
        if (this.DBG) {
            com.android.telephony.Rlog.d(TAG, "setConfig(): item = " + i + "value = " + i2);
        }
        try {
            int configInt = this.miConfig.setConfigInt(i, i2);
            if (this.DBG) {
                com.android.telephony.Rlog.d(TAG, "setConfig(): item = " + i + " value = " + i2 + " ret = " + configInt);
            }
            return configInt;
        } catch (android.os.RemoteException e) {
            throw new com.android.ims.ImsException("setConfig()", e, 131);
        }
    }

    public int setConfig(int i, java.lang.String str) throws com.android.ims.ImsException {
        if (this.DBG) {
            com.android.telephony.Rlog.d(TAG, "setConfig(): item = " + i + "value = " + str);
        }
        try {
            int configString = this.miConfig.setConfigString(i, str);
            if (this.DBG) {
                com.android.telephony.Rlog.d(TAG, "setConfig(): item = " + i + " value = " + str + " ret = " + configString);
            }
            return configString;
        } catch (android.os.RemoteException e) {
            throw new com.android.ims.ImsException("setConfig()", e, 131);
    ...
    public void addConfigCallback(android.telephony.ims.ProvisioningManager.Callback callback) throws com.android.ims.ImsException {
        callback.setExecutor(getThreadExecutor());
        addConfigCallback(callback.getBinder());
    }

    public void addConfigCallback(android.telephony.ims.aidl.IImsConfigCallback iImsConfigCallback) throws com.android.ims.ImsException {
        if (this.DBG) {
            com.android.telephony.Rlog.d(TAG, "addConfigCallback: " + iImsConfigCallback);
        }
        try {
            this.miConfig.addImsConfigCallback(iImsConfigCallback);
        } catch (android.os.RemoteException e) {
            throw new com.android.ims.ImsException("addConfigCallback()", e, 131);
        }
    }

    public void removeConfigCallback(android.telephony.ims.aidl.IImsConfigCallback iImsConfigCallback) throws com.android.ims.ImsException {
        if (this.DBG) {
            com.android.telephony.Rlog.d(TAG, "removeConfigCallback: " + iImsConfigCallback);
        }
        try {
            this.miConfig.removeImsConfigCallback(iImsConfigCallback);
        } catch (android.os.RemoteException e) {
            throw new com.android.ims.ImsException("removeConfigCallback()", e, 131);
        }
    }
    ...
    private java.util.concurrent.Executor getThreadExecutor() {
        ...
        return new com.android.internal.telephony.util.HandlerExecutor(new android.os.Handler(android.os.Looper.myLooper()));
    }
}
