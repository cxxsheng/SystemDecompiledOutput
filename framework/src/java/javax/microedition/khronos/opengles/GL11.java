...
public interface GL11 extends javax.microedition.khronos.opengles.GL10 {
    ...
    void glClipPlanef(int i, java.nio.FloatBuffer floatBuffer);

    void glClipPlanef(int i, float[] fArr, int i2);

    void glClipPlanex(int i, java.nio.IntBuffer intBuffer);
    ...
    void glGetBooleanv(int i, java.nio.IntBuffer intBuffer);
    ...
    void glGetClipPlanef(int i, java.nio.FloatBuffer floatBuffer);

    void glGetClipPlanef(int i, float[] fArr, int i2);

    void glGetClipPlanex(int i, java.nio.IntBuffer intBuffer);

    void glGetClipPlanex(int i, int[] iArr, int i2);

    void glGetFixedv(int i, java.nio.IntBuffer intBuffer);
    ...
    void glGetLightfv(int i, int i2, java.nio.FloatBuffer floatBuffer);

    void glGetLightfv(int i, int i2, float[] fArr, int i3);

    void glGetLightxv(int i, int i2, java.nio.IntBuffer intBuffer);

    void glGetLightxv(int i, int i2, int[] iArr, int i3);

    void glGetMaterialfv(int i, int i2, java.nio.FloatBuffer floatBuffer);

    void glGetMaterialfv(int i, int i2, float[] fArr, int i3);

    void glGetMaterialxv(int i, int i2, java.nio.IntBuffer intBuffer);

    void glGetMaterialxv(int i, int i2, int[] iArr, int i3);

    void glGetPointerv(int i, java.nio.Buffer[] bufferArr);

    void glGetTexEnviv(int i, int i2, java.nio.IntBuffer intBuffer);

    void glGetTexEnviv(int i, int i2, int[] iArr, int i3);

    void glGetTexEnvxv(int i, int i2, java.nio.IntBuffer intBuffer);
    ...
    void glGetTexParameterxv(int i, int i2, java.nio.IntBuffer intBuffer);
    ...
    void glPointParameterfv(int i, java.nio.FloatBuffer floatBuffer);

    void glPointParameterfv(int i, float[] fArr, int i2);

    void glPointParameterx(int i, int i2);

    void glPointParameterxv(int i, java.nio.IntBuffer intBuffer);

    void glPointParameterxv(int i, int[] iArr, int i2);

    void glPointSizePointerOES(int i, int i2, java.nio.Buffer buffer);

    void glTexCoordPointer(int i, int i2, int i3, int i4);

    void glTexEnvi(int i, int i2, int i3);

    void glTexEnviv(int i, int i2, java.nio.IntBuffer intBuffer);
    ...
    void glTexParameterxv(int i, int i2, java.nio.IntBuffer intBuffer);
