...
public interface GL11ExtensionPack extends javax.microedition.khronos.opengles.GL {
    ...
    void glDeleteFramebuffersOES(int i, java.nio.IntBuffer intBuffer);

    void glDeleteFramebuffersOES(int i, int[] iArr, int i2);

    void glDeleteRenderbuffersOES(int i, java.nio.IntBuffer intBuffer);
    ...
    void glGenFramebuffersOES(int i, java.nio.IntBuffer intBuffer);

    void glGenFramebuffersOES(int i, int[] iArr, int i2);

    void glGenRenderbuffersOES(int i, java.nio.IntBuffer intBuffer);

    void glGenRenderbuffersOES(int i, int[] iArr, int i2);

    void glGenerateMipmapOES(int i);

    void glGetFramebufferAttachmentParameterivOES(int i, int i2, int i3, java.nio.IntBuffer intBuffer);
    ...
    void glGetRenderbufferParameterivOES(int i, int i2, java.nio.IntBuffer intBuffer);

    void glGetRenderbufferParameterivOES(int i, int i2, int[] iArr, int i3);

    void glGetTexGenfv(int i, int i2, java.nio.FloatBuffer floatBuffer);

    void glGetTexGenfv(int i, int i2, float[] fArr, int i3);

    void glGetTexGeniv(int i, int i2, java.nio.IntBuffer intBuffer);

    void glGetTexGeniv(int i, int i2, int[] iArr, int i3);

    void glGetTexGenxv(int i, int i2, java.nio.IntBuffer intBuffer);
    ...
    void glTexGenfv(int i, int i2, java.nio.FloatBuffer floatBuffer);

    void glTexGenfv(int i, int i2, float[] fArr, int i3);

    void glTexGeni(int i, int i2, int i3);

    void glTexGeniv(int i, int i2, java.nio.IntBuffer intBuffer);

    void glTexGeniv(int i, int i2, int[] iArr, int i3);

    void glTexGenx(int i, int i2, int i3);

    void glTexGenxv(int i, int i2, java.nio.IntBuffer intBuffer);
