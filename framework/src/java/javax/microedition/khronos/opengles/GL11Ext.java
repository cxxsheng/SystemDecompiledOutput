...
public interface GL11Ext extends javax.microedition.khronos.opengles.GL {
    ...
    void glMatrixIndexPointerOES(int i, int i2, int i3, java.nio.Buffer buffer);

    void glTexParameterfv(int i, int i2, float[] fArr, int i3);

    void glWeightPointerOES(int i, int i2, int i3, int i4);

    void glWeightPointerOES(int i, int i2, int i3, java.nio.Buffer buffer);
}
