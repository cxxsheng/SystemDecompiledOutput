...
public interface GL10 extends javax.microedition.khronos.opengles.GL {
    ...
    void glColorPointer(int i, int i2, int i3, java.nio.Buffer buffer);
    ...
    void glFogfv(int i, java.nio.FloatBuffer floatBuffer);

    void glFogfv(int i, float[] fArr, int i2);

    void glFogx(int i, int i2);

    void glFogxv(int i, java.nio.IntBuffer intBuffer);
    ...
    void glLightModelfv(int i, java.nio.FloatBuffer floatBuffer);

    void glLightModelfv(int i, float[] fArr, int i2);

    void glLightModelx(int i, int i2);

    void glLightModelxv(int i, java.nio.IntBuffer intBuffer);

    void glLightModelxv(int i, int[] iArr, int i2);

    void glLightf(int i, int i2, float f);

    void glLightfv(int i, int i2, java.nio.FloatBuffer floatBuffer);

    void glLightfv(int i, int i2, float[] fArr, int i3);

    void glLightx(int i, int i2, int i3);

    void glLightxv(int i, int i2, java.nio.IntBuffer intBuffer);
    ...
    void glLoadMatrixf(java.nio.FloatBuffer floatBuffer);

    void glLoadMatrixf(float[] fArr, int i);

    void glLoadMatrixx(java.nio.IntBuffer intBuffer);
    ...
    void glMaterialfv(int i, int i2, java.nio.FloatBuffer floatBuffer);

    void glMaterialfv(int i, int i2, float[] fArr, int i3);

    void glMaterialx(int i, int i2, int i3);

    void glMaterialxv(int i, int i2, java.nio.IntBuffer intBuffer);

    void glMaterialxv(int i, int i2, int[] iArr, int i3);

    void glMatrixMode(int i);

    void glMultMatrixf(java.nio.FloatBuffer floatBuffer);

    void glMultMatrixf(float[] fArr, int i);

    void glMultMatrixx(java.nio.IntBuffer intBuffer);
    ...
    void glNormalPointer(int i, int i2, java.nio.Buffer buffer);
    ...
    void glTexCoordPointer(int i, int i2, int i3, java.nio.Buffer buffer);

    void glTexEnvf(int i, int i2, float f);

    void glTexEnvfv(int i, int i2, java.nio.FloatBuffer floatBuffer);

    void glTexEnvfv(int i, int i2, float[] fArr, int i3);

    void glTexEnvx(int i, int i2, int i3);

    void glTexEnvxv(int i, int i2, java.nio.IntBuffer intBuffer);
    ...
    void glVertexPointer(int i, int i2, int i3, java.nio.Buffer buffer);
