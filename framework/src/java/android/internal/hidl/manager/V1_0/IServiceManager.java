...
public interface IServiceManager extends android.internal.hidl.base.V1_0.IBase {
    public static final java.lang.String kInterfaceName = "android.hidl.manager@1.0::IServiceManager";

    boolean add(java.lang.String str, android.internal.hidl.base.V1_0.IBase iBase) throws android.os.RemoteException;
    ...
    java.util.ArrayList<android.internal.hidl.manager.V1_0.IServiceManager.InstanceDebugInfo> debugDump() throws android.os.RemoteException;

    android.internal.hidl.base.V1_0.IBase get(java.lang.String str, java.lang.String str2) throws android.os.RemoteException;
    ...
    boolean registerForNotifications(java.lang.String str, java.lang.String str2, android.internal.hidl.manager.V1_0.IServiceNotification iServiceNotification) throws android.os.RemoteException;
    ...
    static android.internal.hidl.manager.V1_0.IServiceManager asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.internal.hidl.manager.V1_0.IServiceManager)) {
            return (android.internal.hidl.manager.V1_0.IServiceManager) queryLocalInterface;
        }
        android.internal.hidl.manager.V1_0.IServiceManager.Proxy proxy = new android.internal.hidl.manager.V1_0.IServiceManager.Proxy(iHwBinder);
        try {
    ...
    static android.internal.hidl.manager.V1_0.IServiceManager castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.internal.hidl.manager.V1_0.IServiceManager getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.internal.hidl.manager.V1_0.IServiceManager getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.internal.hidl.manager.V1_0.IServiceManager getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.internal.hidl.manager.V1_0.IServiceManager getService() throws android.os.RemoteException {
    ...
    public static final class InstanceDebugInfo {
        ...
        public final boolean equals(java.lang.Object obj) {
            ...
            if (obj == null || obj.getClass() != android.internal.hidl.manager.V1_0.IServiceManager.InstanceDebugInfo.class) {
                return false;
            }
            android.internal.hidl.manager.V1_0.IServiceManager.InstanceDebugInfo instanceDebugInfo = (android.internal.hidl.manager.V1_0.IServiceManager.InstanceDebugInfo) obj;
        ...
        public final java.lang.String toString() {
            return "{.interfaceName = " + this.interfaceName + ", .instanceName = " + this.instanceName + ", .pid = " + this.pid + ", .clientPids = " + this.clientPids + ", .arch = " + android.internal.hidl.base.V1_0.DebugInfo.Architecture.toString(this.arch) + "}";
        }
        ...
        public static final java.util.ArrayList<android.internal.hidl.manager.V1_0.IServiceManager.InstanceDebugInfo> readVectorFromParcel(android.os.HwParcel hwParcel) {
            java.util.ArrayList<android.internal.hidl.manager.V1_0.IServiceManager.InstanceDebugInfo> arrayList = new java.util.ArrayList<>();
            android.os.HwBlob readBuffer = hwParcel.readBuffer(16L);
            int int32 = readBuffer.getInt32(8L);
            android.os.HwBlob readEmbeddedBuffer = hwParcel.readEmbeddedBuffer(int32 * 64, readBuffer.handle(), 0L, true);
            arrayList.clear();
            for (int i = 0; i < int32; i++) {
                android.internal.hidl.manager.V1_0.IServiceManager.InstanceDebugInfo instanceDebugInfo = new android.internal.hidl.manager.V1_0.IServiceManager.InstanceDebugInfo();
        ...
        public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.internal.hidl.manager.V1_0.IServiceManager.InstanceDebugInfo> arrayList) {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.internal.hidl.manager.V1_0.IServiceManager {
        @Override // android.internal.hidl.manager.V1_0.IServiceManager, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.internal.hidl.manager.V1_0.IServiceManager.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public final java.lang.String interfaceDescriptor() {
            return android.internal.hidl.manager.V1_0.IServiceManager.kInterfaceName;
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.internal.hidl.manager.V1_0.IServiceManager.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
