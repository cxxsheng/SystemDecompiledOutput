...
public interface IServiceNotification extends android.internal.hidl.base.V1_0.IBase {
    public static final java.lang.String kInterfaceName = "android.hidl.manager@1.0::IServiceNotification";
    ...
    void onRegistration(java.lang.String str, java.lang.String str2, boolean z) throws android.os.RemoteException;
    ...
    static android.internal.hidl.manager.V1_0.IServiceNotification asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.internal.hidl.manager.V1_0.IServiceNotification)) {
            return (android.internal.hidl.manager.V1_0.IServiceNotification) queryLocalInterface;
        }
        android.internal.hidl.manager.V1_0.IServiceNotification.Proxy proxy = new android.internal.hidl.manager.V1_0.IServiceNotification.Proxy(iHwBinder);
        try {
    ...
    static android.internal.hidl.manager.V1_0.IServiceNotification castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.internal.hidl.manager.V1_0.IServiceNotification getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.internal.hidl.manager.V1_0.IServiceNotification getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.internal.hidl.manager.V1_0.IServiceNotification getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.internal.hidl.manager.V1_0.IServiceNotification getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.internal.hidl.manager.V1_0.IServiceNotification {
        ...
        public void onRegistration(java.lang.String str, java.lang.String str2, boolean z) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.internal.hidl.manager.V1_0.IServiceNotification.kInterfaceName);
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.internal.hidl.manager.V1_0.IServiceNotification {
        @Override // android.internal.hidl.manager.V1_0.IServiceNotification, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.internal.hidl.manager.V1_0.IServiceNotification.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.internal.hidl.manager.V1_0.IServiceNotification.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                case 1:
                    hwParcel.enforceInterface(android.internal.hidl.manager.V1_0.IServiceNotification.kInterfaceName);
