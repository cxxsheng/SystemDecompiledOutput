...
public interface IClientCallback extends android.internal.hidl.base.V1_0.IBase {
    ...
    void onClients(android.internal.hidl.base.V1_0.IBase iBase, boolean z) throws android.os.RemoteException;
    ...
    static android.internal.hidl.manager.V1_2.IClientCallback asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.internal.hidl.manager.V1_2.IClientCallback)) {
            return (android.internal.hidl.manager.V1_2.IClientCallback) queryLocalInterface;
        }
        android.internal.hidl.manager.V1_2.IClientCallback.Proxy proxy = new android.internal.hidl.manager.V1_2.IClientCallback.Proxy(iHwBinder);
        try {
    ...
    static android.internal.hidl.manager.V1_2.IClientCallback castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.internal.hidl.manager.V1_2.IClientCallback getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.internal.hidl.manager.V1_2.IClientCallback getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.internal.hidl.manager.V1_2.IClientCallback getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.internal.hidl.manager.V1_2.IClientCallback getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.internal.hidl.manager.V1_2.IClientCallback {
        ...
        public void onClients(android.internal.hidl.base.V1_0.IBase iBase, boolean z) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.internal.hidl.manager.V1_2.IClientCallback.kInterfaceName);
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.internal.hidl.manager.V1_2.IClientCallback {
        @Override // android.internal.hidl.manager.V1_2.IClientCallback, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.internal.hidl.manager.V1_2.IClientCallback.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public final java.lang.String interfaceDescriptor() {
            return android.internal.hidl.manager.V1_2.IClientCallback.kInterfaceName;
        }

        @Override // android.internal.hidl.manager.V1_2.IClientCallback, android.internal.hidl.base.V1_0.IBase
        public final java.util.ArrayList<byte[]> getHashChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(new byte[]{-91, 112, -3, 67, 106, -19, 94, -18, -22, 36, -107, -71, 38, 126, Byte.MAX_VALUE, -100, 72, 8, -43, 30, -3, 76, -101, com.android.internal.midi.MidiConstants.STATUS_POLYPHONIC_AFTERTOUCH, -111, 59, -111, 2, -21, -109, -82, -19}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, com.android.internal.midi.MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, com.android.internal.midi.MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, android.hardware.biometrics.face.AcquiredInfo.ROLL_TOO_EXTREME, -109, 36, -72, 59, android.hardware.biometrics.face.AcquiredInfo.FIRST_FRAME_RECEIVED, -54, 76}));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.internal.hidl.manager.V1_2.IClientCallback.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                case 1:
                    hwParcel.enforceInterface(android.internal.hidl.manager.V1_2.IClientCallback.kInterfaceName);
                    onClients(android.internal.hidl.base.V1_0.IBase.asInterface(hwParcel.readStrongBinder()), hwParcel.readBool());
                    return;
                case 256067662:
