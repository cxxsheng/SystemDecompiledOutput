...
public interface IServiceManager extends android.internal.hidl.manager.V1_0.IServiceManager {
    ...
    boolean unregisterForNotifications(java.lang.String str, java.lang.String str2, android.internal.hidl.manager.V1_0.IServiceNotification iServiceNotification) throws android.os.RemoteException;

    static android.internal.hidl.manager.V1_1.IServiceManager asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.internal.hidl.manager.V1_1.IServiceManager)) {
            return (android.internal.hidl.manager.V1_1.IServiceManager) queryLocalInterface;
        }
        android.internal.hidl.manager.V1_1.IServiceManager.Proxy proxy = new android.internal.hidl.manager.V1_1.IServiceManager.Proxy(iHwBinder);
        try {
    ...
    static android.internal.hidl.manager.V1_1.IServiceManager castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.internal.hidl.manager.V1_1.IServiceManager getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.internal.hidl.manager.V1_1.IServiceManager getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.internal.hidl.manager.V1_1.IServiceManager getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.internal.hidl.manager.V1_1.IServiceManager getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.internal.hidl.manager.V1_1.IServiceManager {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.internal.hidl.manager.V1_1.IServiceManager {
        @Override // android.internal.hidl.manager.V1_1.IServiceManager, android.internal.hidl.manager.V1_0.IServiceManager, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.internal.hidl.manager.V1_1.IServiceManager.kInterfaceName, android.internal.hidl.manager.V1_0.IServiceManager.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.internal.hidl.manager.V1_1.IServiceManager.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
