...
public final class DebugInfo {
    ...
    public final boolean equals(java.lang.Object obj) {
        ...
        if (obj == null || obj.getClass() != android.internal.hidl.base.V1_0.DebugInfo.class) {
            return false;
        }
        android.internal.hidl.base.V1_0.DebugInfo debugInfo = (android.internal.hidl.base.V1_0.DebugInfo) obj;
    ...
    public final java.lang.String toString() {
        return "{.pid = " + this.pid + ", .ptr = " + this.ptr + ", .arch = " + android.internal.hidl.base.V1_0.DebugInfo.Architecture.toString(this.arch) + "}";
    }
    ...
    public static final java.util.ArrayList<android.internal.hidl.base.V1_0.DebugInfo> readVectorFromParcel(android.os.HwParcel hwParcel) {
        java.util.ArrayList<android.internal.hidl.base.V1_0.DebugInfo> arrayList = new java.util.ArrayList<>();
    ...
    public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.internal.hidl.base.V1_0.DebugInfo> arrayList) {
