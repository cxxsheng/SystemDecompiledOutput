...
public interface IGraphicsStatsCallback extends android.os.IInterface {
    void onRotateGraphicsStatsBuffer() throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.view.IGraphicsStatsCallback {
        ...
        public static android.view.IGraphicsStatsCallback asInterface(android.os.IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            android.os.IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof android.view.IGraphicsStatsCallback)) {
                return (android.view.IGraphicsStatsCallback) queryLocalInterface;
            }
            return new android.view.IGraphicsStatsCallback.Stub.Proxy(iBinder);
        }
        ...
        private static class Proxy implements android.view.IGraphicsStatsCallback {
            ...
            public java.lang.String getInterfaceDescriptor() {
                return android.view.IGraphicsStatsCallback.Stub.DESCRIPTOR;
            }
            ...
            public void onRotateGraphicsStatsBuffer() throws android.os.RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(android.view.IGraphicsStatsCallback.Stub.DESCRIPTOR);
