...
public final class FrameMetrics {
    ...
    public FrameMetrics(android.view.FrameMetrics frameMetrics) {
        this.mTimingData = new long[23];
        java.lang.System.arraycopy(frameMetrics.mTimingData, 0, this.mTimingData, 0, this.mTimingData.length);
    }
    ...
    public long getMetric(int i) {
        if (i < 0 || i > 13 || this.mTimingData == null) {
            return -1L;
        }
        if (i == 9) {
