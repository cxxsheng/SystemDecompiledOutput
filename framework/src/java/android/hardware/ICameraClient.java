...
public interface ICameraClient extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements android.hardware.ICameraClient {
        ...
        public static android.hardware.ICameraClient asInterface(android.os.IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            android.os.IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.ICameraClient)) {
                return (android.hardware.ICameraClient) queryLocalInterface;
            }
            return new android.hardware.ICameraClient.Stub.Proxy(iBinder);
        }
        ...
        private static class Proxy implements android.hardware.ICameraClient {
            ...
            public java.lang.String getInterfaceDescriptor() {
                return android.hardware.ICameraClient.Stub.DESCRIPTOR;
            }
        }
