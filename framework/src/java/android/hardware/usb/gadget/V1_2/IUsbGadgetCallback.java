...
public interface IUsbGadgetCallback extends android.hardware.usb.gadget.V1_0.IUsbGadgetCallback {
    ...
    void getUsbSpeedCb(int i) throws android.os.RemoteException;
    ...
    static android.hardware.usb.gadget.V1_2.IUsbGadgetCallback asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.usb.gadget.V1_2.IUsbGadgetCallback)) {
            return (android.hardware.usb.gadget.V1_2.IUsbGadgetCallback) queryLocalInterface;
        }
        android.hardware.usb.gadget.V1_2.IUsbGadgetCallback.Proxy proxy = new android.hardware.usb.gadget.V1_2.IUsbGadgetCallback.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.usb.gadget.V1_2.IUsbGadgetCallback castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.usb.gadget.V1_2.IUsbGadgetCallback getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.usb.gadget.V1_2.IUsbGadgetCallback getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.usb.gadget.V1_2.IUsbGadgetCallback getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.usb.gadget.V1_2.IUsbGadgetCallback getService() throws android.os.RemoteException {
    ...
    public static final class Proxy implements android.hardware.usb.gadget.V1_2.IUsbGadgetCallback {
        ...
        public void setCurrentUsbFunctionsCb(long j, int i) throws android.os.RemoteException {
        ...
        @Override // android.hardware.usb.gadget.V1_0.IUsbGadgetCallback
        public void getCurrentUsbFunctionsCb(long j, int i) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.usb.gadget.V1_0.IUsbGadgetCallback.kInterfaceName);
            hwParcel.writeInt64(j);
            hwParcel.writeInt32(i);
        ...
        public void getUsbSpeedCb(int i) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.usb.gadget.V1_2.IUsbGadgetCallback.kInterfaceName);
            hwParcel.writeInt32(i);
            android.os.HwParcel hwParcel2 = new android.os.HwParcel();
            try {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.usb.gadget.V1_2.IUsbGadgetCallback {
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.usb.gadget.V1_2.IUsbGadgetCallback.kInterfaceName, android.hardware.usb.gadget.V1_0.IUsbGadgetCallback.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public final java.util.ArrayList<byte[]> getHashChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(new byte[]{-59, 57, 50, 91, 34, -68, -26, -122, -121, 111, 6, 43, android.hardware.biometrics.face.AcquiredInfo.SENSOR_DIRTY, 41, com.android.net.module.util.NetworkStackConstants.TCPHDR_URG, 56, 85, 90, -30, -123, 126, -115, 52, -86, 99, -87, 117, -33, android.hardware.biometrics.face.AcquiredInfo.FIRST_FRAME_RECEIVED, -31, android.hardware.biometrics.face.AcquiredInfo.ROLL_TOO_EXTREME, -79}, new byte[]{-83, 10, 98, 12, -38, 8, -16, com.android.internal.telephony.GsmAlphabet.GSM_EXTENDED_ESCAPE, android.hardware.biometrics.face.AcquiredInfo.START, 28, 48, -53, 122, -6, 35, com.android.internal.midi.MidiConstants.STATUS_CONTROL_CHANGE, 99, 124, -56, 67, 64, -49, -115, -20, 0, -84, -114, 50, -49, 84, -88, -37}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, com.android.internal.midi.MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, com.android.internal.midi.MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, android.hardware.biometrics.face.AcquiredInfo.ROLL_TOO_EXTREME, -109, 36, -72, 59, android.hardware.biometrics.face.AcquiredInfo.FIRST_FRAME_RECEIVED, -54, 76}));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.usb.gadget.V1_2.IUsbGadgetCallback.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                ...
                case 2:
                    ...
                    return;
                case 3:
                    hwParcel.enforceInterface(android.hardware.usb.gadget.V1_2.IUsbGadgetCallback.kInterfaceName);
