...
public interface IUsbGadget extends android.hardware.usb.gadget.V1_0.IUsbGadget {
    public static final java.lang.String kInterfaceName = "android.hardware.usb.gadget@1.1::IUsbGadget";
    ...
    int reset() throws android.os.RemoteException;
    ...
    static android.hardware.usb.gadget.V1_1.IUsbGadget asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.usb.gadget.V1_1.IUsbGadget)) {
            return (android.hardware.usb.gadget.V1_1.IUsbGadget) queryLocalInterface;
        }
        android.hardware.usb.gadget.V1_1.IUsbGadget.Proxy proxy = new android.hardware.usb.gadget.V1_1.IUsbGadget.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.usb.gadget.V1_1.IUsbGadget castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.usb.gadget.V1_1.IUsbGadget getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.usb.gadget.V1_1.IUsbGadget getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.usb.gadget.V1_1.IUsbGadget getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.usb.gadget.V1_1.IUsbGadget getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.usb.gadget.V1_1.IUsbGadget {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.usb.gadget.V1_1.IUsbGadget {
        @Override // android.hardware.usb.gadget.V1_1.IUsbGadget, android.hardware.usb.gadget.V1_0.IUsbGadget, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.usb.gadget.V1_1.IUsbGadget.kInterfaceName, android.hardware.usb.gadget.V1_0.IUsbGadget.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.usb.gadget.V1_1.IUsbGadget.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
