...
public interface IThermalChangedCallback extends android.internal.hidl.base.V1_0.IBase {
    public static final java.lang.String kInterfaceName = "android.hardware.thermal@2.0::IThermalChangedCallback";
    ...
    void notifyThrottling(android.hardware.thermal.V2_0.Temperature temperature) throws android.os.RemoteException;
    ...
    static android.hardware.thermal.V2_0.IThermalChangedCallback asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.thermal.V2_0.IThermalChangedCallback)) {
            return (android.hardware.thermal.V2_0.IThermalChangedCallback) queryLocalInterface;
        }
        android.hardware.thermal.V2_0.IThermalChangedCallback.Proxy proxy = new android.hardware.thermal.V2_0.IThermalChangedCallback.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.thermal.V2_0.IThermalChangedCallback castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.thermal.V2_0.IThermalChangedCallback getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.thermal.V2_0.IThermalChangedCallback getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.thermal.V2_0.IThermalChangedCallback getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.thermal.V2_0.IThermalChangedCallback getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.thermal.V2_0.IThermalChangedCallback {
        ...
        public void notifyThrottling(android.hardware.thermal.V2_0.Temperature temperature) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.thermal.V2_0.IThermalChangedCallback.kInterfaceName);
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.thermal.V2_0.IThermalChangedCallback {
        @Override // android.hardware.thermal.V2_0.IThermalChangedCallback, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.thermal.V2_0.IThermalChangedCallback.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public final java.util.ArrayList<byte[]> getHashChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(new byte[]{-52, 77, 46, com.android.internal.midi.MidiConstants.STATUS_SONG_SELECT, 109, -89, 118, -60, 117, -83, 5, 79, 15, 52, android.hardware.biometrics.face.AcquiredInfo.SENSOR_DIRTY, -40, -88, -122, 93, -17, -99, -98, 33, 41, com.android.internal.midi.MidiConstants.STATUS_MIDI_TIME_CODE, 0, 116, -78, -114, 54, -46, 3}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, com.android.internal.midi.MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, com.android.internal.midi.MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, android.hardware.biometrics.face.AcquiredInfo.ROLL_TOO_EXTREME, -109, 36, -72, 59, android.hardware.biometrics.face.AcquiredInfo.FIRST_FRAME_RECEIVED, -54, 76}));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.thermal.V2_0.IThermalChangedCallback.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                case 1:
                    hwParcel.enforceInterface(android.hardware.thermal.V2_0.IThermalChangedCallback.kInterfaceName);
