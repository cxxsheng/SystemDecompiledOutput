...
public interface IThermal extends android.hardware.thermal.V1_0.IThermal {
    public static final java.lang.String kInterfaceName = "android.hardware.thermal@1.1::IThermal";
    ...
    void registerThermalCallback(android.hardware.thermal.V1_1.IThermalCallback iThermalCallback) throws android.os.RemoteException;
    ...
    static android.hardware.thermal.V1_1.IThermal asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.thermal.V1_1.IThermal)) {
            return (android.hardware.thermal.V1_1.IThermal) queryLocalInterface;
        }
        android.hardware.thermal.V1_1.IThermal.Proxy proxy = new android.hardware.thermal.V1_1.IThermal.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.thermal.V1_1.IThermal castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.thermal.V1_1.IThermal getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.thermal.V1_1.IThermal getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.thermal.V1_1.IThermal getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.thermal.V1_1.IThermal getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.thermal.V1_1.IThermal {
        ...
        public void registerThermalCallback(android.hardware.thermal.V1_1.IThermalCallback iThermalCallback) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.thermal.V1_1.IThermal.kInterfaceName);
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.thermal.V1_1.IThermal {
        @Override // android.hardware.thermal.V1_1.IThermal, android.hardware.thermal.V1_0.IThermal, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.thermal.V1_1.IThermal.kInterfaceName, android.hardware.thermal.V1_0.IThermal.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.thermal.V1_1.IThermal.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, final android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                case 1:
                    ...
                    getTemperatures(new android.hardware.thermal.V1_0.IThermal.getTemperaturesCallback() { // from class: android.hardware.thermal.V1_1.IThermal.Stub.1
                ...
                case 2:
                    hwParcel.enforceInterface(android.hardware.thermal.V1_0.IThermal.kInterfaceName);
                    getCpuUsages(new android.hardware.thermal.V1_0.IThermal.getCpuUsagesCallback() { // from class: android.hardware.thermal.V1_1.IThermal.Stub.2
                ...
                case 3:
                    hwParcel.enforceInterface(android.hardware.thermal.V1_0.IThermal.kInterfaceName);
                    getCoolingDevices(new android.hardware.thermal.V1_0.IThermal.getCoolingDevicesCallback() { // from class: android.hardware.thermal.V1_1.IThermal.Stub.3
                    ...
                    return;
                case 4:
                    hwParcel.enforceInterface(android.hardware.thermal.V1_1.IThermal.kInterfaceName);
                    registerThermalCallback(android.hardware.thermal.V1_1.IThermalCallback.asInterface(hwParcel.readStrongBinder()));
                    hwParcel2.writeStatus(0);
                    hwParcel2.send();
                    return;
                case 256067662:
