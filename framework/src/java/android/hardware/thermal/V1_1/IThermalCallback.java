...
public interface IThermalCallback extends android.internal.hidl.base.V1_0.IBase {
    public static final java.lang.String kInterfaceName = "android.hardware.thermal@1.1::IThermalCallback";
    ...
    void notifyThrottling(boolean z, android.hardware.thermal.V1_0.Temperature temperature) throws android.os.RemoteException;
    ...
    static android.hardware.thermal.V1_1.IThermalCallback asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.thermal.V1_1.IThermalCallback)) {
            return (android.hardware.thermal.V1_1.IThermalCallback) queryLocalInterface;
        }
        android.hardware.thermal.V1_1.IThermalCallback.Proxy proxy = new android.hardware.thermal.V1_1.IThermalCallback.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.thermal.V1_1.IThermalCallback castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.thermal.V1_1.IThermalCallback getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.thermal.V1_1.IThermalCallback getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.thermal.V1_1.IThermalCallback getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.thermal.V1_1.IThermalCallback getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.thermal.V1_1.IThermalCallback {
        ...
        public void notifyThrottling(boolean z, android.hardware.thermal.V1_0.Temperature temperature) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.thermal.V1_1.IThermalCallback.kInterfaceName);
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.thermal.V1_1.IThermalCallback {
        @Override // android.hardware.thermal.V1_1.IThermalCallback, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.thermal.V1_1.IThermalCallback.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.thermal.V1_1.IThermalCallback.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                case 1:
                    hwParcel.enforceInterface(android.hardware.thermal.V1_1.IThermalCallback.kInterfaceName);
