...
public interface ICamera extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements android.hardware.ICamera {
        ...
        public static android.hardware.ICamera asInterface(android.os.IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            android.os.IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.ICamera)) {
                return (android.hardware.ICamera) queryLocalInterface;
            }
            return new android.hardware.ICamera.Stub.Proxy(iBinder);
        }
        ...
        private static class Proxy implements android.hardware.ICamera {
            ...
            public java.lang.String getInterfaceDescriptor() {
                return android.hardware.ICamera.Stub.DESCRIPTOR;
            }
            ...
            public void disconnect() throws android.os.RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(android.hardware.ICamera.Stub.DESCRIPTOR);
