...
public interface IGnssConfiguration extends android.internal.hidl.base.V1_0.IBase {
    public static final java.lang.String kInterfaceName = "android.hardware.gnss@1.0::IGnssConfiguration";
    ...
    boolean setEmergencySuplPdn(boolean z) throws android.os.RemoteException;

    boolean setGlonassPositioningProtocol(byte b) throws android.os.RemoteException;

    boolean setGpsLock(byte b) throws android.os.RemoteException;

    @Override // android.internal.hidl.base.V1_0.IBase
    void setHALInstrumentation() throws android.os.RemoteException;

    boolean setLppProfile(byte b) throws android.os.RemoteException;

    boolean setSuplEs(boolean z) throws android.os.RemoteException;

    boolean setSuplMode(byte b) throws android.os.RemoteException;

    boolean setSuplVersion(int i) throws android.os.RemoteException;

    @Override // android.internal.hidl.base.V1_0.IBase
    boolean unlinkToDeath(android.os.IHwBinder.DeathRecipient deathRecipient) throws android.os.RemoteException;

    static android.hardware.gnss.V1_0.IGnssConfiguration asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.gnss.V1_0.IGnssConfiguration)) {
            return (android.hardware.gnss.V1_0.IGnssConfiguration) queryLocalInterface;
        }
        android.hardware.gnss.V1_0.IGnssConfiguration.Proxy proxy = new android.hardware.gnss.V1_0.IGnssConfiguration.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.gnss.V1_0.IGnssConfiguration castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.gnss.V1_0.IGnssConfiguration getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.gnss.V1_0.IGnssConfiguration getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.gnss.V1_0.IGnssConfiguration getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.gnss.V1_0.IGnssConfiguration getService() throws android.os.RemoteException {
    ...
    public static final class Proxy implements android.hardware.gnss.V1_0.IGnssConfiguration {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.gnss.V1_0.IGnssConfiguration {
        @Override // android.hardware.gnss.V1_0.IGnssConfiguration, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.gnss.V1_0.IGnssConfiguration.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.gnss.V1_0.IGnssConfiguration.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
