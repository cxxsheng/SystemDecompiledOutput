...
public interface IGnssXtraCallback extends android.internal.hidl.base.V1_0.IBase {
    ...
    void downloadRequestCb() throws android.os.RemoteException;
    ...
    static android.hardware.gnss.V1_0.IGnssXtraCallback asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.gnss.V1_0.IGnssXtraCallback)) {
            return (android.hardware.gnss.V1_0.IGnssXtraCallback) queryLocalInterface;
        }
        android.hardware.gnss.V1_0.IGnssXtraCallback.Proxy proxy = new android.hardware.gnss.V1_0.IGnssXtraCallback.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.gnss.V1_0.IGnssXtraCallback castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.gnss.V1_0.IGnssXtraCallback getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.gnss.V1_0.IGnssXtraCallback getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.gnss.V1_0.IGnssXtraCallback getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.gnss.V1_0.IGnssXtraCallback getService() throws android.os.RemoteException {
    ...
    public static final class Proxy implements android.hardware.gnss.V1_0.IGnssXtraCallback {
        ...
        public void downloadRequestCb() throws android.os.RemoteException {
            ...
            hwParcel.writeInterfaceToken(android.hardware.gnss.V1_0.IGnssXtraCallback.kInterfaceName);
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.gnss.V1_0.IGnssXtraCallback {
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.gnss.V1_0.IGnssXtraCallback.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.gnss.V1_0.IGnssXtraCallback.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                case 1:
                    hwParcel.enforceInterface(android.hardware.gnss.V1_0.IGnssXtraCallback.kInterfaceName);
                    downloadRequestCb();
