...
public interface IGnssNiCallback extends android.internal.hidl.base.V1_0.IBase {
    ...
    void niNotifyCb(android.hardware.gnss.V1_0.IGnssNiCallback.GnssNiNotification gnssNiNotification) throws android.os.RemoteException;
    ...
    static android.hardware.gnss.V1_0.IGnssNiCallback asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.gnss.V1_0.IGnssNiCallback)) {
            return (android.hardware.gnss.V1_0.IGnssNiCallback) queryLocalInterface;
        }
        android.hardware.gnss.V1_0.IGnssNiCallback.Proxy proxy = new android.hardware.gnss.V1_0.IGnssNiCallback.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.gnss.V1_0.IGnssNiCallback castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.gnss.V1_0.IGnssNiCallback getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.gnss.V1_0.IGnssNiCallback getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.gnss.V1_0.IGnssNiCallback getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.gnss.V1_0.IGnssNiCallback getService() throws android.os.RemoteException {
    ...
    public static final class GnssNiNotification {
        ...
        public java.lang.String notificationMessage = new java.lang.String();
        ...
        public final boolean equals(java.lang.Object obj) {
            ...
            if (obj == null || obj.getClass() != android.hardware.gnss.V1_0.IGnssNiCallback.GnssNiNotification.class) {
                return false;
            }
            android.hardware.gnss.V1_0.IGnssNiCallback.GnssNiNotification gnssNiNotification = (android.hardware.gnss.V1_0.IGnssNiCallback.GnssNiNotification) obj;
            if (this.notificationId == gnssNiNotification.notificationId && this.niType == gnssNiNotification.niType && android.os.HidlSupport.deepEquals(java.lang.Integer.valueOf(this.notifyFlags), java.lang.Integer.valueOf(gnssNiNotification.notifyFlags)) && this.timeoutSec == gnssNiNotification.timeoutSec && this.defaultResponse == gnssNiNotification.defaultResponse && android.os.HidlSupport.deepEquals(this.requestorId, gnssNiNotification.requestorId) && android.os.HidlSupport.deepEquals(this.notificationMessage, gnssNiNotification.notificationMessage) && this.requestorIdEncoding == gnssNiNotification.requestorIdEncoding && this.notificationIdEncoding == gnssNiNotification.notificationIdEncoding) {
                return true;
            }
            return false;
        }
        ...
        public final int hashCode() {
            return java.util.Objects.hash(java.lang.Integer.valueOf(android.os.HidlSupport.deepHashCode(java.lang.Integer.valueOf(this.notificationId))), java.lang.Integer.valueOf(android.os.HidlSupport.deepHashCode(java.lang.Byte.valueOf(this.niType))), java.lang.Integer.valueOf(android.os.HidlSupport.deepHashCode(java.lang.Integer.valueOf(this.notifyFlags))), java.lang.Integer.valueOf(android.os.HidlSupport.deepHashCode(java.lang.Integer.valueOf(this.timeoutSec))), java.lang.Integer.valueOf(android.os.HidlSupport.deepHashCode(java.lang.Byte.valueOf(this.defaultResponse))), java.lang.Integer.valueOf(android.os.HidlSupport.deepHashCode(this.requestorId)), java.lang.Integer.valueOf(android.os.HidlSupport.deepHashCode(this.notificationMessage)), java.lang.Integer.valueOf(android.os.HidlSupport.deepHashCode(java.lang.Integer.valueOf(this.requestorIdEncoding))), java.lang.Integer.valueOf(android.os.HidlSupport.deepHashCode(java.lang.Integer.valueOf(this.notificationIdEncoding))));
        }

        public final java.lang.String toString() {
            return "{.notificationId = " + this.notificationId + ", .niType = " + android.hardware.gnss.V1_0.IGnssNiCallback.GnssNiType.toString(this.niType) + ", .notifyFlags = " + android.hardware.gnss.V1_0.IGnssNiCallback.GnssNiNotifyFlags.dumpBitfield(this.notifyFlags) + ", .timeoutSec = " + this.timeoutSec + ", .defaultResponse = " + android.hardware.gnss.V1_0.IGnssNiCallback.GnssUserResponseType.toString(this.defaultResponse) + ", .requestorId = " + this.requestorId + ", .notificationMessage = " + this.notificationMessage + ", .requestorIdEncoding = " + android.hardware.gnss.V1_0.IGnssNiCallback.GnssNiEncodingType.toString(this.requestorIdEncoding) + ", .notificationIdEncoding = " + android.hardware.gnss.V1_0.IGnssNiCallback.GnssNiEncodingType.toString(this.notificationIdEncoding) + "}";
        }
        ...
        public static final java.util.ArrayList<android.hardware.gnss.V1_0.IGnssNiCallback.GnssNiNotification> readVectorFromParcel(android.os.HwParcel hwParcel) {
            java.util.ArrayList<android.hardware.gnss.V1_0.IGnssNiCallback.GnssNiNotification> arrayList = new java.util.ArrayList<>();
            android.os.HwBlob readBuffer = hwParcel.readBuffer(16L);
            int int32 = readBuffer.getInt32(8L);
            android.os.HwBlob readEmbeddedBuffer = hwParcel.readEmbeddedBuffer(int32 * 64, readBuffer.handle(), 0L, true);
            arrayList.clear();
            for (int i = 0; i < int32; i++) {
                android.hardware.gnss.V1_0.IGnssNiCallback.GnssNiNotification gnssNiNotification = new android.hardware.gnss.V1_0.IGnssNiCallback.GnssNiNotification();
        ...
        public final void readEmbeddedFromParcel(android.os.HwParcel hwParcel, android.os.HwBlob hwBlob, long j) {
            this.notificationId = hwBlob.getInt32(j + 0);
            ...
            hwParcel.readEmbeddedBuffer(this.requestorId.getBytes().length + 1, hwBlob.handle(), j2 + 0, false);
            long j3 = j + 40;
            this.notificationMessage = hwBlob.getString(j3);
            hwParcel.readEmbeddedBuffer(this.notificationMessage.getBytes().length + 1, hwBlob.handle(), j3 + 0, false);
        ...
        public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.hardware.gnss.V1_0.IGnssNiCallback.GnssNiNotification> arrayList) {
        ...
        public final void writeEmbeddedToBlob(android.os.HwBlob hwBlob, long j) {
            hwBlob.putInt32(0 + j, this.notificationId);
    ...
    public static final class Proxy implements android.hardware.gnss.V1_0.IGnssNiCallback {
        ...
        public void niNotifyCb(android.hardware.gnss.V1_0.IGnssNiCallback.GnssNiNotification gnssNiNotification) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.gnss.V1_0.IGnssNiCallback.kInterfaceName);
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.gnss.V1_0.IGnssNiCallback {
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.gnss.V1_0.IGnssNiCallback.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.gnss.V1_0.IGnssNiCallback.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                case 1:
                    hwParcel.enforceInterface(android.hardware.gnss.V1_0.IGnssNiCallback.kInterfaceName);
                    android.hardware.gnss.V1_0.IGnssNiCallback.GnssNiNotification gnssNiNotification = new android.hardware.gnss.V1_0.IGnssNiCallback.GnssNiNotification();
