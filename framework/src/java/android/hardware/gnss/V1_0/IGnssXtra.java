...
public interface IGnssXtra extends android.internal.hidl.base.V1_0.IBase {
    public static final java.lang.String kInterfaceName = "android.hardware.gnss@1.0::IGnssXtra";
    ...
    boolean injectXtraData(java.lang.String str) throws android.os.RemoteException;
    ...
    boolean setCallback(android.hardware.gnss.V1_0.IGnssXtraCallback iGnssXtraCallback) throws android.os.RemoteException;
    ...
    static android.hardware.gnss.V1_0.IGnssXtra asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.gnss.V1_0.IGnssXtra)) {
            return (android.hardware.gnss.V1_0.IGnssXtra) queryLocalInterface;
        }
        android.hardware.gnss.V1_0.IGnssXtra.Proxy proxy = new android.hardware.gnss.V1_0.IGnssXtra.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.gnss.V1_0.IGnssXtra castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.gnss.V1_0.IGnssXtra getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.gnss.V1_0.IGnssXtra getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.gnss.V1_0.IGnssXtra getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.gnss.V1_0.IGnssXtra getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.gnss.V1_0.IGnssXtra {
        ...
        public boolean setCallback(android.hardware.gnss.V1_0.IGnssXtraCallback iGnssXtraCallback) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.gnss.V1_0.IGnssXtra.kInterfaceName);
        ...
        @Override // android.hardware.gnss.V1_0.IGnssXtra
        public boolean injectXtraData(java.lang.String str) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.gnss.V1_0.IGnssXtra.kInterfaceName);
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.gnss.V1_0.IGnssXtra {
        @Override // android.hardware.gnss.V1_0.IGnssXtra, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.gnss.V1_0.IGnssXtra.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.gnss.V1_0.IGnssXtra.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                case 1:
                    hwParcel.enforceInterface(android.hardware.gnss.V1_0.IGnssXtra.kInterfaceName);
                    boolean callback = setCallback(android.hardware.gnss.V1_0.IGnssXtraCallback.asInterface(hwParcel.readStrongBinder()));
