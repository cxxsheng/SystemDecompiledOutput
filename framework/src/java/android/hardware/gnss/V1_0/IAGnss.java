...
public interface IAGnss extends android.internal.hidl.base.V1_0.IBase {
    ...
    boolean dataConnOpen(java.lang.String str, byte b) throws android.os.RemoteException;
    ...
    void setCallback(android.hardware.gnss.V1_0.IAGnssCallback iAGnssCallback) throws android.os.RemoteException;
    ...
    static android.hardware.gnss.V1_0.IAGnss asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.gnss.V1_0.IAGnss)) {
            return (android.hardware.gnss.V1_0.IAGnss) queryLocalInterface;
        }
        android.hardware.gnss.V1_0.IAGnss.Proxy proxy = new android.hardware.gnss.V1_0.IAGnss.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.gnss.V1_0.IAGnss castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.gnss.V1_0.IAGnss getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.gnss.V1_0.IAGnss getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.gnss.V1_0.IAGnss getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.gnss.V1_0.IAGnss getService() throws android.os.RemoteException {
    ...
    public static final class Proxy implements android.hardware.gnss.V1_0.IAGnss {
        ...
        public void setCallback(android.hardware.gnss.V1_0.IAGnssCallback iAGnssCallback) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.gnss.V1_0.IAGnss.kInterfaceName);
        ...
        @Override // android.hardware.gnss.V1_0.IAGnss
        public boolean dataConnOpen(java.lang.String str, byte b) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.gnss.V1_0.IAGnss.kInterfaceName);
            hwParcel.writeString(str);
            hwParcel.writeInt8(b);
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.gnss.V1_0.IAGnss {
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.gnss.V1_0.IAGnss.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.gnss.V1_0.IAGnss.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                case 1:
                    hwParcel.enforceInterface(android.hardware.gnss.V1_0.IAGnss.kInterfaceName);
                    setCallback(android.hardware.gnss.V1_0.IAGnssCallback.asInterface(hwParcel.readStrongBinder()));
