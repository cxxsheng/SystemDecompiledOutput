...
public interface IGnssMeasurement extends android.hardware.gnss.V1_1.IGnssMeasurement {
    public static final java.lang.String kInterfaceName = "android.hardware.gnss@2.0::IGnssMeasurement";
    ...
    int setCallback_2_0(android.hardware.gnss.V2_0.IGnssMeasurementCallback iGnssMeasurementCallback, boolean z) throws android.os.RemoteException;
    ...
    static android.hardware.gnss.V2_0.IGnssMeasurement asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.gnss.V2_0.IGnssMeasurement)) {
            return (android.hardware.gnss.V2_0.IGnssMeasurement) queryLocalInterface;
        }
        android.hardware.gnss.V2_0.IGnssMeasurement.Proxy proxy = new android.hardware.gnss.V2_0.IGnssMeasurement.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.gnss.V2_0.IGnssMeasurement castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.gnss.V2_0.IGnssMeasurement getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.gnss.V2_0.IGnssMeasurement getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.gnss.V2_0.IGnssMeasurement getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.gnss.V2_0.IGnssMeasurement getService() throws android.os.RemoteException {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.gnss.V2_0.IGnssMeasurement {
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.gnss.V2_0.IGnssMeasurement.kInterfaceName, android.hardware.gnss.V1_1.IGnssMeasurement.kInterfaceName, android.hardware.gnss.V1_0.IGnssMeasurement.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.gnss.V2_0.IGnssMeasurement.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
