...
public interface IGnssBatching extends android.hardware.gnss.V1_0.IGnssBatching {
    public static final java.lang.String kInterfaceName = "android.hardware.gnss@2.0::IGnssBatching";
    ...
    boolean init_2_0(android.hardware.gnss.V2_0.IGnssBatchingCallback iGnssBatchingCallback) throws android.os.RemoteException;
    ...
    static android.hardware.gnss.V2_0.IGnssBatching asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.gnss.V2_0.IGnssBatching)) {
            return (android.hardware.gnss.V2_0.IGnssBatching) queryLocalInterface;
        }
        android.hardware.gnss.V2_0.IGnssBatching.Proxy proxy = new android.hardware.gnss.V2_0.IGnssBatching.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.gnss.V2_0.IGnssBatching castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.gnss.V2_0.IGnssBatching getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.gnss.V2_0.IGnssBatching getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.gnss.V2_0.IGnssBatching getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.gnss.V2_0.IGnssBatching getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.gnss.V2_0.IGnssBatching {
        ...
        public boolean init_2_0(android.hardware.gnss.V2_0.IGnssBatchingCallback iGnssBatchingCallback) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.gnss.V2_0.IGnssBatching.kInterfaceName);
            hwParcel.writeStrongBinder(iGnssBatchingCallback == null ? null : iGnssBatchingCallback.asBinder());
            android.os.HwParcel hwParcel2 = new android.os.HwParcel();
            try {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.gnss.V2_0.IGnssBatching {
        @Override // android.hardware.gnss.V2_0.IGnssBatching, android.hardware.gnss.V1_0.IGnssBatching, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.gnss.V2_0.IGnssBatching.kInterfaceName, android.hardware.gnss.V1_0.IGnssBatching.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.gnss.V2_0.IGnssBatching.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                ...
                case 6:
                    ...
                    return;
                case 7:
                    hwParcel.enforceInterface(android.hardware.gnss.V2_0.IGnssBatching.kInterfaceName);
                    boolean init_2_0 = init_2_0(android.hardware.gnss.V2_0.IGnssBatchingCallback.asInterface(hwParcel.readStrongBinder()));
                    hwParcel2.writeStatus(0);
