...
public interface IAGnss extends android.internal.hidl.base.V1_0.IBase {
    public static final java.lang.String kInterfaceName = "android.hardware.gnss@2.0::IAGnss";

    @Override // android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
    android.os.IHwBinder asBinder();

    boolean dataConnClosed() throws android.os.RemoteException;

    boolean dataConnFailed() throws android.os.RemoteException;

    boolean dataConnOpen(long j, java.lang.String str, byte b) throws android.os.RemoteException;
    ...
    void setCallback(android.hardware.gnss.V2_0.IAGnssCallback iAGnssCallback) throws android.os.RemoteException;

    @Override // android.internal.hidl.base.V1_0.IBase
    void setHALInstrumentation() throws android.os.RemoteException;

    boolean setServer(byte b, java.lang.String str, int i) throws android.os.RemoteException;

    @Override // android.internal.hidl.base.V1_0.IBase
    boolean unlinkToDeath(android.os.IHwBinder.DeathRecipient deathRecipient) throws android.os.RemoteException;

    static android.hardware.gnss.V2_0.IAGnss asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.gnss.V2_0.IAGnss)) {
            return (android.hardware.gnss.V2_0.IAGnss) queryLocalInterface;
        }
        android.hardware.gnss.V2_0.IAGnss.Proxy proxy = new android.hardware.gnss.V2_0.IAGnss.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.gnss.V2_0.IAGnss castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.gnss.V2_0.IAGnss getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.gnss.V2_0.IAGnss getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.gnss.V2_0.IAGnss getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.gnss.V2_0.IAGnss getService() throws android.os.RemoteException {
    ...
    public static final class ApnIpType {
        ...
        public static final java.lang.String toString(byte b) {
            ...
            if (b == 1) {
                return android.telephony.ims.SipDelegateImsConfiguration.IPTYPE_IPV4;
            }
            if (b == 2) {
                return "IPV6";
            }
        ...
        public static final java.lang.String dumpBitfield(byte b) {
            ...
            if ((b & 1) != 1) {
                ...
                arrayList.add(android.telephony.ims.SipDelegateImsConfiguration.IPTYPE_IPV4);
                b2 = (byte) 1;
            }
            if ((b & 2) == 2) {
                arrayList.add("IPV6");
    ...
    public static final class Proxy implements android.hardware.gnss.V2_0.IAGnss {
        ...
        public void setCallback(android.hardware.gnss.V2_0.IAGnssCallback iAGnssCallback) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.gnss.V2_0.IAGnss.kInterfaceName);
        ...
        @Override // android.hardware.gnss.V2_0.IAGnss
        public boolean setServer(byte b, java.lang.String str, int i) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.gnss.V2_0.IAGnss.kInterfaceName);
        ...
        @Override // android.hardware.gnss.V2_0.IAGnss
        public boolean dataConnOpen(long j, java.lang.String str, byte b) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.gnss.V2_0.IAGnss.kInterfaceName);
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.gnss.V2_0.IAGnss {
        @Override // android.hardware.gnss.V2_0.IAGnss, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.gnss.V2_0.IAGnss.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public final java.util.ArrayList<byte[]> getHashChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(new byte[]{Byte.MAX_VALUE, 70, 14, 121, 95, 93, 30, -43, -29, 120, -109, 95, -104, -58, -37, 77, 57, 73, 125, -23, -120, -82, com.android.internal.midi.MidiConstants.STATUS_MIDI_TIME_CODE, -76, -62, -92, com.android.internal.midi.MidiConstants.STATUS_POLYPHONIC_AFTERTOUCH, 122, 108, 64, 3, -110}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, com.android.internal.midi.MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, com.android.internal.midi.MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, android.hardware.biometrics.face.AcquiredInfo.ROLL_TOO_EXTREME, -109, 36, -72, 59, android.hardware.biometrics.face.AcquiredInfo.FIRST_FRAME_RECEIVED, -54, 76}));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.gnss.V2_0.IAGnss.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                case 1:
                    hwParcel.enforceInterface(android.hardware.gnss.V2_0.IAGnss.kInterfaceName);
                    setCallback(android.hardware.gnss.V2_0.IAGnssCallback.asInterface(hwParcel.readStrongBinder()));
