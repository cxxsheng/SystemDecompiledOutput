...
public interface IGnssBatchingCallback extends android.internal.hidl.base.V1_0.IBase {
    public static final java.lang.String kInterfaceName = "android.hardware.gnss@2.0::IGnssBatchingCallback";
    ...
    void gnssLocationBatchCb(java.util.ArrayList<android.hardware.gnss.V2_0.GnssLocation> arrayList) throws android.os.RemoteException;
    ...
    static android.hardware.gnss.V2_0.IGnssBatchingCallback asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.gnss.V2_0.IGnssBatchingCallback)) {
            return (android.hardware.gnss.V2_0.IGnssBatchingCallback) queryLocalInterface;
        }
        android.hardware.gnss.V2_0.IGnssBatchingCallback.Proxy proxy = new android.hardware.gnss.V2_0.IGnssBatchingCallback.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.gnss.V2_0.IGnssBatchingCallback castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.gnss.V2_0.IGnssBatchingCallback getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.gnss.V2_0.IGnssBatchingCallback getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.gnss.V2_0.IGnssBatchingCallback getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.gnss.V2_0.IGnssBatchingCallback getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.gnss.V2_0.IGnssBatchingCallback {
        ...
        public void gnssLocationBatchCb(java.util.ArrayList<android.hardware.gnss.V2_0.GnssLocation> arrayList) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.gnss.V2_0.IGnssBatchingCallback.kInterfaceName);
            android.hardware.gnss.V2_0.GnssLocation.writeVectorToParcel(hwParcel, arrayList);
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.gnss.V2_0.IGnssBatchingCallback {
        @Override // android.hardware.gnss.V2_0.IGnssBatchingCallback, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.gnss.V2_0.IGnssBatchingCallback.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public final java.util.ArrayList<byte[]> getHashChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(new byte[]{31, -119, 57, 47, 30, -69, 105, 61, -113, -90, -11, 3, 36, -79, 99, 95, -57, -97, -85, 36, 109, 49, com.android.internal.midi.MidiConstants.STATUS_NOTE_ON, 14, 99, -103, -114, com.android.internal.telephony.GsmAlphabet.GSM_EXTENDED_ESCAPE, 14, android.hardware.biometrics.face.AcquiredInfo.VENDOR, 81, 28}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, com.android.internal.midi.MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, com.android.internal.midi.MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, android.hardware.biometrics.face.AcquiredInfo.ROLL_TOO_EXTREME, -109, 36, -72, 59, android.hardware.biometrics.face.AcquiredInfo.FIRST_FRAME_RECEIVED, -54, 76}));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.gnss.V2_0.IGnssBatchingCallback.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                case 1:
                    hwParcel.enforceInterface(android.hardware.gnss.V2_0.IGnssBatchingCallback.kInterfaceName);
                    gnssLocationBatchCb(android.hardware.gnss.V2_0.GnssLocation.readVectorFromParcel(hwParcel));
