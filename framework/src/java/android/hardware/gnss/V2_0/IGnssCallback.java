...
public interface IGnssCallback extends android.hardware.gnss.V1_1.IGnssCallback {
    ...
    void gnssLocationCb_2_0(android.hardware.gnss.V2_0.GnssLocation gnssLocation) throws android.os.RemoteException;

    void gnssRequestLocationCb_2_0(boolean z, boolean z2) throws android.os.RemoteException;

    void gnssSetCapabilitiesCb_2_0(int i) throws android.os.RemoteException;

    void gnssSvStatusCb_2_0(java.util.ArrayList<android.hardware.gnss.V2_0.IGnssCallback.GnssSvInfo> arrayList) throws android.os.RemoteException;
    ...
    static android.hardware.gnss.V2_0.IGnssCallback asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.gnss.V2_0.IGnssCallback)) {
            return (android.hardware.gnss.V2_0.IGnssCallback) queryLocalInterface;
        }
        android.hardware.gnss.V2_0.IGnssCallback.Proxy proxy = new android.hardware.gnss.V2_0.IGnssCallback.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.gnss.V2_0.IGnssCallback castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.gnss.V2_0.IGnssCallback getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.gnss.V2_0.IGnssCallback getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.gnss.V2_0.IGnssCallback getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.gnss.V2_0.IGnssCallback getService() throws android.os.RemoteException {
    ...
    public static final class GnssSvInfo {
        ...
        public final boolean equals(java.lang.Object obj) {
            ...
            if (obj == null || obj.getClass() != android.hardware.gnss.V2_0.IGnssCallback.GnssSvInfo.class) {
                return false;
            }
            android.hardware.gnss.V2_0.IGnssCallback.GnssSvInfo gnssSvInfo = (android.hardware.gnss.V2_0.IGnssCallback.GnssSvInfo) obj;
            if (android.os.HidlSupport.deepEquals(this.v1_0, gnssSvInfo.v1_0) && this.constellation == gnssSvInfo.constellation) {
                return true;
            }
            return false;
        }
        ...
        public static final java.util.ArrayList<android.hardware.gnss.V2_0.IGnssCallback.GnssSvInfo> readVectorFromParcel(android.os.HwParcel hwParcel) {
            java.util.ArrayList<android.hardware.gnss.V2_0.IGnssCallback.GnssSvInfo> arrayList = new java.util.ArrayList<>();
            android.os.HwBlob readBuffer = hwParcel.readBuffer(16L);
            int int32 = readBuffer.getInt32(8L);
            android.os.HwBlob readEmbeddedBuffer = hwParcel.readEmbeddedBuffer(int32 * 28, readBuffer.handle(), 0L, true);
            arrayList.clear();
            for (int i = 0; i < int32; i++) {
                android.hardware.gnss.V2_0.IGnssCallback.GnssSvInfo gnssSvInfo = new android.hardware.gnss.V2_0.IGnssCallback.GnssSvInfo();
        ...
        public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.hardware.gnss.V2_0.IGnssCallback.GnssSvInfo> arrayList) {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.gnss.V2_0.IGnssCallback {
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.gnss.V2_0.IGnssCallback.kInterfaceName, android.hardware.gnss.V1_1.IGnssCallback.kInterfaceName, android.hardware.gnss.V1_0.IGnssCallback.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.gnss.V2_0.IGnssCallback.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
