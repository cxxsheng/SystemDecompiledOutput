...
public interface IGnssAntennaInfo extends android.internal.hidl.base.V1_0.IBase {
    public static final java.lang.String kInterfaceName = "android.hardware.gnss@2.1::IGnssAntennaInfo";
    ...
    int setCallback(android.hardware.gnss.V2_1.IGnssAntennaInfoCallback iGnssAntennaInfoCallback) throws android.os.RemoteException;
    ...
    static android.hardware.gnss.V2_1.IGnssAntennaInfo asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.gnss.V2_1.IGnssAntennaInfo)) {
            return (android.hardware.gnss.V2_1.IGnssAntennaInfo) queryLocalInterface;
        }
        android.hardware.gnss.V2_1.IGnssAntennaInfo.Proxy proxy = new android.hardware.gnss.V2_1.IGnssAntennaInfo.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.gnss.V2_1.IGnssAntennaInfo castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.gnss.V2_1.IGnssAntennaInfo getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.gnss.V2_1.IGnssAntennaInfo getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.gnss.V2_1.IGnssAntennaInfo getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.gnss.V2_1.IGnssAntennaInfo getService() throws android.os.RemoteException {
    ...
    public static final class Proxy implements android.hardware.gnss.V2_1.IGnssAntennaInfo {
        ...
        public int setCallback(android.hardware.gnss.V2_1.IGnssAntennaInfoCallback iGnssAntennaInfoCallback) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.gnss.V2_1.IGnssAntennaInfo.kInterfaceName);
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.gnss.V2_1.IGnssAntennaInfo {
        @Override // android.hardware.gnss.V2_1.IGnssAntennaInfo, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.gnss.V2_1.IGnssAntennaInfo.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.gnss.V2_1.IGnssAntennaInfo.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                case 1:
                    hwParcel.enforceInterface(android.hardware.gnss.V2_1.IGnssAntennaInfo.kInterfaceName);
                    int callback = setCallback(android.hardware.gnss.V2_1.IGnssAntennaInfoCallback.asInterface(hwParcel.readStrongBinder()));
