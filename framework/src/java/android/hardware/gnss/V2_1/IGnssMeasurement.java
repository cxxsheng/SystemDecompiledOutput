...
public interface IGnssMeasurement extends android.hardware.gnss.V2_0.IGnssMeasurement {
    public static final java.lang.String kInterfaceName = "android.hardware.gnss@2.1::IGnssMeasurement";
    ...
    int setCallback_2_1(android.hardware.gnss.V2_1.IGnssMeasurementCallback iGnssMeasurementCallback, boolean z) throws android.os.RemoteException;
    ...
    static android.hardware.gnss.V2_1.IGnssMeasurement asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.gnss.V2_1.IGnssMeasurement)) {
            return (android.hardware.gnss.V2_1.IGnssMeasurement) queryLocalInterface;
        }
        android.hardware.gnss.V2_1.IGnssMeasurement.Proxy proxy = new android.hardware.gnss.V2_1.IGnssMeasurement.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.gnss.V2_1.IGnssMeasurement castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.gnss.V2_1.IGnssMeasurement getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.gnss.V2_1.IGnssMeasurement getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.gnss.V2_1.IGnssMeasurement getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.gnss.V2_1.IGnssMeasurement getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.gnss.V2_1.IGnssMeasurement {
        ...
        public int setCallback_2_0(android.hardware.gnss.V2_0.IGnssMeasurementCallback iGnssMeasurementCallback, boolean z) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
        ...
        public int setCallback_2_1(android.hardware.gnss.V2_1.IGnssMeasurementCallback iGnssMeasurementCallback, boolean z) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.gnss.V2_1.IGnssMeasurement.kInterfaceName);
            hwParcel.writeStrongBinder(iGnssMeasurementCallback == null ? null : iGnssMeasurementCallback.asBinder());
            hwParcel.writeBool(z);
            android.os.HwParcel hwParcel2 = new android.os.HwParcel();
            try {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.gnss.V2_1.IGnssMeasurement {
        @Override // android.hardware.gnss.V2_1.IGnssMeasurement, android.hardware.gnss.V2_0.IGnssMeasurement, android.hardware.gnss.V1_1.IGnssMeasurement, android.hardware.gnss.V1_0.IGnssMeasurement, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.gnss.V2_1.IGnssMeasurement.kInterfaceName, android.hardware.gnss.V2_0.IGnssMeasurement.kInterfaceName, android.hardware.gnss.V1_1.IGnssMeasurement.kInterfaceName, android.hardware.gnss.V1_0.IGnssMeasurement.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public final java.util.ArrayList<byte[]> getHashChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(new byte[]{121, android.hardware.biometrics.face.AcquiredInfo.ROLL_TOO_EXTREME, -95, android.hardware.biometrics.face.AcquiredInfo.TILT_TOO_EXTREME, 6, -91, 119, -79, 42, -34, -122, -89, -49, 63, -107, -62, 99, -100, -75, 20, com.android.internal.midi.MidiConstants.STATUS_CHANNEL_PRESSURE, -122, 103, 63, 39, -101, -7, -110, 56, -55, -111, 126}, new byte[]{-58, 119, 89, -11, -42, 56, 125, 39, 59, 102, 114, -111, Byte.MIN_VALUE, com.android.internal.midi.MidiConstants.STATUS_CHANNEL_PRESSURE, 54, com.android.internal.midi.MidiConstants.STATUS_NOTE_ON, -24, 39, -16, -74, -72, -44, -31, 60, -30, -1, 66, -45, com.android.internal.telephony.GsmAlphabet.GSM_EXTENDED_ESCAPE, 34, 64, 101}, new byte[]{android.hardware.biometrics.face.AcquiredInfo.MOUTH_COVERING_DETECTED, 7, -47, 56, 62, -124, 124, 61, -21, 105, 110, -57, -94, -55, -29, 59, -106, -125, 119, 41, 69, 102, 4, 72, com.android.internal.midi.MidiConstants.STATUS_POLYPHONIC_AFTERTOUCH, 16, -79, Byte.MIN_VALUE, 99, -38, 103, -92}, new byte[]{-98, -88, -104, 123, -79, 8, -100, -116, 93, 123, 103, -122, 101, 117, -72, 102, -17, 81, 96, 69, 2, 29, -98, -4, -61, 124, 99, 82, -68, com.android.internal.midi.MidiConstants.STATUS_PITCH_BEND, 114, -93}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, com.android.internal.midi.MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, com.android.internal.midi.MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, android.hardware.biometrics.face.AcquiredInfo.ROLL_TOO_EXTREME, -109, 36, -72, 59, android.hardware.biometrics.face.AcquiredInfo.FIRST_FRAME_RECEIVED, -54, 76}));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.gnss.V2_1.IGnssMeasurement.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                ...
                case 4:
                    ...
                    return;
                case 5:
                    hwParcel.enforceInterface(android.hardware.gnss.V2_1.IGnssMeasurement.kInterfaceName);
                    int callback_2_1 = setCallback_2_1(android.hardware.gnss.V2_1.IGnssMeasurementCallback.asInterface(hwParcel.readStrongBinder()), hwParcel.readBool());
                    hwParcel2.writeStatus(0);
