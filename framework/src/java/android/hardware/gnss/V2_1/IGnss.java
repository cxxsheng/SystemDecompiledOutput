...
public interface IGnss extends android.hardware.gnss.V2_0.IGnss {
    ...
    android.hardware.gnss.V2_1.IGnssAntennaInfo getExtensionGnssAntennaInfo() throws android.os.RemoteException;

    android.hardware.gnss.V2_1.IGnssConfiguration getExtensionGnssConfiguration_2_1() throws android.os.RemoteException;

    android.hardware.gnss.V2_1.IGnssMeasurement getExtensionGnssMeasurement_2_1() throws android.os.RemoteException;

    android.hardware.gnss.measurement_corrections.V1_1.IMeasurementCorrections getExtensionMeasurementCorrections_1_1() throws android.os.RemoteException;
    ...
    boolean setCallback_2_1(android.hardware.gnss.V2_1.IGnssCallback iGnssCallback) throws android.os.RemoteException;
    ...
    static android.hardware.gnss.V2_1.IGnss asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.gnss.V2_1.IGnss)) {
            return (android.hardware.gnss.V2_1.IGnss) queryLocalInterface;
        }
        android.hardware.gnss.V2_1.IGnss.Proxy proxy = new android.hardware.gnss.V2_1.IGnss.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.gnss.V2_1.IGnss castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.gnss.V2_1.IGnss getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.gnss.V2_1.IGnss getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.gnss.V2_1.IGnss getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.gnss.V2_1.IGnss getService() throws android.os.RemoteException {
    ...
    public static final class Proxy implements android.hardware.gnss.V2_1.IGnss {
        ...
        public boolean setCallback_2_1(android.hardware.gnss.V2_1.IGnssCallback iGnssCallback) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.gnss.V2_1.IGnss.kInterfaceName);
            hwParcel.writeStrongBinder(iGnssCallback == null ? null : iGnssCallback.asBinder());
            android.os.HwParcel hwParcel2 = new android.os.HwParcel();
            try {
        ...
        public android.hardware.gnss.V2_1.IGnssMeasurement getExtensionGnssMeasurement_2_1() throws android.os.RemoteException {
            ...
            try {
                ...
                hwParcel2.verifySuccess();
                hwParcel.releaseTemporaryStorage();
                return android.hardware.gnss.V2_1.IGnssMeasurement.asInterface(hwParcel2.readStrongBinder());
            } finally {
                hwParcel2.release();
            }
        }
        ...
        public android.hardware.gnss.V2_1.IGnssConfiguration getExtensionGnssConfiguration_2_1() throws android.os.RemoteException {
            ...
            try {
                ...
                hwParcel2.verifySuccess();
                hwParcel.releaseTemporaryStorage();
                return android.hardware.gnss.V2_1.IGnssConfiguration.asInterface(hwParcel2.readStrongBinder());
            } finally {
                hwParcel2.release();
            }
        }
        ...
        public android.hardware.gnss.measurement_corrections.V1_1.IMeasurementCorrections getExtensionMeasurementCorrections_1_1() throws android.os.RemoteException {
            ...
            try {
                ...
                hwParcel2.verifySuccess();
                hwParcel.releaseTemporaryStorage();
                return android.hardware.gnss.measurement_corrections.V1_1.IMeasurementCorrections.asInterface(hwParcel2.readStrongBinder());
            } finally {
                hwParcel2.release();
            }
        }
        ...
        public android.hardware.gnss.V2_1.IGnssAntennaInfo getExtensionGnssAntennaInfo() throws android.os.RemoteException {
            ...
            try {
                ...
                hwParcel2.verifySuccess();
                hwParcel.releaseTemporaryStorage();
                return android.hardware.gnss.V2_1.IGnssAntennaInfo.asInterface(hwParcel2.readStrongBinder());
            } finally {
                hwParcel2.release();
            }
        }
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.gnss.V2_1.IGnss {
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.gnss.V2_1.IGnss.kInterfaceName, android.hardware.gnss.V2_0.IGnss.kInterfaceName, android.hardware.gnss.V1_1.IGnss.kInterfaceName, android.hardware.gnss.V1_0.IGnss.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.gnss.V2_1.IGnss.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                ...
                case 33:
                    ...
                    return;
                case 34:
                    hwParcel.enforceInterface(android.hardware.gnss.V2_1.IGnss.kInterfaceName);
                    boolean callback_2_1 = setCallback_2_1(android.hardware.gnss.V2_1.IGnssCallback.asInterface(hwParcel.readStrongBinder()));
                    hwParcel2.writeStatus(0);
                ...
                case 35:
                    hwParcel.enforceInterface(android.hardware.gnss.V2_1.IGnss.kInterfaceName);
                    android.hardware.gnss.V2_1.IGnssMeasurement extensionGnssMeasurement_2_1 = getExtensionGnssMeasurement_2_1();
                    hwParcel2.writeStatus(0);
                ...
                case 36:
                    hwParcel.enforceInterface(android.hardware.gnss.V2_1.IGnss.kInterfaceName);
                    android.hardware.gnss.V2_1.IGnssConfiguration extensionGnssConfiguration_2_1 = getExtensionGnssConfiguration_2_1();
                    hwParcel2.writeStatus(0);
                ...
                case 37:
                    hwParcel.enforceInterface(android.hardware.gnss.V2_1.IGnss.kInterfaceName);
                    android.hardware.gnss.measurement_corrections.V1_1.IMeasurementCorrections extensionMeasurementCorrections_1_1 = getExtensionMeasurementCorrections_1_1();
                    hwParcel2.writeStatus(0);
                ...
                case 38:
                    hwParcel.enforceInterface(android.hardware.gnss.V2_1.IGnss.kInterfaceName);
                    android.hardware.gnss.V2_1.IGnssAntennaInfo extensionGnssAntennaInfo = getExtensionGnssAntennaInfo();
                    hwParcel2.writeStatus(0);
