...
public interface IGnssConfiguration extends android.hardware.gnss.V1_0.IGnssConfiguration {
    ...
    boolean setBlacklist(java.util.ArrayList<android.hardware.gnss.V1_1.IGnssConfiguration.BlacklistedSource> arrayList) throws android.os.RemoteException;
    ...
    static android.hardware.gnss.V1_1.IGnssConfiguration asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.gnss.V1_1.IGnssConfiguration)) {
            return (android.hardware.gnss.V1_1.IGnssConfiguration) queryLocalInterface;
        }
        android.hardware.gnss.V1_1.IGnssConfiguration.Proxy proxy = new android.hardware.gnss.V1_1.IGnssConfiguration.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.gnss.V1_1.IGnssConfiguration castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.gnss.V1_1.IGnssConfiguration getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.gnss.V1_1.IGnssConfiguration getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.gnss.V1_1.IGnssConfiguration getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.gnss.V1_1.IGnssConfiguration getService() throws android.os.RemoteException {
    ...
    public static final class BlacklistedSource {
        ...
        public final boolean equals(java.lang.Object obj) {
            ...
            if (obj == null || obj.getClass() != android.hardware.gnss.V1_1.IGnssConfiguration.BlacklistedSource.class) {
                return false;
            }
            android.hardware.gnss.V1_1.IGnssConfiguration.BlacklistedSource blacklistedSource = (android.hardware.gnss.V1_1.IGnssConfiguration.BlacklistedSource) obj;
        ...
        public final java.lang.String toString() {
            return "{.constellation = " + android.hardware.gnss.V1_0.GnssConstellationType.toString(this.constellation) + ", .svid = " + ((int) this.svid) + "}";
        }
        ...
        public static final java.util.ArrayList<android.hardware.gnss.V1_1.IGnssConfiguration.BlacklistedSource> readVectorFromParcel(android.os.HwParcel hwParcel) {
            java.util.ArrayList<android.hardware.gnss.V1_1.IGnssConfiguration.BlacklistedSource> arrayList = new java.util.ArrayList<>();
            android.os.HwBlob readBuffer = hwParcel.readBuffer(16L);
            int int32 = readBuffer.getInt32(8L);
            android.os.HwBlob readEmbeddedBuffer = hwParcel.readEmbeddedBuffer(int32 * 4, readBuffer.handle(), 0L, true);
            arrayList.clear();
            for (int i = 0; i < int32; i++) {
                android.hardware.gnss.V1_1.IGnssConfiguration.BlacklistedSource blacklistedSource = new android.hardware.gnss.V1_1.IGnssConfiguration.BlacklistedSource();
        ...
        public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.hardware.gnss.V1_1.IGnssConfiguration.BlacklistedSource> arrayList) {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.gnss.V1_1.IGnssConfiguration {
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.gnss.V1_1.IGnssConfiguration.kInterfaceName, android.hardware.gnss.V1_0.IGnssConfiguration.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.gnss.V1_1.IGnssConfiguration.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
