...
public interface IVibrator extends android.hardware.vibrator.V1_2.IVibrator {
    public static final java.lang.String kInterfaceName = "android.hardware.vibrator@1.3::IVibrator";
    ...
    void perform_1_3(int i, byte b, android.hardware.vibrator.V1_3.IVibrator.perform_1_3Callback perform_1_3callback) throws android.os.RemoteException;

    @Override // android.hardware.vibrator.V1_2.IVibrator, android.hardware.vibrator.V1_1.IVibrator, android.hardware.vibrator.V1_0.IVibrator, android.internal.hidl.base.V1_0.IBase
    void ping() throws android.os.RemoteException;

    int setExternalControl(boolean z) throws android.os.RemoteException;

    @Override // android.hardware.vibrator.V1_2.IVibrator, android.hardware.vibrator.V1_1.IVibrator, android.hardware.vibrator.V1_0.IVibrator, android.internal.hidl.base.V1_0.IBase
    void setHALInstrumentation() throws android.os.RemoteException;

    boolean supportsExternalControl() throws android.os.RemoteException;

    @Override // android.hardware.vibrator.V1_2.IVibrator, android.hardware.vibrator.V1_1.IVibrator, android.hardware.vibrator.V1_0.IVibrator, android.internal.hidl.base.V1_0.IBase
    boolean unlinkToDeath(android.os.IHwBinder.DeathRecipient deathRecipient) throws android.os.RemoteException;

    static android.hardware.vibrator.V1_3.IVibrator asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.vibrator.V1_3.IVibrator)) {
            return (android.hardware.vibrator.V1_3.IVibrator) queryLocalInterface;
        }
        android.hardware.vibrator.V1_3.IVibrator.Proxy proxy = new android.hardware.vibrator.V1_3.IVibrator.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.vibrator.V1_3.IVibrator castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.vibrator.V1_3.IVibrator getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.vibrator.V1_3.IVibrator getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.vibrator.V1_3.IVibrator getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.vibrator.V1_3.IVibrator getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.vibrator.V1_3.IVibrator {
        ...
        public boolean supportsExternalControl() throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.vibrator.V1_3.IVibrator.kInterfaceName);
            android.os.HwParcel hwParcel2 = new android.os.HwParcel();
            try {
        ...
        @Override // android.hardware.vibrator.V1_3.IVibrator
        public int setExternalControl(boolean z) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.vibrator.V1_3.IVibrator.kInterfaceName);
        ...
        @Override // android.hardware.vibrator.V1_3.IVibrator
        public void perform_1_3(int i, byte b, android.hardware.vibrator.V1_3.IVibrator.perform_1_3Callback perform_1_3callback) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.vibrator.V1_3.IVibrator.kInterfaceName);
            hwParcel.writeInt32(i);
            hwParcel.writeInt8(b);
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.vibrator.V1_3.IVibrator {
        @Override // android.hardware.vibrator.V1_3.IVibrator, android.hardware.vibrator.V1_2.IVibrator, android.hardware.vibrator.V1_1.IVibrator, android.hardware.vibrator.V1_0.IVibrator, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.vibrator.V1_3.IVibrator.kInterfaceName, android.hardware.vibrator.V1_2.IVibrator.kInterfaceName, android.hardware.vibrator.V1_1.IVibrator.kInterfaceName, android.hardware.vibrator.V1_0.IVibrator.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.vibrator.V1_3.IVibrator.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, final android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                ...
                case 5:
                    hwParcel.enforceInterface(android.hardware.vibrator.V1_0.IVibrator.kInterfaceName);
                    perform(hwParcel.readInt32(), hwParcel.readInt8(), new android.hardware.vibrator.V1_0.IVibrator.performCallback() { // from class: android.hardware.vibrator.V1_3.IVibrator.Stub.1
                ...
                case 6:
                    ...
                    perform_1_1(hwParcel.readInt32(), hwParcel.readInt8(), new android.hardware.vibrator.V1_1.IVibrator.perform_1_1Callback() { // from class: android.hardware.vibrator.V1_3.IVibrator.Stub.2
                ...
                case 7:
                    ...
                    perform_1_2(hwParcel.readInt32(), hwParcel.readInt8(), new android.hardware.vibrator.V1_2.IVibrator.perform_1_2Callback() { // from class: android.hardware.vibrator.V1_3.IVibrator.Stub.3
                    ...
                    return;
                case 8:
                    hwParcel.enforceInterface(android.hardware.vibrator.V1_3.IVibrator.kInterfaceName);
                ...
                case 10:
                    hwParcel.enforceInterface(android.hardware.vibrator.V1_3.IVibrator.kInterfaceName);
                    perform_1_3(hwParcel.readInt32(), hwParcel.readInt8(), new android.hardware.vibrator.V1_3.IVibrator.perform_1_3Callback() { // from class: android.hardware.vibrator.V1_3.IVibrator.Stub.4
