...
public interface IVibrator extends android.internal.hidl.base.V1_0.IBase {
    public static final java.lang.String kInterfaceName = "android.hardware.vibrator@1.0::IVibrator";
    ...
    int off() throws android.os.RemoteException;

    int on(int i) throws android.os.RemoteException;

    void perform(int i, byte b, android.hardware.vibrator.V1_0.IVibrator.performCallback performcallback) throws android.os.RemoteException;

    @Override // android.internal.hidl.base.V1_0.IBase
    void ping() throws android.os.RemoteException;

    int setAmplitude(byte b) throws android.os.RemoteException;

    @Override // android.internal.hidl.base.V1_0.IBase
    void setHALInstrumentation() throws android.os.RemoteException;

    boolean supportsAmplitudeControl() throws android.os.RemoteException;

    @Override // android.internal.hidl.base.V1_0.IBase
    boolean unlinkToDeath(android.os.IHwBinder.DeathRecipient deathRecipient) throws android.os.RemoteException;

    static android.hardware.vibrator.V1_0.IVibrator asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.vibrator.V1_0.IVibrator)) {
            return (android.hardware.vibrator.V1_0.IVibrator) queryLocalInterface;
        }
        android.hardware.vibrator.V1_0.IVibrator.Proxy proxy = new android.hardware.vibrator.V1_0.IVibrator.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.vibrator.V1_0.IVibrator castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.vibrator.V1_0.IVibrator getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.vibrator.V1_0.IVibrator getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.vibrator.V1_0.IVibrator getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.vibrator.V1_0.IVibrator getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.vibrator.V1_0.IVibrator {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.vibrator.V1_0.IVibrator {
        @Override // android.hardware.vibrator.V1_0.IVibrator, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.vibrator.V1_0.IVibrator.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.vibrator.V1_0.IVibrator.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, final android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                ...
                case 5:
                    hwParcel.enforceInterface(android.hardware.vibrator.V1_0.IVibrator.kInterfaceName);
                    perform(hwParcel.readInt32(), hwParcel.readInt8(), new android.hardware.vibrator.V1_0.IVibrator.performCallback() { // from class: android.hardware.vibrator.V1_0.IVibrator.Stub.1
