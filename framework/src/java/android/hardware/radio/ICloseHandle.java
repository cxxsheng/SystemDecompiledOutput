...
public interface ICloseHandle extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements android.hardware.radio.ICloseHandle {
        ...
        public static android.hardware.radio.ICloseHandle asInterface(android.os.IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            android.os.IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.radio.ICloseHandle)) {
                return (android.hardware.radio.ICloseHandle) queryLocalInterface;
            }
            return new android.hardware.radio.ICloseHandle.Stub.Proxy(iBinder);
        }
        ...
        private static class Proxy implements android.hardware.radio.ICloseHandle {
            ...
            public java.lang.String getInterfaceDescriptor() {
                return android.hardware.radio.ICloseHandle.Stub.DESCRIPTOR;
            }
            ...
            public void close() throws android.os.RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(android.hardware.radio.ICloseHandle.Stub.DESCRIPTOR);
