...
public final class DataRegStateResult {
    ...
    public final boolean equals(java.lang.Object obj) {
        ...
        if (obj == null || obj.getClass() != android.hardware.radio.V1_2.DataRegStateResult.class) {
            return false;
        }
        android.hardware.radio.V1_2.DataRegStateResult dataRegStateResult = (android.hardware.radio.V1_2.DataRegStateResult) obj;
    ...
    public static final java.util.ArrayList<android.hardware.radio.V1_2.DataRegStateResult> readVectorFromParcel(android.os.HwParcel hwParcel) {
        java.util.ArrayList<android.hardware.radio.V1_2.DataRegStateResult> arrayList = new java.util.ArrayList<>();
        android.os.HwBlob readBuffer = hwParcel.readBuffer(16L);
        int int32 = readBuffer.getInt32(8L);
        android.os.HwBlob readEmbeddedBuffer = hwParcel.readEmbeddedBuffer(int32 * 104, readBuffer.handle(), 0L, true);
        arrayList.clear();
        for (int i = 0; i < int32; i++) {
            android.hardware.radio.V1_2.DataRegStateResult dataRegStateResult = new android.hardware.radio.V1_2.DataRegStateResult();
    ...
    public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.hardware.radio.V1_2.DataRegStateResult> arrayList) {
