...
public interface IRadioResponse extends android.hardware.radio.V1_1.IRadioResponse {
    public static final java.lang.String kInterfaceName = "android.hardware.radio@1.2::IRadioResponse";
    ...
    void getCellInfoListResponse_1_2(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo, java.util.ArrayList<android.hardware.radio.V1_2.CellInfo> arrayList) throws android.os.RemoteException;

    void getCurrentCallsResponse_1_2(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo, java.util.ArrayList<android.hardware.radio.V1_2.Call> arrayList) throws android.os.RemoteException;

    void getDataRegistrationStateResponse_1_2(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo, android.hardware.radio.V1_2.DataRegStateResult dataRegStateResult) throws android.os.RemoteException;
    ...
    void getIccCardStatusResponse_1_2(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo, android.hardware.radio.V1_2.CardStatus cardStatus) throws android.os.RemoteException;

    void getSignalStrengthResponse_1_2(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo, android.hardware.radio.V1_2.SignalStrength signalStrength) throws android.os.RemoteException;

    void getVoiceRegistrationStateResponse_1_2(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo, android.hardware.radio.V1_2.VoiceRegStateResult voiceRegStateResult) throws android.os.RemoteException;
    ...
    void setLinkCapacityReportingCriteriaResponse(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo) throws android.os.RemoteException;

    void setSignalStrengthReportingCriteriaResponse(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo) throws android.os.RemoteException;

    @Override // android.hardware.radio.V1_1.IRadioResponse, android.hardware.radio.V1_0.IRadioResponse, android.internal.hidl.base.V1_0.IBase
    boolean unlinkToDeath(android.os.IHwBinder.DeathRecipient deathRecipient) throws android.os.RemoteException;

    static android.hardware.radio.V1_2.IRadioResponse asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.radio.V1_2.IRadioResponse)) {
            return (android.hardware.radio.V1_2.IRadioResponse) queryLocalInterface;
        }
        android.hardware.radio.V1_2.IRadioResponse.Proxy proxy = new android.hardware.radio.V1_2.IRadioResponse.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.radio.V1_2.IRadioResponse castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.radio.V1_2.IRadioResponse getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.radio.V1_2.IRadioResponse getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.radio.V1_2.IRadioResponse getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.radio.V1_2.IRadioResponse getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.radio.V1_2.IRadioResponse {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.radio.V1_2.IRadioResponse {
        @Override // android.hardware.radio.V1_2.IRadioResponse, android.hardware.radio.V1_1.IRadioResponse, android.hardware.radio.V1_0.IRadioResponse, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.radio.V1_2.IRadioResponse.kInterfaceName, android.hardware.radio.V1_1.IRadioResponse.kInterfaceName, android.hardware.radio.V1_0.IRadioResponse.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.radio.V1_2.IRadioResponse.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
