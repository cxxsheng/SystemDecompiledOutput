...
public interface IRadio extends android.hardware.radio.V1_1.IRadio {
    ...
    void deactivateDataCall_1_2(int i, int i2, int i3) throws android.os.RemoteException;
    ...
    void setIndicationFilter_1_2(int i, int i2) throws android.os.RemoteException;

    void setLinkCapacityReportingCriteria(int i, int i2, int i3, int i4, java.util.ArrayList<java.lang.Integer> arrayList, java.util.ArrayList<java.lang.Integer> arrayList2, int i5) throws android.os.RemoteException;

    void setSignalStrengthReportingCriteria(int i, int i2, int i3, java.util.ArrayList<java.lang.Integer> arrayList, int i4) throws android.os.RemoteException;

    void setupDataCall_1_2(int i, int i2, android.hardware.radio.V1_0.DataProfileInfo dataProfileInfo, boolean z, boolean z2, boolean z3, int i3, java.util.ArrayList<java.lang.String> arrayList, java.util.ArrayList<java.lang.String> arrayList2) throws android.os.RemoteException;

    void startNetworkScan_1_2(int i, android.hardware.radio.V1_2.NetworkScanRequest networkScanRequest) throws android.os.RemoteException;

    @Override // android.hardware.radio.V1_1.IRadio, android.hardware.radio.V1_0.IRadio, android.internal.hidl.base.V1_0.IBase
    boolean unlinkToDeath(android.os.IHwBinder.DeathRecipient deathRecipient) throws android.os.RemoteException;

    static android.hardware.radio.V1_2.IRadio asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.radio.V1_2.IRadio)) {
            return (android.hardware.radio.V1_2.IRadio) queryLocalInterface;
        }
        android.hardware.radio.V1_2.IRadio.Proxy proxy = new android.hardware.radio.V1_2.IRadio.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.radio.V1_2.IRadio castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.radio.V1_2.IRadio getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.radio.V1_2.IRadio getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.radio.V1_2.IRadio getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.radio.V1_2.IRadio getService() throws android.os.RemoteException {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.radio.V1_2.IRadio {
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.radio.V1_2.IRadio.kInterfaceName, android.hardware.radio.V1_1.IRadio.kInterfaceName, android.hardware.radio.V1_0.IRadio.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.radio.V1_2.IRadio.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
