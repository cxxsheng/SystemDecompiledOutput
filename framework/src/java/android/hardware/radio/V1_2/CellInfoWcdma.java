...
public final class CellInfoWcdma {
    ...
    public final boolean equals(java.lang.Object obj) {
        ...
        if (obj == null || obj.getClass() != android.hardware.radio.V1_2.CellInfoWcdma.class) {
            return false;
        }
        android.hardware.radio.V1_2.CellInfoWcdma cellInfoWcdma = (android.hardware.radio.V1_2.CellInfoWcdma) obj;
    ...
    public static final java.util.ArrayList<android.hardware.radio.V1_2.CellInfoWcdma> readVectorFromParcel(android.os.HwParcel hwParcel) {
        java.util.ArrayList<android.hardware.radio.V1_2.CellInfoWcdma> arrayList = new java.util.ArrayList<>();
    ...
    public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.hardware.radio.V1_2.CellInfoWcdma> arrayList) {
