...
public final class NetworkScanResult {
    public int status = 0;
    public int error = 0;
    public java.util.ArrayList<android.hardware.radio.V1_0.CellInfo> networkInfos = new java.util.ArrayList<>();

    public final boolean equals(java.lang.Object obj) {
        if (this == obj) {
            return true;
        }
        if (obj == null || obj.getClass() != android.hardware.radio.V1_1.NetworkScanResult.class) {
            return false;
        }
        android.hardware.radio.V1_1.NetworkScanResult networkScanResult = (android.hardware.radio.V1_1.NetworkScanResult) obj;
    ...
    public static final java.util.ArrayList<android.hardware.radio.V1_1.NetworkScanResult> readVectorFromParcel(android.os.HwParcel hwParcel) {
        java.util.ArrayList<android.hardware.radio.V1_1.NetworkScanResult> arrayList = new java.util.ArrayList<>();
    ...
    public final void readEmbeddedFromParcel(android.os.HwParcel hwParcel, android.os.HwBlob hwBlob, long j) {
        ...
        android.os.HwBlob readEmbeddedBuffer = hwParcel.readEmbeddedBuffer(int32 * 104, hwBlob.handle(), j2 + 0, true);
    ...
    public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.hardware.radio.V1_1.NetworkScanResult> arrayList) {
