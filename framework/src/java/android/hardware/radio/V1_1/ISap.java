...
public interface ISap extends android.hardware.radio.V1_0.ISap {
    ...
    static android.hardware.radio.V1_1.ISap asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.radio.V1_1.ISap)) {
            return (android.hardware.radio.V1_1.ISap) queryLocalInterface;
        }
        android.hardware.radio.V1_1.ISap.Proxy proxy = new android.hardware.radio.V1_1.ISap.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.radio.V1_1.ISap castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.radio.V1_1.ISap getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.radio.V1_1.ISap getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.radio.V1_1.ISap getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.radio.V1_1.ISap getService() throws android.os.RemoteException {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.radio.V1_1.ISap {
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.radio.V1_1.ISap.kInterfaceName, android.hardware.radio.V1_0.ISap.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public final java.util.ArrayList<byte[]> getHashChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(new byte[]{-7, 108, -68, 89, -33, -31, 108, -115, 12, 42, 126, 6, -37, 36, -40, 115, -118, 99, 40, -74, -23, 15, 123, -114, android.hardware.biometrics.face.AcquiredInfo.SENSOR_DIRTY, 64, -22, 43, 70, 0, -34, -67}, new byte[]{-34, 58, -71, -9, 59, 16, 115, -51, 103, 123, android.hardware.biometrics.face.AcquiredInfo.DARK_GLASSES_DETECTED, -40, -122, -5, -110, 126, -109, -127, -77, 1, 97, -89, 4, 113, 45, 43, 48, -8, 117, -121, 63, 92}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, com.android.internal.midi.MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, com.android.internal.midi.MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, android.hardware.biometrics.face.AcquiredInfo.ROLL_TOO_EXTREME, -109, 36, -72, 59, android.hardware.biometrics.face.AcquiredInfo.FIRST_FRAME_RECEIVED, -54, 76}));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.radio.V1_1.ISap.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
