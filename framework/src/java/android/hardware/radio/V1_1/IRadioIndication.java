...
public interface IRadioIndication extends android.hardware.radio.V1_0.IRadioIndication {
    public static final java.lang.String kInterfaceName = "android.hardware.radio@1.1::IRadioIndication";
    ...
    void keepaliveStatus(int i, android.hardware.radio.V1_1.KeepaliveStatus keepaliveStatus) throws android.os.RemoteException;

    @Override // android.hardware.radio.V1_0.IRadioIndication, android.internal.hidl.base.V1_0.IBase
    boolean linkToDeath(android.os.IHwBinder.DeathRecipient deathRecipient, long j) throws android.os.RemoteException;

    void networkScanResult(int i, android.hardware.radio.V1_1.NetworkScanResult networkScanResult) throws android.os.RemoteException;
    ...
    static android.hardware.radio.V1_1.IRadioIndication asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.radio.V1_1.IRadioIndication)) {
            return (android.hardware.radio.V1_1.IRadioIndication) queryLocalInterface;
        }
        android.hardware.radio.V1_1.IRadioIndication.Proxy proxy = new android.hardware.radio.V1_1.IRadioIndication.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.radio.V1_1.IRadioIndication castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.radio.V1_1.IRadioIndication getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.radio.V1_1.IRadioIndication getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.radio.V1_1.IRadioIndication getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.radio.V1_1.IRadioIndication getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.radio.V1_1.IRadioIndication {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.radio.V1_1.IRadioIndication {
        @Override // android.hardware.radio.V1_1.IRadioIndication, android.hardware.radio.V1_0.IRadioIndication, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.radio.V1_1.IRadioIndication.kInterfaceName, android.hardware.radio.V1_0.IRadioIndication.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.radio.V1_1.IRadioIndication.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
