...
public interface SuggestedAction$$ {
    static java.lang.String toString(int i) {
        return i == 0 ? android.security.keystore.KeyProperties.DIGEST_NONE : i == 1 ? "TRIGGER_PLMN_BLOCK" : i == 2 ? "TRIGGER_PLMN_BLOCK_WITH_TIMEOUT" : i == 3 ? "TRIGGER_RAT_BLOCK" : i == 4 ? "TRIGGER_CLEAR_RAT_BLOCKS" : java.lang.Integer.toString(i);
    }
