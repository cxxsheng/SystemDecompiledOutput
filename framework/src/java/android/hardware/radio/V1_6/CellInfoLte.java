...
public final class CellInfoLte {
    ...
    public final boolean equals(java.lang.Object obj) {
        ...
        if (obj == null || obj.getClass() != android.hardware.radio.V1_6.CellInfoLte.class) {
            return false;
        }
        android.hardware.radio.V1_6.CellInfoLte cellInfoLte = (android.hardware.radio.V1_6.CellInfoLte) obj;
    ...
    public static final java.util.ArrayList<android.hardware.radio.V1_6.CellInfoLte> readVectorFromParcel(android.os.HwParcel hwParcel) {
        java.util.ArrayList<android.hardware.radio.V1_6.CellInfoLte> arrayList = new java.util.ArrayList<>();
        android.os.HwBlob readBuffer = hwParcel.readBuffer(16L);
        int int32 = readBuffer.getInt32(8L);
        android.os.HwBlob readEmbeddedBuffer = hwParcel.readEmbeddedBuffer(int32 * 192, readBuffer.handle(), 0L, true);
        arrayList.clear();
        for (int i = 0; i < int32; i++) {
            android.hardware.radio.V1_6.CellInfoLte cellInfoLte = new android.hardware.radio.V1_6.CellInfoLte();
    ...
    public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.hardware.radio.V1_6.CellInfoLte> arrayList) {
