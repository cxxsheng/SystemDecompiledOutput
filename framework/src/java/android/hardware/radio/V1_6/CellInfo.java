...
public final class CellInfo {
    ...
    public static final class CellInfoRatSpecificInfo {
        ...
        public void lte(android.hardware.radio.V1_6.CellInfoLte cellInfoLte) {
            this.hidl_d = (byte) 3;
        ...
        public android.hardware.radio.V1_6.CellInfoLte lte() {
            ...
            if (this.hidl_o != null && !android.hardware.radio.V1_6.CellInfoLte.class.isInstance(this.hidl_o)) {
                throw new java.lang.Error("Union is in a corrupted state.");
            }
            return (android.hardware.radio.V1_6.CellInfoLte) this.hidl_o;
        }

        public void nr(android.hardware.radio.V1_6.CellInfoNr cellInfoNr) {
            this.hidl_d = (byte) 4;
        ...
        public android.hardware.radio.V1_6.CellInfoNr nr() {
            ...
            if (this.hidl_o != null && !android.hardware.radio.V1_6.CellInfoNr.class.isInstance(this.hidl_o)) {
                throw new java.lang.Error("Union is in a corrupted state.");
            }
            return (android.hardware.radio.V1_6.CellInfoNr) this.hidl_o;
        }
        ...
        public final boolean equals(java.lang.Object obj) {
            ...
            if (obj == null || obj.getClass() != android.hardware.radio.V1_6.CellInfo.CellInfoRatSpecificInfo.class) {
                return false;
            }
            android.hardware.radio.V1_6.CellInfo.CellInfoRatSpecificInfo cellInfoRatSpecificInfo = (android.hardware.radio.V1_6.CellInfo.CellInfoRatSpecificInfo) obj;
        ...
        public static final java.util.ArrayList<android.hardware.radio.V1_6.CellInfo.CellInfoRatSpecificInfo> readVectorFromParcel(android.os.HwParcel hwParcel) {
            java.util.ArrayList<android.hardware.radio.V1_6.CellInfo.CellInfoRatSpecificInfo> arrayList = new java.util.ArrayList<>();
            android.os.HwBlob readBuffer = hwParcel.readBuffer(16L);
            int int32 = readBuffer.getInt32(8L);
            android.os.HwBlob readEmbeddedBuffer = hwParcel.readEmbeddedBuffer(int32 * 200, readBuffer.handle(), 0L, true);
            arrayList.clear();
            for (int i = 0; i < int32; i++) {
                android.hardware.radio.V1_6.CellInfo.CellInfoRatSpecificInfo cellInfoRatSpecificInfo = new android.hardware.radio.V1_6.CellInfo.CellInfoRatSpecificInfo();
        ...
        public final void readEmbeddedFromParcel(android.os.HwParcel hwParcel, android.os.HwBlob hwBlob, long j) {
            ...
            switch (this.hidl_d) {
                ...
                case 2:
                    ...
                    return;
                case 3:
                    this.hidl_o = new android.hardware.radio.V1_6.CellInfoLte();
                    ((android.hardware.radio.V1_6.CellInfoLte) this.hidl_o).readEmbeddedFromParcel(hwParcel, hwBlob, j + 8);
                    return;
                case 4:
                    this.hidl_o = new android.hardware.radio.V1_6.CellInfoNr();
                    ((android.hardware.radio.V1_6.CellInfoNr) this.hidl_o).readEmbeddedFromParcel(hwParcel, hwBlob, j + 8);
                    return;
                case 5:
        ...
        public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.hardware.radio.V1_6.CellInfo.CellInfoRatSpecificInfo> arrayList) {
    ...
    public final boolean equals(java.lang.Object obj) {
        ...
        if (obj == null || obj.getClass() != android.hardware.radio.V1_6.CellInfo.class) {
            return false;
        }
        android.hardware.radio.V1_6.CellInfo cellInfo = (android.hardware.radio.V1_6.CellInfo) obj;
        if (this.registered == cellInfo.registered && this.connectionStatus == cellInfo.connectionStatus && android.os.HidlSupport.deepEquals(this.ratSpecificInfo, cellInfo.ratSpecificInfo)) {
            return true;
        }
        return false;
    }
    ...
    public final java.lang.String toString() {
        return "{.registered = " + this.registered + ", .connectionStatus = " + android.hardware.radio.V1_2.CellConnectionStatus.toString(this.connectionStatus) + ", .ratSpecificInfo = " + this.ratSpecificInfo + "}";
    }
    ...
    public static final java.util.ArrayList<android.hardware.radio.V1_6.CellInfo> readVectorFromParcel(android.os.HwParcel hwParcel) {
        java.util.ArrayList<android.hardware.radio.V1_6.CellInfo> arrayList = new java.util.ArrayList<>();
        android.os.HwBlob readBuffer = hwParcel.readBuffer(16L);
        int int32 = readBuffer.getInt32(8L);
    ...
    public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.hardware.radio.V1_6.CellInfo> arrayList) {
        android.os.HwBlob hwBlob = new android.os.HwBlob(16);
        int size = arrayList.size();
        hwBlob.putInt32(8L, size);
        hwBlob.putBool(12L, false);
