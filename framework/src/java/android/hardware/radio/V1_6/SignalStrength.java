...
public final class SignalStrength {
    ...
    public final boolean equals(java.lang.Object obj) {
        ...
        if (obj == null || obj.getClass() != android.hardware.radio.V1_6.SignalStrength.class) {
            return false;
        }
        android.hardware.radio.V1_6.SignalStrength signalStrength = (android.hardware.radio.V1_6.SignalStrength) obj;
    ...
    public static final java.util.ArrayList<android.hardware.radio.V1_6.SignalStrength> readVectorFromParcel(android.os.HwParcel hwParcel) {
        java.util.ArrayList<android.hardware.radio.V1_6.SignalStrength> arrayList = new java.util.ArrayList<>();
    ...
    public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.hardware.radio.V1_6.SignalStrength> arrayList) {
