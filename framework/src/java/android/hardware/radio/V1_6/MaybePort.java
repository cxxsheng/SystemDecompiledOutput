...
public final class MaybePort {
    ...
    public void range(android.hardware.radio.V1_6.PortRange portRange) {
        this.hidl_d = (byte) 1;
    ...
    public android.hardware.radio.V1_6.PortRange range() {
        ...
        if (this.hidl_o != null && !android.hardware.radio.V1_6.PortRange.class.isInstance(this.hidl_o)) {
            throw new java.lang.Error("Union is in a corrupted state.");
        }
        return (android.hardware.radio.V1_6.PortRange) this.hidl_o;
    }
    ...
    public final boolean equals(java.lang.Object obj) {
        ...
        if (obj == null || obj.getClass() != android.hardware.radio.V1_6.MaybePort.class) {
            return false;
        }
        android.hardware.radio.V1_6.MaybePort maybePort = (android.hardware.radio.V1_6.MaybePort) obj;
        if (this.hidl_d == maybePort.hidl_d && android.os.HidlSupport.deepEquals(this.hidl_o, maybePort.hidl_o)) {
            return true;
        }
        return false;
    }
    ...
    public static final java.util.ArrayList<android.hardware.radio.V1_6.MaybePort> readVectorFromParcel(android.os.HwParcel hwParcel) {
        java.util.ArrayList<android.hardware.radio.V1_6.MaybePort> arrayList = new java.util.ArrayList<>();
        android.os.HwBlob readBuffer = hwParcel.readBuffer(16L);
        int int32 = readBuffer.getInt32(8L);
        android.os.HwBlob readEmbeddedBuffer = hwParcel.readEmbeddedBuffer(int32 * 12, readBuffer.handle(), 0L, true);
        arrayList.clear();
        for (int i = 0; i < int32; i++) {
            android.hardware.radio.V1_6.MaybePort maybePort = new android.hardware.radio.V1_6.MaybePort();
    ...
    public final void readEmbeddedFromParcel(android.os.HwParcel hwParcel, android.os.HwBlob hwBlob, long j) {
        ...
        switch (this.hidl_d) {
            case 0:
                ...
                return;
            case 1:
                this.hidl_o = new android.hardware.radio.V1_6.PortRange();
                ((android.hardware.radio.V1_6.PortRange) this.hidl_o).readEmbeddedFromParcel(hwParcel, hwBlob, j + 4);
                return;
            default:
    ...
    public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.hardware.radio.V1_6.MaybePort> arrayList) {
