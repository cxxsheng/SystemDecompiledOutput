...
public final class OptionalSliceInfo {
    ...
    public void value(android.hardware.radio.V1_6.SliceInfo sliceInfo) {
        this.hidl_d = (byte) 1;
    ...
    public android.hardware.radio.V1_6.SliceInfo value() {
        ...
        if (this.hidl_o != null && !android.hardware.radio.V1_6.SliceInfo.class.isInstance(this.hidl_o)) {
            throw new java.lang.Error("Union is in a corrupted state.");
        }
        return (android.hardware.radio.V1_6.SliceInfo) this.hidl_o;
    }
    ...
    public final boolean equals(java.lang.Object obj) {
        ...
        if (obj == null || obj.getClass() != android.hardware.radio.V1_6.OptionalSliceInfo.class) {
            return false;
        }
        android.hardware.radio.V1_6.OptionalSliceInfo optionalSliceInfo = (android.hardware.radio.V1_6.OptionalSliceInfo) obj;
        if (this.hidl_d == optionalSliceInfo.hidl_d && android.os.HidlSupport.deepEquals(this.hidl_o, optionalSliceInfo.hidl_o)) {
            return true;
        }
        return false;
    }
    ...
    public static final java.util.ArrayList<android.hardware.radio.V1_6.OptionalSliceInfo> readVectorFromParcel(android.os.HwParcel hwParcel) {
        java.util.ArrayList<android.hardware.radio.V1_6.OptionalSliceInfo> arrayList = new java.util.ArrayList<>();
    ...
    public final void readEmbeddedFromParcel(android.os.HwParcel hwParcel, android.os.HwBlob hwBlob, long j) {
        ...
        switch (this.hidl_d) {
            case 0:
                ...
                return;
            case 1:
                this.hidl_o = new android.hardware.radio.V1_6.SliceInfo();
                ((android.hardware.radio.V1_6.SliceInfo) this.hidl_o).readEmbeddedFromParcel(hwParcel, hwBlob, j + 4);
                return;
            default:
    ...
    public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.hardware.radio.V1_6.OptionalSliceInfo> arrayList) {
