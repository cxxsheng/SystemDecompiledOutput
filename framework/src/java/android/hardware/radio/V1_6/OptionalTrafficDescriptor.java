...
public final class OptionalTrafficDescriptor {
    ...
    public void value(android.hardware.radio.V1_6.TrafficDescriptor trafficDescriptor) {
        this.hidl_d = (byte) 1;
    ...
    public android.hardware.radio.V1_6.TrafficDescriptor value() {
        ...
        if (this.hidl_o != null && !android.hardware.radio.V1_6.TrafficDescriptor.class.isInstance(this.hidl_o)) {
            throw new java.lang.Error("Union is in a corrupted state.");
        }
        return (android.hardware.radio.V1_6.TrafficDescriptor) this.hidl_o;
    }
    ...
    public final boolean equals(java.lang.Object obj) {
        ...
        if (obj == null || obj.getClass() != android.hardware.radio.V1_6.OptionalTrafficDescriptor.class) {
            return false;
        }
        android.hardware.radio.V1_6.OptionalTrafficDescriptor optionalTrafficDescriptor = (android.hardware.radio.V1_6.OptionalTrafficDescriptor) obj;
        if (this.hidl_d == optionalTrafficDescriptor.hidl_d && android.os.HidlSupport.deepEquals(this.hidl_o, optionalTrafficDescriptor.hidl_o)) {
            return true;
        }
        return false;
    }
    ...
    public static final java.util.ArrayList<android.hardware.radio.V1_6.OptionalTrafficDescriptor> readVectorFromParcel(android.os.HwParcel hwParcel) {
        java.util.ArrayList<android.hardware.radio.V1_6.OptionalTrafficDescriptor> arrayList = new java.util.ArrayList<>();
    ...
    public final void readEmbeddedFromParcel(android.os.HwParcel hwParcel, android.os.HwBlob hwBlob, long j) {
        ...
        switch (this.hidl_d) {
            case 0:
                ...
                return;
            case 1:
                this.hidl_o = new android.hardware.radio.V1_6.TrafficDescriptor();
                ((android.hardware.radio.V1_6.TrafficDescriptor) this.hidl_o).readEmbeddedFromParcel(hwParcel, hwBlob, j + 8);
                return;
            default:
    ...
    public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.hardware.radio.V1_6.OptionalTrafficDescriptor> arrayList) {
