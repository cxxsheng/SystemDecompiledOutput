...
public interface EmergencyServiceCategory$$ {
    static java.lang.String toString(int i) {
        return i == 0 ? "UNSPECIFIED" : i == 1 ? "POLICE" : i == 2 ? "AMBULANCE" : i == 4 ? "FIRE_BRIGADE" : i == 8 ? "MARINE_GUARD" : i == 16 ? "MOUNTAIN_RESCUE" : i == 32 ? "MIEC" : i == 64 ? "AIEC" : java.lang.Integer.toString(i);
    }
