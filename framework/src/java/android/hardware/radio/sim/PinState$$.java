...
public interface PinState$$ {
    static java.lang.String toString(int i) {
        return i == 0 ? "UNKNOWN" : i == 1 ? "ENABLED_NOT_VERIFIED" : i == 2 ? "ENABLED_VERIFIED" : i == 3 ? "DISABLED" : i == 4 ? "ENABLED_BLOCKED" : i == 5 ? "ENABLED_PERM_BLOCKED" : java.lang.Integer.toString(i);
    }
