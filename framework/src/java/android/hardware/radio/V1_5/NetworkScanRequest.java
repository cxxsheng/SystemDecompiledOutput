...
public final class NetworkScanRequest {
    ...
    public java.util.ArrayList<android.hardware.radio.V1_5.RadioAccessSpecifier> specifiers = new java.util.ArrayList<>();
    ...
    public final boolean equals(java.lang.Object obj) {
        ...
        if (obj == null || obj.getClass() != android.hardware.radio.V1_5.NetworkScanRequest.class) {
            return false;
        }
        android.hardware.radio.V1_5.NetworkScanRequest networkScanRequest = (android.hardware.radio.V1_5.NetworkScanRequest) obj;
    ...
    public static final java.util.ArrayList<android.hardware.radio.V1_5.NetworkScanRequest> readVectorFromParcel(android.os.HwParcel hwParcel) {
        java.util.ArrayList<android.hardware.radio.V1_5.NetworkScanRequest> arrayList = new java.util.ArrayList<>();
        android.os.HwBlob readBuffer = hwParcel.readBuffer(16L);
        int int32 = readBuffer.getInt32(8L);
        android.os.HwBlob readEmbeddedBuffer = hwParcel.readEmbeddedBuffer(int32 * 56, readBuffer.handle(), 0L, true);
        arrayList.clear();
        for (int i = 0; i < int32; i++) {
            android.hardware.radio.V1_5.NetworkScanRequest networkScanRequest = new android.hardware.radio.V1_5.NetworkScanRequest();
    ...
    public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.hardware.radio.V1_5.NetworkScanRequest> arrayList) {
