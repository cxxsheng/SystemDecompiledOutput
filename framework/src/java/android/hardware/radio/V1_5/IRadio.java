...
public interface IRadio extends android.hardware.radio.V1_4.IRadio {
    public static final java.lang.String kInterfaceName = "android.hardware.radio@1.5::IRadio";
    ...
    void getDataRegistrationState_1_5(int i) throws android.os.RemoteException;
    ...
    void getVoiceRegistrationState_1_5(int i) throws android.os.RemoteException;
    ...
    void sendCdmaSmsExpectMore(int i, android.hardware.radio.V1_0.CdmaSmsMessage cdmaSmsMessage) throws android.os.RemoteException;

    void setDataProfile_1_5(int i, java.util.ArrayList<android.hardware.radio.V1_5.DataProfileInfo> arrayList) throws android.os.RemoteException;

    @Override // android.hardware.radio.V1_4.IRadio, android.hardware.radio.V1_3.IRadio, android.hardware.radio.V1_2.IRadio, android.hardware.radio.V1_1.IRadio, android.hardware.radio.V1_0.IRadio, android.internal.hidl.base.V1_0.IBase
    void setHALInstrumentation() throws android.os.RemoteException;

    void setIndicationFilter_1_5(int i, int i2) throws android.os.RemoteException;

    void setInitialAttachApn_1_5(int i, android.hardware.radio.V1_5.DataProfileInfo dataProfileInfo) throws android.os.RemoteException;

    void setLinkCapacityReportingCriteria_1_5(int i, int i2, int i3, int i4, java.util.ArrayList<java.lang.Integer> arrayList, java.util.ArrayList<java.lang.Integer> arrayList2, int i5) throws android.os.RemoteException;

    void setNetworkSelectionModeManual_1_5(int i, java.lang.String str, int i2) throws android.os.RemoteException;

    void setRadioPower_1_5(int i, boolean z, boolean z2, boolean z3) throws android.os.RemoteException;

    void setSignalStrengthReportingCriteria_1_5(int i, android.hardware.radio.V1_5.SignalThresholdInfo signalThresholdInfo, int i2) throws android.os.RemoteException;

    void setSystemSelectionChannels_1_5(int i, boolean z, java.util.ArrayList<android.hardware.radio.V1_5.RadioAccessSpecifier> arrayList) throws android.os.RemoteException;

    void setupDataCall_1_5(int i, int i2, android.hardware.radio.V1_5.DataProfileInfo dataProfileInfo, boolean z, int i3, java.util.ArrayList<android.hardware.radio.V1_5.LinkAddress> arrayList, java.util.ArrayList<java.lang.String> arrayList2) throws android.os.RemoteException;

    void startNetworkScan_1_5(int i, android.hardware.radio.V1_5.NetworkScanRequest networkScanRequest) throws android.os.RemoteException;
    ...
    static android.hardware.radio.V1_5.IRadio asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.radio.V1_5.IRadio)) {
            return (android.hardware.radio.V1_5.IRadio) queryLocalInterface;
        }
        android.hardware.radio.V1_5.IRadio.Proxy proxy = new android.hardware.radio.V1_5.IRadio.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.radio.V1_5.IRadio castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.radio.V1_5.IRadio getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.radio.V1_5.IRadio getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.radio.V1_5.IRadio getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.radio.V1_5.IRadio getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.radio.V1_5.IRadio {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.radio.V1_5.IRadio {
        @Override // android.hardware.radio.V1_5.IRadio, android.hardware.radio.V1_4.IRadio, android.hardware.radio.V1_3.IRadio, android.hardware.radio.V1_2.IRadio, android.hardware.radio.V1_1.IRadio, android.hardware.radio.V1_0.IRadio, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.radio.V1_5.IRadio.kInterfaceName, android.hardware.radio.V1_4.IRadio.kInterfaceName, android.hardware.radio.V1_3.IRadio.kInterfaceName, android.hardware.radio.V1_2.IRadio.kInterfaceName, android.hardware.radio.V1_1.IRadio.kInterfaceName, android.hardware.radio.V1_0.IRadio.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.radio.V1_5.IRadio.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
