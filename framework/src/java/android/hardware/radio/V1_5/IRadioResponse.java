...
public interface IRadioResponse extends android.hardware.radio.V1_4.IRadioResponse {
    public static final java.lang.String kInterfaceName = "android.hardware.radio@1.5::IRadioResponse";

    void areUiccApplicationsEnabledResponse(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo, boolean z) throws android.os.RemoteException;
    ...
    void enableUiccApplicationsResponse(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo) throws android.os.RemoteException;

    void getBarringInfoResponse(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo, android.hardware.radio.V1_5.CellIdentity cellIdentity, java.util.ArrayList<android.hardware.radio.V1_5.BarringInfo> arrayList) throws android.os.RemoteException;

    void getCellInfoListResponse_1_5(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo, java.util.ArrayList<android.hardware.radio.V1_5.CellInfo> arrayList) throws android.os.RemoteException;

    void getDataCallListResponse_1_5(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo, java.util.ArrayList<android.hardware.radio.V1_5.SetupDataCallResult> arrayList) throws android.os.RemoteException;

    void getDataRegistrationStateResponse_1_5(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo, android.hardware.radio.V1_5.RegStateResult regStateResult) throws android.os.RemoteException;
    ...
    void getIccCardStatusResponse_1_5(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo, android.hardware.radio.V1_5.CardStatus cardStatus) throws android.os.RemoteException;

    void getVoiceRegistrationStateResponse_1_5(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo, android.hardware.radio.V1_5.RegStateResult regStateResult) throws android.os.RemoteException;
    ...
    void sendCdmaSmsExpectMoreResponse(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo, android.hardware.radio.V1_0.SendSmsResult sendSmsResult) throws android.os.RemoteException;

    void setDataProfileResponse_1_5(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo) throws android.os.RemoteException;

    @Override // android.hardware.radio.V1_4.IRadioResponse, android.hardware.radio.V1_3.IRadioResponse, android.hardware.radio.V1_2.IRadioResponse, android.hardware.radio.V1_1.IRadioResponse, android.hardware.radio.V1_0.IRadioResponse, android.internal.hidl.base.V1_0.IBase
    void setHALInstrumentation() throws android.os.RemoteException;

    void setIndicationFilterResponse_1_5(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo) throws android.os.RemoteException;

    void setInitialAttachApnResponse_1_5(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo) throws android.os.RemoteException;

    void setLinkCapacityReportingCriteriaResponse_1_5(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo) throws android.os.RemoteException;

    void setNetworkSelectionModeManualResponse_1_5(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo) throws android.os.RemoteException;

    void setRadioPowerResponse_1_5(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo) throws android.os.RemoteException;

    void setSignalStrengthReportingCriteriaResponse_1_5(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo) throws android.os.RemoteException;

    void setSystemSelectionChannelsResponse_1_5(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo) throws android.os.RemoteException;

    void setupDataCallResponse_1_5(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo, android.hardware.radio.V1_5.SetupDataCallResult setupDataCallResult) throws android.os.RemoteException;

    void startNetworkScanResponse_1_5(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo) throws android.os.RemoteException;

    void supplySimDepersonalizationResponse(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo, int i, int i2) throws android.os.RemoteException;

    @Override // android.hardware.radio.V1_4.IRadioResponse, android.hardware.radio.V1_3.IRadioResponse, android.hardware.radio.V1_2.IRadioResponse, android.hardware.radio.V1_1.IRadioResponse, android.hardware.radio.V1_0.IRadioResponse, android.internal.hidl.base.V1_0.IBase
    boolean unlinkToDeath(android.os.IHwBinder.DeathRecipient deathRecipient) throws android.os.RemoteException;

    static android.hardware.radio.V1_5.IRadioResponse asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.radio.V1_5.IRadioResponse)) {
            return (android.hardware.radio.V1_5.IRadioResponse) queryLocalInterface;
        }
        android.hardware.radio.V1_5.IRadioResponse.Proxy proxy = new android.hardware.radio.V1_5.IRadioResponse.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.radio.V1_5.IRadioResponse castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.radio.V1_5.IRadioResponse getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.radio.V1_5.IRadioResponse getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.radio.V1_5.IRadioResponse getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.radio.V1_5.IRadioResponse getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.radio.V1_5.IRadioResponse {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.radio.V1_5.IRadioResponse {
        @Override // android.hardware.radio.V1_5.IRadioResponse, android.hardware.radio.V1_4.IRadioResponse, android.hardware.radio.V1_3.IRadioResponse, android.hardware.radio.V1_2.IRadioResponse, android.hardware.radio.V1_1.IRadioResponse, android.hardware.radio.V1_0.IRadioResponse, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.radio.V1_5.IRadioResponse.kInterfaceName, android.hardware.radio.V1_4.IRadioResponse.kInterfaceName, android.hardware.radio.V1_3.IRadioResponse.kInterfaceName, android.hardware.radio.V1_2.IRadioResponse.kInterfaceName, android.hardware.radio.V1_1.IRadioResponse.kInterfaceName, android.hardware.radio.V1_0.IRadioResponse.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.radio.V1_5.IRadioResponse.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
