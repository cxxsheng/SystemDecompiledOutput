...
public interface IRadioIndication extends android.hardware.radio.V1_4.IRadioIndication {
    public static final java.lang.String kInterfaceName = "android.hardware.radio@1.5::IRadioIndication";
    ...
    void barringInfoChanged(int i, android.hardware.radio.V1_5.CellIdentity cellIdentity, java.util.ArrayList<android.hardware.radio.V1_5.BarringInfo> arrayList) throws android.os.RemoteException;

    void cellInfoList_1_5(int i, java.util.ArrayList<android.hardware.radio.V1_5.CellInfo> arrayList) throws android.os.RemoteException;

    void dataCallListChanged_1_5(int i, java.util.ArrayList<android.hardware.radio.V1_5.SetupDataCallResult> arrayList) throws android.os.RemoteException;
    ...
    void networkScanResult_1_5(int i, android.hardware.radio.V1_5.NetworkScanResult networkScanResult) throws android.os.RemoteException;
    ...
    void registrationFailed(int i, android.hardware.radio.V1_5.CellIdentity cellIdentity, java.lang.String str, int i2, int i3, int i4) throws android.os.RemoteException;
    ...
    static android.hardware.radio.V1_5.IRadioIndication asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.radio.V1_5.IRadioIndication)) {
            return (android.hardware.radio.V1_5.IRadioIndication) queryLocalInterface;
        }
        android.hardware.radio.V1_5.IRadioIndication.Proxy proxy = new android.hardware.radio.V1_5.IRadioIndication.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.radio.V1_5.IRadioIndication castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.radio.V1_5.IRadioIndication getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.radio.V1_5.IRadioIndication getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.radio.V1_5.IRadioIndication getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.radio.V1_5.IRadioIndication getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.radio.V1_5.IRadioIndication {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.radio.V1_5.IRadioIndication {
        @Override // android.hardware.radio.V1_5.IRadioIndication, android.hardware.radio.V1_4.IRadioIndication, android.hardware.radio.V1_3.IRadioIndication, android.hardware.radio.V1_2.IRadioIndication, android.hardware.radio.V1_1.IRadioIndication, android.hardware.radio.V1_0.IRadioIndication, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.radio.V1_5.IRadioIndication.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
