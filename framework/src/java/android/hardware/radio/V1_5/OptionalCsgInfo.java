...
public final class OptionalCsgInfo {
    ...
    public android.internal.hidl.safe_union.V1_0.Monostate noinit() {
        if (this.hidl_d != 0) {
            throw new java.lang.IllegalStateException("Read access to inactive union components is disallowed. Discriminator value is " + ((int) this.hidl_d) + " (corresponding to " + android.hardware.radio.V1_5.OptionalCsgInfo.hidl_discriminator.getName(this.hidl_d) + "), and hidl_o is of type " + (this.hidl_o != null ? this.hidl_o.getClass().getName() : "null") + android.media.MediaMetrics.SEPARATOR);
        }
    ...
    public void csgInfo(android.hardware.radio.V1_5.ClosedSubscriberGroupInfo closedSubscriberGroupInfo) {
        this.hidl_d = (byte) 1;
    ...
    public android.hardware.radio.V1_5.ClosedSubscriberGroupInfo csgInfo() {
        ...
        if (this.hidl_o != null && !android.hardware.radio.V1_5.ClosedSubscriberGroupInfo.class.isInstance(this.hidl_o)) {
            throw new java.lang.Error("Union is in a corrupted state.");
        }
        return (android.hardware.radio.V1_5.ClosedSubscriberGroupInfo) this.hidl_o;
    }
    ...
    public final boolean equals(java.lang.Object obj) {
        ...
        if (obj == null || obj.getClass() != android.hardware.radio.V1_5.OptionalCsgInfo.class) {
            return false;
        }
        android.hardware.radio.V1_5.OptionalCsgInfo optionalCsgInfo = (android.hardware.radio.V1_5.OptionalCsgInfo) obj;
        if (this.hidl_d == optionalCsgInfo.hidl_d && android.os.HidlSupport.deepEquals(this.hidl_o, optionalCsgInfo.hidl_o)) {
            return true;
        }
        return false;
    }
    ...
    public static final java.util.ArrayList<android.hardware.radio.V1_5.OptionalCsgInfo> readVectorFromParcel(android.os.HwParcel hwParcel) {
        java.util.ArrayList<android.hardware.radio.V1_5.OptionalCsgInfo> arrayList = new java.util.ArrayList<>();
        android.os.HwBlob readBuffer = hwParcel.readBuffer(16L);
        int int32 = readBuffer.getInt32(8L);
        android.os.HwBlob readEmbeddedBuffer = hwParcel.readEmbeddedBuffer(int32 * 40, readBuffer.handle(), 0L, true);
        arrayList.clear();
        for (int i = 0; i < int32; i++) {
            android.hardware.radio.V1_5.OptionalCsgInfo optionalCsgInfo = new android.hardware.radio.V1_5.OptionalCsgInfo();
    ...
    public final void readEmbeddedFromParcel(android.os.HwParcel hwParcel, android.os.HwBlob hwBlob, long j) {
        ...
        switch (this.hidl_d) {
            case 0:
                ...
                return;
            case 1:
                this.hidl_o = new android.hardware.radio.V1_5.ClosedSubscriberGroupInfo();
                ((android.hardware.radio.V1_5.ClosedSubscriberGroupInfo) this.hidl_o).readEmbeddedFromParcel(hwParcel, hwBlob, j + 8);
                return;
            default:
    ...
    public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.hardware.radio.V1_5.OptionalCsgInfo> arrayList) {
