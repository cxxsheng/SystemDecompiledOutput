...
public final class SetupDataCallResult {
    ...
    public java.util.ArrayList<java.lang.String> addresses = new java.util.ArrayList<>();
    ...
    public final boolean equals(java.lang.Object obj) {
        ...
        if (obj == null || obj.getClass() != android.hardware.radio.V1_4.SetupDataCallResult.class) {
            return false;
        }
        android.hardware.radio.V1_4.SetupDataCallResult setupDataCallResult = (android.hardware.radio.V1_4.SetupDataCallResult) obj;
    ...
    public static final java.util.ArrayList<android.hardware.radio.V1_4.SetupDataCallResult> readVectorFromParcel(android.os.HwParcel hwParcel) {
        java.util.ArrayList<android.hardware.radio.V1_4.SetupDataCallResult> arrayList = new java.util.ArrayList<>();
        android.os.HwBlob readBuffer = hwParcel.readBuffer(16L);
        int int32 = readBuffer.getInt32(8L);
        android.os.HwBlob readEmbeddedBuffer = hwParcel.readEmbeddedBuffer(int32 * 112, readBuffer.handle(), 0L, true);
        arrayList.clear();
        for (int i = 0; i < int32; i++) {
            android.hardware.radio.V1_4.SetupDataCallResult setupDataCallResult = new android.hardware.radio.V1_4.SetupDataCallResult();
    ...
    public final void readEmbeddedFromParcel(android.os.HwParcel hwParcel, android.os.HwBlob hwBlob, long j) {
        ...
        android.os.HwBlob readEmbeddedBuffer = hwParcel.readEmbeddedBuffer(int32 * 16, hwBlob.handle(), j3 + 0, true);
        ...
        for (int i2 = 0; i2 < int322; i2++) {
            ...
            hwParcel.readEmbeddedBuffer(string2.getBytes().length + 1, readEmbeddedBuffer2.handle(), r10 + 0, false);
        ...
        for (int i3 = 0; i3 < int323; i3++) {
            new java.lang.String();
            java.lang.String string3 = readEmbeddedBuffer3.getString(i3 * 16);
            hwParcel.readEmbeddedBuffer(string3.getBytes().length + 1, readEmbeddedBuffer3.handle(), r10 + 0, false);
        ...
        for (int i4 = 0; i4 < int324; i4++) {
            new java.lang.String();
            java.lang.String string4 = readEmbeddedBuffer4.getString(i4 * 16);
            hwParcel.readEmbeddedBuffer(string4.getBytes().length + 1, readEmbeddedBuffer4.handle(), r5 + 0, false);
    ...
    public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.hardware.radio.V1_4.SetupDataCallResult> arrayList) {
