...
public final class DataProfileInfo {
    ...
    public final java.lang.String toString() {
        return "{.profileId = " + android.hardware.radio.V1_0.DataProfileId.toString(this.profileId) + ", .apn = " + this.apn + ", .protocol = " + android.hardware.radio.V1_4.PdpProtocolType.toString(this.protocol) + ", .roamingProtocol = " + android.hardware.radio.V1_4.PdpProtocolType.toString(this.roamingProtocol) + ", .authType = " + android.hardware.radio.V1_0.ApnAuthType.toString(this.authType) + ", .user = " + this.user + ", .password = " + this.password + ", .type = " + android.hardware.radio.V1_0.DataProfileInfoType.toString(this.type) + ", .maxConnsTime = " + this.maxConnsTime + ", .maxConns = " + this.maxConns + ", .waitTime = " + this.waitTime + ", .enabled = " + this.enabled + ", .supportedApnTypesBitmap = " + android.hardware.radio.V1_4.ApnTypes.dumpBitfield(this.supportedApnTypesBitmap) + ", .bearerBitmap = " + android.hardware.radio.V1_4.RadioAccessFamily.dumpBitfield(this.bearerBitmap) + ", .mtu = " + this.mtu + ", .preferred = " + this.preferred + ", .persistent = " + this.persistent + "}";
    }
    ...
    public static final java.util.ArrayList<android.hardware.radio.V1_4.DataProfileInfo> readVectorFromParcel(android.os.HwParcel hwParcel) {
        java.util.ArrayList<android.hardware.radio.V1_4.DataProfileInfo> arrayList = new java.util.ArrayList<>();
    ...
    public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.hardware.radio.V1_4.DataProfileInfo> arrayList) {
