...
public interface IRadioIndication extends android.hardware.radio.V1_3.IRadioIndication {
    ...
    void cellInfoList_1_4(int i, java.util.ArrayList<android.hardware.radio.V1_4.CellInfo> arrayList) throws android.os.RemoteException;

    void currentEmergencyNumberList(int i, java.util.ArrayList<android.hardware.radio.V1_4.EmergencyNumber> arrayList) throws android.os.RemoteException;

    void currentPhysicalChannelConfigs_1_4(int i, java.util.ArrayList<android.hardware.radio.V1_4.PhysicalChannelConfig> arrayList) throws android.os.RemoteException;

    void currentSignalStrength_1_4(int i, android.hardware.radio.V1_4.SignalStrength signalStrength) throws android.os.RemoteException;

    void dataCallListChanged_1_4(int i, java.util.ArrayList<android.hardware.radio.V1_4.SetupDataCallResult> arrayList) throws android.os.RemoteException;
    ...
    void networkScanResult_1_4(int i, android.hardware.radio.V1_4.NetworkScanResult networkScanResult) throws android.os.RemoteException;
    ...
    static android.hardware.radio.V1_4.IRadioIndication asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.radio.V1_4.IRadioIndication)) {
            return (android.hardware.radio.V1_4.IRadioIndication) queryLocalInterface;
        }
        android.hardware.radio.V1_4.IRadioIndication.Proxy proxy = new android.hardware.radio.V1_4.IRadioIndication.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.radio.V1_4.IRadioIndication castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.radio.V1_4.IRadioIndication getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.radio.V1_4.IRadioIndication getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.radio.V1_4.IRadioIndication getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.radio.V1_4.IRadioIndication getService() throws android.os.RemoteException {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.radio.V1_4.IRadioIndication {
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.radio.V1_4.IRadioIndication.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
