...
public interface IRadioResponse extends android.hardware.radio.V1_3.IRadioResponse {
    ...
    void emergencyDialResponse(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo) throws android.os.RemoteException;

    void getAllowedCarriersResponse_1_4(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo, android.hardware.radio.V1_4.CarrierRestrictionsWithPriority carrierRestrictionsWithPriority, int i) throws android.os.RemoteException;

    void getCellInfoListResponse_1_4(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo, java.util.ArrayList<android.hardware.radio.V1_4.CellInfo> arrayList) throws android.os.RemoteException;

    void getDataCallListResponse_1_4(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo, java.util.ArrayList<android.hardware.radio.V1_4.SetupDataCallResult> arrayList) throws android.os.RemoteException;

    void getDataRegistrationStateResponse_1_4(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo, android.hardware.radio.V1_4.DataRegStateResult dataRegStateResult) throws android.os.RemoteException;
    ...
    void getIccCardStatusResponse_1_4(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo, android.hardware.radio.V1_4.CardStatus cardStatus) throws android.os.RemoteException;

    void getPreferredNetworkTypeBitmapResponse(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo, int i) throws android.os.RemoteException;

    void getSignalStrengthResponse_1_4(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo, android.hardware.radio.V1_4.SignalStrength signalStrength) throws android.os.RemoteException;
    ...
    void setAllowedCarriersResponse_1_4(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo) throws android.os.RemoteException;

    @Override // android.hardware.radio.V1_3.IRadioResponse, android.hardware.radio.V1_2.IRadioResponse, android.hardware.radio.V1_1.IRadioResponse, android.hardware.radio.V1_0.IRadioResponse, android.internal.hidl.base.V1_0.IBase
    void setHALInstrumentation() throws android.os.RemoteException;

    void setPreferredNetworkTypeBitmapResponse(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo) throws android.os.RemoteException;

    void setupDataCallResponse_1_4(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo, android.hardware.radio.V1_4.SetupDataCallResult setupDataCallResult) throws android.os.RemoteException;

    void startNetworkScanResponse_1_4(android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo) throws android.os.RemoteException;

    @Override // android.hardware.radio.V1_3.IRadioResponse, android.hardware.radio.V1_2.IRadioResponse, android.hardware.radio.V1_1.IRadioResponse, android.hardware.radio.V1_0.IRadioResponse, android.internal.hidl.base.V1_0.IBase
    boolean unlinkToDeath(android.os.IHwBinder.DeathRecipient deathRecipient) throws android.os.RemoteException;

    static android.hardware.radio.V1_4.IRadioResponse asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.radio.V1_4.IRadioResponse)) {
            return (android.hardware.radio.V1_4.IRadioResponse) queryLocalInterface;
        }
        android.hardware.radio.V1_4.IRadioResponse.Proxy proxy = new android.hardware.radio.V1_4.IRadioResponse.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.radio.V1_4.IRadioResponse castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.radio.V1_4.IRadioResponse getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.radio.V1_4.IRadioResponse getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.radio.V1_4.IRadioResponse getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.radio.V1_4.IRadioResponse getService() throws android.os.RemoteException {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.radio.V1_4.IRadioResponse {
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.radio.V1_4.IRadioResponse.kInterfaceName, android.hardware.radio.V1_3.IRadioResponse.kInterfaceName, android.hardware.radio.V1_2.IRadioResponse.kInterfaceName, android.hardware.radio.V1_1.IRadioResponse.kInterfaceName, android.hardware.radio.V1_0.IRadioResponse.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.radio.V1_4.IRadioResponse.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
