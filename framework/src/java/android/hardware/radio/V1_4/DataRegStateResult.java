...
public final class DataRegStateResult {
    ...
    public static final class VopsInfo {
        ...
        public android.internal.hidl.safe_union.V1_0.Monostate noinit() {
            if (this.hidl_d != 0) {
                throw new java.lang.IllegalStateException("Read access to inactive union components is disallowed. Discriminator value is " + ((int) this.hidl_d) + " (corresponding to " + android.hardware.radio.V1_4.DataRegStateResult.VopsInfo.hidl_discriminator.getName(this.hidl_d) + "), and hidl_o is of type " + (this.hidl_o != null ? this.hidl_o.getClass().getName() : "null") + android.media.MediaMetrics.SEPARATOR);
            }
        ...
        public android.hardware.radio.V1_4.LteVopsInfo lteVopsInfo() {
            ...
            if (this.hidl_o != null && !android.hardware.radio.V1_4.LteVopsInfo.class.isInstance(this.hidl_o)) {
                throw new java.lang.Error("Union is in a corrupted state.");
            }
            return (android.hardware.radio.V1_4.LteVopsInfo) this.hidl_o;
        }
        ...
        public final boolean equals(java.lang.Object obj) {
            ...
            if (obj == null || obj.getClass() != android.hardware.radio.V1_4.DataRegStateResult.VopsInfo.class) {
                return false;
            }
            android.hardware.radio.V1_4.DataRegStateResult.VopsInfo vopsInfo = (android.hardware.radio.V1_4.DataRegStateResult.VopsInfo) obj;
            if (this.hidl_d == vopsInfo.hidl_d && android.os.HidlSupport.deepEquals(this.hidl_o, vopsInfo.hidl_o)) {
                return true;
            }
            return false;
        }
        ...
        public static final java.util.ArrayList<android.hardware.radio.V1_4.DataRegStateResult.VopsInfo> readVectorFromParcel(android.os.HwParcel hwParcel) {
            java.util.ArrayList<android.hardware.radio.V1_4.DataRegStateResult.VopsInfo> arrayList = new java.util.ArrayList<>();
            android.os.HwBlob readBuffer = hwParcel.readBuffer(16L);
            int int32 = readBuffer.getInt32(8L);
            android.os.HwBlob readEmbeddedBuffer = hwParcel.readEmbeddedBuffer(int32 * 3, readBuffer.handle(), 0L, true);
            arrayList.clear();
            for (int i = 0; i < int32; i++) {
                android.hardware.radio.V1_4.DataRegStateResult.VopsInfo vopsInfo = new android.hardware.radio.V1_4.DataRegStateResult.VopsInfo();
        ...
        public final void readEmbeddedFromParcel(android.os.HwParcel hwParcel, android.os.HwBlob hwBlob, long j) {
            ...
            switch (this.hidl_d) {
                case 0:
                    ...
                    return;
                case 1:
                    this.hidl_o = new android.hardware.radio.V1_4.LteVopsInfo();
                    ((android.hardware.radio.V1_4.LteVopsInfo) this.hidl_o).readEmbeddedFromParcel(hwParcel, hwBlob, j + 1);
                    return;
                default:
        ...
        public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.hardware.radio.V1_4.DataRegStateResult.VopsInfo> arrayList) {
    ...
    public final boolean equals(java.lang.Object obj) {
        ...
        if (obj == null || obj.getClass() != android.hardware.radio.V1_4.DataRegStateResult.class) {
            return false;
        }
        android.hardware.radio.V1_4.DataRegStateResult dataRegStateResult = (android.hardware.radio.V1_4.DataRegStateResult) obj;
        if (android.os.HidlSupport.deepEquals(this.base, dataRegStateResult.base) && android.os.HidlSupport.deepEquals(this.vopsInfo, dataRegStateResult.vopsInfo) && android.os.HidlSupport.deepEquals(this.nrIndicators, dataRegStateResult.nrIndicators)) {
            return true;
        }
        return false;
    }
    ...
    public final int hashCode() {
        return java.util.Objects.hash(java.lang.Integer.valueOf(android.os.HidlSupport.deepHashCode(this.base)), java.lang.Integer.valueOf(android.os.HidlSupport.deepHashCode(this.vopsInfo)), java.lang.Integer.valueOf(android.os.HidlSupport.deepHashCode(this.nrIndicators)));
    }
    ...
    public static final java.util.ArrayList<android.hardware.radio.V1_4.DataRegStateResult> readVectorFromParcel(android.os.HwParcel hwParcel) {
        java.util.ArrayList<android.hardware.radio.V1_4.DataRegStateResult> arrayList = new java.util.ArrayList<>();
        android.os.HwBlob readBuffer = hwParcel.readBuffer(16L);
        int int32 = readBuffer.getInt32(8L);
        android.os.HwBlob readEmbeddedBuffer = hwParcel.readEmbeddedBuffer(int32 * 112, readBuffer.handle(), 0L, true);
        arrayList.clear();
        for (int i = 0; i < int32; i++) {
            android.hardware.radio.V1_4.DataRegStateResult dataRegStateResult = new android.hardware.radio.V1_4.DataRegStateResult();
    ...
    public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.hardware.radio.V1_4.DataRegStateResult> arrayList) {
        android.os.HwBlob hwBlob = new android.os.HwBlob(16);
        int size = arrayList.size();
        hwBlob.putInt32(8L, size);
        hwBlob.putBool(12L, false);
