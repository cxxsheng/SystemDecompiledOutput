...
public class NetworkScanRequest implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.hardware.radio.network.NetworkScanRequest> CREATOR = new android.os.Parcelable.Creator<android.hardware.radio.network.NetworkScanRequest>() { // from class: android.hardware.radio.network.NetworkScanRequest.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.hardware.radio.network.NetworkScanRequest createFromParcel(android.os.Parcel parcel) {
            android.hardware.radio.network.NetworkScanRequest networkScanRequest = new android.hardware.radio.network.NetworkScanRequest();
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.hardware.radio.network.NetworkScanRequest[] newArray(int i) {
            return new android.hardware.radio.network.NetworkScanRequest[i];
        }
    };
    ...
    public final void readFromParcel(android.os.Parcel parcel) {
        ...
        try {
            ...
            this.specifiers = (android.hardware.radio.network.RadioAccessSpecifier[]) parcel.createTypedArray(android.hardware.radio.network.RadioAccessSpecifier.CREATOR);
            if (parcel.dataPosition() - dataPosition >= readInt) {
                if (dataPosition > Integer.MAX_VALUE - readInt) {
                    throw new android.os.BadParcelableException("Overflow in the size of parcelable");
                }
    ...
    public java.lang.String toString() {
        ...
        stringJoiner.add("specifiers: " + java.util.Arrays.toString(this.specifiers));
        ...
        stringJoiner.add("mccMncs: " + java.util.Arrays.toString(this.mccMncs));
        return "NetworkScanRequest" + stringJoiner.toString();
    }

    @Override // android.os.Parcelable
    public int describeContents() {
        return describeContents(this.specifiers) | 0;
    }
