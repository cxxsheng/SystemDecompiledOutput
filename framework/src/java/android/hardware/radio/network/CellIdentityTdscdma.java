...
public class CellIdentityTdscdma implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.hardware.radio.network.CellIdentityTdscdma> CREATOR = new android.os.Parcelable.Creator<android.hardware.radio.network.CellIdentityTdscdma>() { // from class: android.hardware.radio.network.CellIdentityTdscdma.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.hardware.radio.network.CellIdentityTdscdma createFromParcel(android.os.Parcel parcel) {
            android.hardware.radio.network.CellIdentityTdscdma cellIdentityTdscdma = new android.hardware.radio.network.CellIdentityTdscdma();
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.hardware.radio.network.CellIdentityTdscdma[] newArray(int i) {
            return new android.hardware.radio.network.CellIdentityTdscdma[i];
        }
    };
