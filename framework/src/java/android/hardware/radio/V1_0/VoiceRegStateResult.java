...
public final class VoiceRegStateResult {
    ...
    public final boolean equals(java.lang.Object obj) {
        ...
        if (obj == null || obj.getClass() != android.hardware.radio.V1_0.VoiceRegStateResult.class) {
            return false;
        }
        android.hardware.radio.V1_0.VoiceRegStateResult voiceRegStateResult = (android.hardware.radio.V1_0.VoiceRegStateResult) obj;
    ...
    public static final java.util.ArrayList<android.hardware.radio.V1_0.VoiceRegStateResult> readVectorFromParcel(android.os.HwParcel hwParcel) {
        java.util.ArrayList<android.hardware.radio.V1_0.VoiceRegStateResult> arrayList = new java.util.ArrayList<>();
    ...
    public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.hardware.radio.V1_0.VoiceRegStateResult> arrayList) {
