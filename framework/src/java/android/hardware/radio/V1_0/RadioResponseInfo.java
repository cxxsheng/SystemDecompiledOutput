...
public final class RadioResponseInfo {
    ...
    public final boolean equals(java.lang.Object obj) {
        ...
        if (obj == null || obj.getClass() != android.hardware.radio.V1_0.RadioResponseInfo.class) {
            return false;
        }
        android.hardware.radio.V1_0.RadioResponseInfo radioResponseInfo = (android.hardware.radio.V1_0.RadioResponseInfo) obj;
    ...
    public final java.lang.String toString() {
        return "{.type = " + android.hardware.radio.V1_0.RadioResponseType.toString(this.type) + ", .serial = " + this.serial + ", .error = " + android.hardware.radio.V1_0.RadioError.toString(this.error) + "}";
    }
    ...
    public static final java.util.ArrayList<android.hardware.radio.V1_0.RadioResponseInfo> readVectorFromParcel(android.os.HwParcel hwParcel) {
        java.util.ArrayList<android.hardware.radio.V1_0.RadioResponseInfo> arrayList = new java.util.ArrayList<>();
    ...
    public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.hardware.radio.V1_0.RadioResponseInfo> arrayList) {
