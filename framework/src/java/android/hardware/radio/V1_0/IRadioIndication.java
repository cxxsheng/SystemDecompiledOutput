...
public interface IRadioIndication extends android.internal.hidl.base.V1_0.IBase {
    public static final java.lang.String kInterfaceName = "android.hardware.radio@1.0::IRadioIndication";

    @Override // android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
    android.os.IHwBinder asBinder();

    void callRing(int i, boolean z, android.hardware.radio.V1_0.CdmaSignalInfoRecord cdmaSignalInfoRecord) throws android.os.RemoteException;

    void callStateChanged(int i) throws android.os.RemoteException;

    void cdmaCallWaiting(int i, android.hardware.radio.V1_0.CdmaCallWaiting cdmaCallWaiting) throws android.os.RemoteException;

    void cdmaInfoRec(int i, android.hardware.radio.V1_0.CdmaInformationRecords cdmaInformationRecords) throws android.os.RemoteException;

    void cdmaNewSms(int i, android.hardware.radio.V1_0.CdmaSmsMessage cdmaSmsMessage) throws android.os.RemoteException;
    ...
    void cellInfoList(int i, java.util.ArrayList<android.hardware.radio.V1_0.CellInfo> arrayList) throws android.os.RemoteException;

    void currentSignalStrength(int i, android.hardware.radio.V1_0.SignalStrength signalStrength) throws android.os.RemoteException;

    void dataCallListChanged(int i, java.util.ArrayList<android.hardware.radio.V1_0.SetupDataCallResult> arrayList) throws android.os.RemoteException;
    ...
    void hardwareConfigChanged(int i, java.util.ArrayList<android.hardware.radio.V1_0.HardwareConfig> arrayList) throws android.os.RemoteException;
    ...
    void lceData(int i, android.hardware.radio.V1_0.LceDataInfo lceDataInfo) throws android.os.RemoteException;
    ...
    void newBroadcastSms(int i, java.util.ArrayList<java.lang.Byte> arrayList) throws android.os.RemoteException;

    void newSms(int i, java.util.ArrayList<java.lang.Byte> arrayList) throws android.os.RemoteException;

    void newSmsOnSim(int i, int i2) throws android.os.RemoteException;

    void newSmsStatusReport(int i, java.util.ArrayList<java.lang.Byte> arrayList) throws android.os.RemoteException;

    void nitzTimeReceived(int i, java.lang.String str, long j) throws android.os.RemoteException;

    @Override // android.internal.hidl.base.V1_0.IBase
    void notifySyspropsChanged() throws android.os.RemoteException;

    void onSupplementaryServiceIndication(int i, android.hardware.radio.V1_0.StkCcUnsolSsResult stkCcUnsolSsResult) throws android.os.RemoteException;

    void onUssd(int i, int i2, java.lang.String str) throws android.os.RemoteException;

    void pcoData(int i, android.hardware.radio.V1_0.PcoDataInfo pcoDataInfo) throws android.os.RemoteException;

    @Override // android.internal.hidl.base.V1_0.IBase
    void ping() throws android.os.RemoteException;

    void radioCapabilityIndication(int i, android.hardware.radio.V1_0.RadioCapability radioCapability) throws android.os.RemoteException;
    ...
    void simRefresh(int i, android.hardware.radio.V1_0.SimRefreshResult simRefreshResult) throws android.os.RemoteException;
    ...
    void suppSvcNotify(int i, android.hardware.radio.V1_0.SuppSvcNotification suppSvcNotification) throws android.os.RemoteException;
    ...
    static android.hardware.radio.V1_0.IRadioIndication asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.radio.V1_0.IRadioIndication)) {
            return (android.hardware.radio.V1_0.IRadioIndication) queryLocalInterface;
        }
        android.hardware.radio.V1_0.IRadioIndication.Proxy proxy = new android.hardware.radio.V1_0.IRadioIndication.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.radio.V1_0.IRadioIndication castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.radio.V1_0.IRadioIndication getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.radio.V1_0.IRadioIndication getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.radio.V1_0.IRadioIndication getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.radio.V1_0.IRadioIndication getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.radio.V1_0.IRadioIndication {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.radio.V1_0.IRadioIndication {
        @Override // android.hardware.radio.V1_0.IRadioIndication, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.radio.V1_0.IRadioIndication.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.radio.V1_0.IRadioIndication.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
