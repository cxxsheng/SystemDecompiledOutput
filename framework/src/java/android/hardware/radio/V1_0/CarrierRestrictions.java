...
public final class CarrierRestrictions {
    ...
    public final boolean equals(java.lang.Object obj) {
        ...
        if (obj == null || obj.getClass() != android.hardware.radio.V1_0.CarrierRestrictions.class) {
            return false;
        }
        android.hardware.radio.V1_0.CarrierRestrictions carrierRestrictions = (android.hardware.radio.V1_0.CarrierRestrictions) obj;
        if (android.os.HidlSupport.deepEquals(this.allowedCarriers, carrierRestrictions.allowedCarriers) && android.os.HidlSupport.deepEquals(this.excludedCarriers, carrierRestrictions.excludedCarriers)) {
            return true;
        }
        return false;
    }
    ...
    public final int hashCode() {
        return java.util.Objects.hash(java.lang.Integer.valueOf(android.os.HidlSupport.deepHashCode(this.allowedCarriers)), java.lang.Integer.valueOf(android.os.HidlSupport.deepHashCode(this.excludedCarriers)));
    }
    ...
    public static final java.util.ArrayList<android.hardware.radio.V1_0.CarrierRestrictions> readVectorFromParcel(android.os.HwParcel hwParcel) {
        java.util.ArrayList<android.hardware.radio.V1_0.CarrierRestrictions> arrayList = new java.util.ArrayList<>();
    ...
    public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.hardware.radio.V1_0.CarrierRestrictions> arrayList) {
