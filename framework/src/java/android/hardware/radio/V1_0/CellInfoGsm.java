...
public final class CellInfoGsm {
    ...
    public final boolean equals(java.lang.Object obj) {
        ...
        if (obj == null || obj.getClass() != android.hardware.radio.V1_0.CellInfoGsm.class) {
            return false;
        }
        android.hardware.radio.V1_0.CellInfoGsm cellInfoGsm = (android.hardware.radio.V1_0.CellInfoGsm) obj;
    ...
    public static final java.util.ArrayList<android.hardware.radio.V1_0.CellInfoGsm> readVectorFromParcel(android.os.HwParcel hwParcel) {
        java.util.ArrayList<android.hardware.radio.V1_0.CellInfoGsm> arrayList = new java.util.ArrayList<>();
    ...
    public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.hardware.radio.V1_0.CellInfoGsm> arrayList) {
