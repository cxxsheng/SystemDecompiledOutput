...
public final class CellIdentityTdscdma {
    ...
    public final boolean equals(java.lang.Object obj) {
        ...
        if (obj == null || obj.getClass() != android.hardware.radio.V1_0.CellIdentityTdscdma.class) {
            return false;
        }
        android.hardware.radio.V1_0.CellIdentityTdscdma cellIdentityTdscdma = (android.hardware.radio.V1_0.CellIdentityTdscdma) obj;
        if (android.os.HidlSupport.deepEquals(this.mcc, cellIdentityTdscdma.mcc) && android.os.HidlSupport.deepEquals(this.mnc, cellIdentityTdscdma.mnc) && this.lac == cellIdentityTdscdma.lac && this.cid == cellIdentityTdscdma.cid && this.cpid == cellIdentityTdscdma.cpid) {
            return true;
        }
        return false;
    }
    ...
    public static final java.util.ArrayList<android.hardware.radio.V1_0.CellIdentityTdscdma> readVectorFromParcel(android.os.HwParcel hwParcel) {
        java.util.ArrayList<android.hardware.radio.V1_0.CellIdentityTdscdma> arrayList = new java.util.ArrayList<>();
    ...
    public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.hardware.radio.V1_0.CellIdentityTdscdma> arrayList) {
