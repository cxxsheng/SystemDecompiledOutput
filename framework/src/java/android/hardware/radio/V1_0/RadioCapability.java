...
public final class RadioCapability {
    ...
    public final boolean equals(java.lang.Object obj) {
        ...
        if (obj == null || obj.getClass() != android.hardware.radio.V1_0.RadioCapability.class) {
            return false;
        }
        android.hardware.radio.V1_0.RadioCapability radioCapability = (android.hardware.radio.V1_0.RadioCapability) obj;
    ...
    public final java.lang.String toString() {
        return "{.session = " + this.session + ", .phase = " + android.hardware.radio.V1_0.RadioCapabilityPhase.toString(this.phase) + ", .raf = " + android.hardware.radio.V1_0.RadioAccessFamily.dumpBitfield(this.raf) + ", .logicalModemUuid = " + this.logicalModemUuid + ", .status = " + android.hardware.radio.V1_0.RadioCapabilityStatus.toString(this.status) + "}";
    }
    ...
    public static final java.util.ArrayList<android.hardware.radio.V1_0.RadioCapability> readVectorFromParcel(android.os.HwParcel hwParcel) {
        java.util.ArrayList<android.hardware.radio.V1_0.RadioCapability> arrayList = new java.util.ArrayList<>();
    ...
    public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.hardware.radio.V1_0.RadioCapability> arrayList) {
