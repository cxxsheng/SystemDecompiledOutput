...
public final class CellInfo {
    ...
    public java.util.ArrayList<android.hardware.radio.V1_0.CellInfoGsm> gsm = new java.util.ArrayList<>();
    public java.util.ArrayList<android.hardware.radio.V1_0.CellInfoCdma> cdma = new java.util.ArrayList<>();
    public java.util.ArrayList<android.hardware.radio.V1_0.CellInfoLte> lte = new java.util.ArrayList<>();
    public java.util.ArrayList<android.hardware.radio.V1_0.CellInfoWcdma> wcdma = new java.util.ArrayList<>();
    public java.util.ArrayList<android.hardware.radio.V1_0.CellInfoTdscdma> tdscdma = new java.util.ArrayList<>();

    public final boolean equals(java.lang.Object obj) {
        if (this == obj) {
            return true;
        }
        if (obj == null || obj.getClass() != android.hardware.radio.V1_0.CellInfo.class) {
            return false;
        }
    ...
    public static final java.util.ArrayList<android.hardware.radio.V1_0.CellInfo> readVectorFromParcel(android.os.HwParcel hwParcel) {
        java.util.ArrayList<android.hardware.radio.V1_0.CellInfo> arrayList = new java.util.ArrayList<>();
        android.os.HwBlob readBuffer = hwParcel.readBuffer(16L);
        int int32 = readBuffer.getInt32(8L);
        android.os.HwBlob readEmbeddedBuffer = hwParcel.readEmbeddedBuffer(int32 * 104, readBuffer.handle(), 0L, true);
        arrayList.clear();
        for (int i = 0; i < int32; i++) {
            android.hardware.radio.V1_0.CellInfo cellInfo = new android.hardware.radio.V1_0.CellInfo();
    ...
    public final void readEmbeddedFromParcel(android.os.HwParcel hwParcel, android.os.HwBlob hwBlob, long j) {
        ...
        this.gsm.clear();
        for (int i = 0; i < int32; i++) {
            android.hardware.radio.V1_0.CellInfoGsm cellInfoGsm = new android.hardware.radio.V1_0.CellInfoGsm();
        ...
        android.os.HwBlob readEmbeddedBuffer2 = hwParcel.readEmbeddedBuffer(int322 * 40, hwBlob.handle(), j3 + 0, true);
        this.cdma.clear();
        ...
        android.os.HwBlob readEmbeddedBuffer3 = hwParcel.readEmbeddedBuffer(int323 * 72, hwBlob.handle(), j4 + 0, true);
        this.lte.clear();
        for (int i3 = 0; i3 < int323; i3++) {
            android.hardware.radio.V1_0.CellInfoLte cellInfoLte = new android.hardware.radio.V1_0.CellInfoLte();
        ...
        android.os.HwBlob readEmbeddedBuffer4 = hwParcel.readEmbeddedBuffer(int324 * 56, hwBlob.handle(), j5 + 0, true);
        this.wcdma.clear();
        for (int i4 = 0; i4 < int324; i4++) {
            android.hardware.radio.V1_0.CellInfoWcdma cellInfoWcdma = new android.hardware.radio.V1_0.CellInfoWcdma();
        ...
        android.os.HwBlob readEmbeddedBuffer5 = hwParcel.readEmbeddedBuffer(int325 * 56, hwBlob.handle(), j6 + 0, true);
        this.tdscdma.clear();
        for (int i5 = 0; i5 < int325; i5++) {
            android.hardware.radio.V1_0.CellInfoTdscdma cellInfoTdscdma = new android.hardware.radio.V1_0.CellInfoTdscdma();
    ...
    public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.hardware.radio.V1_0.CellInfo> arrayList) {
    ...
    public final void writeEmbeddedToBlob(android.os.HwBlob hwBlob, long j) {
        ...
        android.os.HwBlob hwBlob3 = new android.os.HwBlob(size2 * 40);
        ...
        android.os.HwBlob hwBlob4 = new android.os.HwBlob(size3 * 72);
        ...
        android.os.HwBlob hwBlob5 = new android.os.HwBlob(size4 * 56);
        ...
        android.os.HwBlob hwBlob6 = new android.os.HwBlob(size5 * 56);
