...
public final class CellIdentity {
    ...
    public java.util.ArrayList<android.hardware.radio.V1_0.CellIdentityGsm> cellIdentityGsm = new java.util.ArrayList<>();
    public java.util.ArrayList<android.hardware.radio.V1_0.CellIdentityWcdma> cellIdentityWcdma = new java.util.ArrayList<>();
    public java.util.ArrayList<android.hardware.radio.V1_0.CellIdentityCdma> cellIdentityCdma = new java.util.ArrayList<>();
    public java.util.ArrayList<android.hardware.radio.V1_0.CellIdentityLte> cellIdentityLte = new java.util.ArrayList<>();
    public java.util.ArrayList<android.hardware.radio.V1_0.CellIdentityTdscdma> cellIdentityTdscdma = new java.util.ArrayList<>();

    public final boolean equals(java.lang.Object obj) {
        if (this == obj) {
            return true;
        }
        if (obj == null || obj.getClass() != android.hardware.radio.V1_0.CellIdentity.class) {
            return false;
        }
    ...
    public static final java.util.ArrayList<android.hardware.radio.V1_0.CellIdentity> readVectorFromParcel(android.os.HwParcel hwParcel) {
        java.util.ArrayList<android.hardware.radio.V1_0.CellIdentity> arrayList = new java.util.ArrayList<>();
        android.os.HwBlob readBuffer = hwParcel.readBuffer(16L);
        int int32 = readBuffer.getInt32(8L);
        android.os.HwBlob readEmbeddedBuffer = hwParcel.readEmbeddedBuffer(int32 * 88, readBuffer.handle(), 0L, true);
        arrayList.clear();
        for (int i = 0; i < int32; i++) {
            android.hardware.radio.V1_0.CellIdentity cellIdentity = new android.hardware.radio.V1_0.CellIdentity();
    ...
    public final void readEmbeddedFromParcel(android.os.HwParcel hwParcel, android.os.HwBlob hwBlob, long j) {
        ...
        android.os.HwBlob readEmbeddedBuffer3 = hwParcel.readEmbeddedBuffer(int323 * 20, hwBlob.handle(), j4 + 0, true);
        ...
        android.os.HwBlob readEmbeddedBuffer4 = hwParcel.readEmbeddedBuffer(int324 * 48, hwBlob.handle(), j5 + 0, true);
        ...
        android.os.HwBlob readEmbeddedBuffer5 = hwParcel.readEmbeddedBuffer(int325 * 48, hwBlob.handle(), j6 + 0, true);
        this.cellIdentityTdscdma.clear();
        for (int i5 = 0; i5 < int325; i5++) {
            android.hardware.radio.V1_0.CellIdentityTdscdma cellIdentityTdscdma = new android.hardware.radio.V1_0.CellIdentityTdscdma();
    ...
    public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.hardware.radio.V1_0.CellIdentity> arrayList) {
    ...
    public final void writeEmbeddedToBlob(android.os.HwBlob hwBlob, long j) {
        ...
        android.os.HwBlob hwBlob4 = new android.os.HwBlob(size3 * 20);
        ...
        android.os.HwBlob hwBlob5 = new android.os.HwBlob(size4 * 48);
