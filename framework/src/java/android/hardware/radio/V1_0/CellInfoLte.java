...
public final class CellInfoLte {
    ...
    public final boolean equals(java.lang.Object obj) {
        ...
        if (obj == null || obj.getClass() != android.hardware.radio.V1_0.CellInfoLte.class) {
            return false;
        }
        android.hardware.radio.V1_0.CellInfoLte cellInfoLte = (android.hardware.radio.V1_0.CellInfoLte) obj;
    ...
    public static final java.util.ArrayList<android.hardware.radio.V1_0.CellInfoLte> readVectorFromParcel(android.os.HwParcel hwParcel) {
        java.util.ArrayList<android.hardware.radio.V1_0.CellInfoLte> arrayList = new java.util.ArrayList<>();
    ...
    public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.hardware.radio.V1_0.CellInfoLte> arrayList) {
