...
public interface IContexthub extends android.hardware.contexthub.V1_0.IContexthub {
    public static final java.lang.String kInterfaceName = "android.hardware.contexthub@1.1::IContexthub";
    ...
    void onSettingChanged(byte b, byte b2) throws android.os.RemoteException;
    ...
    static android.hardware.contexthub.V1_1.IContexthub asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.contexthub.V1_1.IContexthub)) {
            return (android.hardware.contexthub.V1_1.IContexthub) queryLocalInterface;
        }
        android.hardware.contexthub.V1_1.IContexthub.Proxy proxy = new android.hardware.contexthub.V1_1.IContexthub.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.contexthub.V1_1.IContexthub castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.contexthub.V1_1.IContexthub getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.contexthub.V1_1.IContexthub getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.contexthub.V1_1.IContexthub getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.contexthub.V1_1.IContexthub getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.contexthub.V1_1.IContexthub {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.contexthub.V1_1.IContexthub {
        @Override // android.hardware.contexthub.V1_1.IContexthub, android.hardware.contexthub.V1_0.IContexthub, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.contexthub.V1_1.IContexthub.kInterfaceName, android.hardware.contexthub.V1_0.IContexthub.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.contexthub.V1_1.IContexthub.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
