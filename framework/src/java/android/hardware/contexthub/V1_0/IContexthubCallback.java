...
public interface IContexthubCallback extends android.internal.hidl.base.V1_0.IBase {
    public static final java.lang.String kInterfaceName = "android.hardware.contexthub@1.0::IContexthubCallback";
    ...
    void handleAppAbort(long j, int i) throws android.os.RemoteException;

    void handleAppsInfo(java.util.ArrayList<android.hardware.contexthub.V1_0.HubAppInfo> arrayList) throws android.os.RemoteException;

    void handleClientMsg(android.hardware.contexthub.V1_0.ContextHubMsg contextHubMsg) throws android.os.RemoteException;

    void handleHubEvent(int i) throws android.os.RemoteException;

    void handleTxnResult(int i, int i2) throws android.os.RemoteException;
    ...
    static android.hardware.contexthub.V1_0.IContexthubCallback asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.contexthub.V1_0.IContexthubCallback)) {
            return (android.hardware.contexthub.V1_0.IContexthubCallback) queryLocalInterface;
        }
        android.hardware.contexthub.V1_0.IContexthubCallback.Proxy proxy = new android.hardware.contexthub.V1_0.IContexthubCallback.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.contexthub.V1_0.IContexthubCallback castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.contexthub.V1_0.IContexthubCallback getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.contexthub.V1_0.IContexthubCallback getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.contexthub.V1_0.IContexthubCallback getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.contexthub.V1_0.IContexthubCallback getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.contexthub.V1_0.IContexthubCallback {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.contexthub.V1_0.IContexthubCallback {
        @Override // android.hardware.contexthub.V1_0.IContexthubCallback, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.contexthub.V1_0.IContexthubCallback.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.contexthub.V1_0.IContexthubCallback.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
