...
public interface ICas extends android.hardware.cas.V1_1.ICas {
    ...
    void openSession_1_2(int i, int i2, android.hardware.cas.V1_2.ICas.openSession_1_2Callback opensession_1_2callback) throws android.os.RemoteException;
    ...
    static android.hardware.cas.V1_2.ICas asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.cas.V1_2.ICas)) {
            return (android.hardware.cas.V1_2.ICas) queryLocalInterface;
        }
        android.hardware.cas.V1_2.ICas.Proxy proxy = new android.hardware.cas.V1_2.ICas.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.cas.V1_2.ICas castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.cas.V1_2.ICas getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.cas.V1_2.ICas getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.cas.V1_2.ICas getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.cas.V1_2.ICas getService() throws android.os.RemoteException {
    ...
    public static final class Proxy implements android.hardware.cas.V1_2.ICas {
        ...
        public void openSession_1_2(int i, int i2, android.hardware.cas.V1_2.ICas.openSession_1_2Callback opensession_1_2callback) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.cas.V1_2.ICas.kInterfaceName);
            hwParcel.writeInt32(i);
            hwParcel.writeInt32(i2);
            android.os.HwParcel hwParcel2 = new android.os.HwParcel();
            try {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.cas.V1_2.ICas {
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.cas.V1_2.ICas.kInterfaceName, android.hardware.cas.V1_1.ICas.kInterfaceName, android.hardware.cas.V1_0.ICas.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.cas.V1_2.ICas.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, final android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                ...
                case 2:
                    hwParcel.enforceInterface(android.hardware.cas.V1_0.ICas.kInterfaceName);
                    openSession(new android.hardware.cas.V1_0.ICas.openSessionCallback() { // from class: android.hardware.cas.V1_2.ICas.Stub.1
                ...
                case 11:
                    ...
                    return;
                case 12:
                    hwParcel.enforceInterface(android.hardware.cas.V1_2.ICas.kInterfaceName);
                    openSession_1_2(hwParcel.readInt32(), hwParcel.readInt32(), new android.hardware.cas.V1_2.ICas.openSession_1_2Callback() { // from class: android.hardware.cas.V1_2.ICas.Stub.2
