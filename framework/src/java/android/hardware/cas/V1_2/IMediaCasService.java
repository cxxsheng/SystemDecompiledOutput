...
public interface IMediaCasService extends android.hardware.cas.V1_1.IMediaCasService {
    public static final java.lang.String kInterfaceName = "android.hardware.cas@1.2::IMediaCasService";
    ...
    static android.hardware.cas.V1_2.IMediaCasService asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.cas.V1_2.IMediaCasService)) {
            return (android.hardware.cas.V1_2.IMediaCasService) queryLocalInterface;
        }
        android.hardware.cas.V1_2.IMediaCasService.Proxy proxy = new android.hardware.cas.V1_2.IMediaCasService.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.cas.V1_2.IMediaCasService castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.cas.V1_2.IMediaCasService getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.cas.V1_2.IMediaCasService getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.cas.V1_2.IMediaCasService getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.cas.V1_2.IMediaCasService getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.cas.V1_2.IMediaCasService {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.cas.V1_2.IMediaCasService {
        @Override // android.hardware.cas.V1_2.IMediaCasService, android.hardware.cas.V1_1.IMediaCasService, android.hardware.cas.V1_0.IMediaCasService, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.cas.V1_2.IMediaCasService.kInterfaceName, android.hardware.cas.V1_1.IMediaCasService.kInterfaceName, android.hardware.cas.V1_0.IMediaCasService.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.cas.V1_2.IMediaCasService.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
