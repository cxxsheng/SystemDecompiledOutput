...
public interface ICasListener extends android.hardware.cas.V1_1.ICasListener {
    public static final java.lang.String kInterfaceName = "android.hardware.cas@1.2::ICasListener";
    ...
    static android.hardware.cas.V1_2.ICasListener asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.cas.V1_2.ICasListener)) {
            return (android.hardware.cas.V1_2.ICasListener) queryLocalInterface;
        }
        android.hardware.cas.V1_2.ICasListener.Proxy proxy = new android.hardware.cas.V1_2.ICasListener.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.cas.V1_2.ICasListener castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.cas.V1_2.ICasListener getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.cas.V1_2.ICasListener getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.cas.V1_2.ICasListener getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.cas.V1_2.ICasListener getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.cas.V1_2.ICasListener {
        ...
        public void onStatusUpdate(byte b, int i) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.cas.V1_2.ICasListener.kInterfaceName);
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.cas.V1_2.ICasListener {
        @Override // android.hardware.cas.V1_2.ICasListener, android.hardware.cas.V1_1.ICasListener, android.hardware.cas.V1_0.ICasListener, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.cas.V1_2.ICasListener.kInterfaceName, android.hardware.cas.V1_1.ICasListener.kInterfaceName, android.hardware.cas.V1_0.ICasListener.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public final java.util.ArrayList<byte[]> getHashChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(new byte[]{-104, 17, -8, 103, -34, -12, -101, 66, 13, -116, 112, Byte.MAX_VALUE, 126, 56, -45, -67, -42, 79, -125, 82, 68, -31, -46, -91, -23, 118, 42, -71, -125, 86, 114, -36}, new byte[]{37, 1, 45, android.hardware.biometrics.face.AcquiredInfo.VENDOR, 120, -9, 57, 111, -106, 123, -68, 2, 49, 57, 125, 84, 75, -34, 66, com.android.internal.telephony.GsmAlphabet.GSM_EXTENDED_ESCAPE, -91, -71, -121, 6, -55, -28, -118, -57, com.android.internal.midi.MidiConstants.STATUS_NOTE_ON, 97, 38, -125}, new byte[]{-72, 14, 20, 86, -72, 31, Byte.MIN_VALUE, 3, 45, 13, -25, -53, 69, 101, 42, -63, 90, com.android.internal.midi.MidiConstants.STATUS_MIDI_TIME_CODE, 30, 116, 116, -43, com.android.net.module.util.NetworkStackConstants.TCPHDR_URG, -41, 87, 72, 30, -54, -83, 121, 109, -1}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, com.android.internal.midi.MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, com.android.internal.midi.MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, android.hardware.biometrics.face.AcquiredInfo.ROLL_TOO_EXTREME, -109, 36, -72, 59, android.hardware.biometrics.face.AcquiredInfo.FIRST_FRAME_RECEIVED, -54, 76}));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.cas.V1_2.ICasListener.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                ...
                case 2:
                    ...
                    return;
                case 3:
                    hwParcel.enforceInterface(android.hardware.cas.V1_2.ICasListener.kInterfaceName);
