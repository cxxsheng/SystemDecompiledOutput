...
public interface IMediaCasService extends android.internal.hidl.base.V1_0.IBase {
    ...
    android.hardware.cas.V1_0.IDescramblerBase createDescrambler(int i) throws android.os.RemoteException;

    android.hardware.cas.V1_0.ICas createPlugin(int i, android.hardware.cas.V1_0.ICasListener iCasListener) throws android.os.RemoteException;

    @Override // android.internal.hidl.base.V1_0.IBase
    void debug(android.os.NativeHandle nativeHandle, java.util.ArrayList<java.lang.String> arrayList) throws android.os.RemoteException;

    java.util.ArrayList<android.hardware.cas.V1_0.HidlCasPluginDescriptor> enumeratePlugins() throws android.os.RemoteException;
    ...
    static android.hardware.cas.V1_0.IMediaCasService asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.cas.V1_0.IMediaCasService)) {
            return (android.hardware.cas.V1_0.IMediaCasService) queryLocalInterface;
        }
        android.hardware.cas.V1_0.IMediaCasService.Proxy proxy = new android.hardware.cas.V1_0.IMediaCasService.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.cas.V1_0.IMediaCasService castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.cas.V1_0.IMediaCasService getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.cas.V1_0.IMediaCasService getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.cas.V1_0.IMediaCasService getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.cas.V1_0.IMediaCasService getService() throws android.os.RemoteException {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.cas.V1_0.IMediaCasService {
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.cas.V1_0.IMediaCasService.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.cas.V1_0.IMediaCasService.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
