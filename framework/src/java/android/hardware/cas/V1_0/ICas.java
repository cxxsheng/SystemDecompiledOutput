...
public interface ICas extends android.internal.hidl.base.V1_0.IBase {
    public static final java.lang.String kInterfaceName = "android.hardware.cas@1.0::ICas";
    ...
    int closeSession(java.util.ArrayList<java.lang.Byte> arrayList) throws android.os.RemoteException;
    ...
    void openSession(android.hardware.cas.V1_0.ICas.openSessionCallback opensessioncallback) throws android.os.RemoteException;

    @Override // android.internal.hidl.base.V1_0.IBase
    void ping() throws android.os.RemoteException;

    int processEcm(java.util.ArrayList<java.lang.Byte> arrayList, java.util.ArrayList<java.lang.Byte> arrayList2) throws android.os.RemoteException;

    int processEmm(java.util.ArrayList<java.lang.Byte> arrayList) throws android.os.RemoteException;

    int provision(java.lang.String str) throws android.os.RemoteException;

    int refreshEntitlements(int i, java.util.ArrayList<java.lang.Byte> arrayList) throws android.os.RemoteException;

    int release() throws android.os.RemoteException;

    int sendEvent(int i, int i2, java.util.ArrayList<java.lang.Byte> arrayList) throws android.os.RemoteException;

    @Override // android.internal.hidl.base.V1_0.IBase
    void setHALInstrumentation() throws android.os.RemoteException;

    int setPrivateData(java.util.ArrayList<java.lang.Byte> arrayList) throws android.os.RemoteException;

    int setSessionPrivateData(java.util.ArrayList<java.lang.Byte> arrayList, java.util.ArrayList<java.lang.Byte> arrayList2) throws android.os.RemoteException;

    @Override // android.internal.hidl.base.V1_0.IBase
    boolean unlinkToDeath(android.os.IHwBinder.DeathRecipient deathRecipient) throws android.os.RemoteException;

    static android.hardware.cas.V1_0.ICas asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.cas.V1_0.ICas)) {
            return (android.hardware.cas.V1_0.ICas) queryLocalInterface;
        }
        android.hardware.cas.V1_0.ICas.Proxy proxy = new android.hardware.cas.V1_0.ICas.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.cas.V1_0.ICas castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.cas.V1_0.ICas getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.cas.V1_0.ICas getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.cas.V1_0.ICas getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.cas.V1_0.ICas getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.cas.V1_0.ICas {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.cas.V1_0.ICas {
        @Override // android.hardware.cas.V1_0.ICas, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.cas.V1_0.ICas.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.cas.V1_0.ICas.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, final android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                ...
                case 2:
                    hwParcel.enforceInterface(android.hardware.cas.V1_0.ICas.kInterfaceName);
                    openSession(new android.hardware.cas.V1_0.ICas.openSessionCallback() { // from class: android.hardware.cas.V1_0.ICas.Stub.1
