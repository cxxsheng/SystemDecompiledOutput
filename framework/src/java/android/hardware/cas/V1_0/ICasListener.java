...
public interface ICasListener extends android.internal.hidl.base.V1_0.IBase {
    public static final java.lang.String kInterfaceName = "android.hardware.cas@1.0::ICasListener";
    ...
    void onEvent(int i, int i2, java.util.ArrayList<java.lang.Byte> arrayList) throws android.os.RemoteException;
    ...
    static android.hardware.cas.V1_0.ICasListener asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.cas.V1_0.ICasListener)) {
            return (android.hardware.cas.V1_0.ICasListener) queryLocalInterface;
        }
        android.hardware.cas.V1_0.ICasListener.Proxy proxy = new android.hardware.cas.V1_0.ICasListener.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.cas.V1_0.ICasListener castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.cas.V1_0.ICasListener getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.cas.V1_0.ICasListener getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.cas.V1_0.ICasListener getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.cas.V1_0.ICasListener getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.cas.V1_0.ICasListener {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.cas.V1_0.ICasListener {
        @Override // android.hardware.cas.V1_0.ICasListener, android.internal.hidl.base.V1_0.IBase, android.os.IHwInterface
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.cas.V1_0.ICasListener.kInterfaceName, android.internal.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.cas.V1_0.ICasListener.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
