...
public class FrontendIsdbsSettings implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.hardware.tv.tuner.FrontendIsdbsSettings> CREATOR = new android.os.Parcelable.Creator<android.hardware.tv.tuner.FrontendIsdbsSettings>() { // from class: android.hardware.tv.tuner.FrontendIsdbsSettings.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.hardware.tv.tuner.FrontendIsdbsSettings createFromParcel(android.os.Parcel parcel) {
            android.hardware.tv.tuner.FrontendIsdbsSettings frontendIsdbsSettings = new android.hardware.tv.tuner.FrontendIsdbsSettings();
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.hardware.tv.tuner.FrontendIsdbsSettings[] newArray(int i) {
            return new android.hardware.tv.tuner.FrontendIsdbsSettings[i];
        }
    };
