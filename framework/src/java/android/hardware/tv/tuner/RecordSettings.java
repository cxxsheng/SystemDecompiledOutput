...
public class RecordSettings implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.hardware.tv.tuner.RecordSettings> CREATOR = new android.os.Parcelable.Creator<android.hardware.tv.tuner.RecordSettings>() { // from class: android.hardware.tv.tuner.RecordSettings.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.hardware.tv.tuner.RecordSettings createFromParcel(android.os.Parcel parcel) {
            android.hardware.tv.tuner.RecordSettings recordSettings = new android.hardware.tv.tuner.RecordSettings();
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.hardware.tv.tuner.RecordSettings[] newArray(int i) {
            return new android.hardware.tv.tuner.RecordSettings[i];
        }
    };
