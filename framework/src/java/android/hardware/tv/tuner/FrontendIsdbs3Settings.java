...
public class FrontendIsdbs3Settings implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.hardware.tv.tuner.FrontendIsdbs3Settings> CREATOR = new android.os.Parcelable.Creator<android.hardware.tv.tuner.FrontendIsdbs3Settings>() { // from class: android.hardware.tv.tuner.FrontendIsdbs3Settings.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.hardware.tv.tuner.FrontendIsdbs3Settings createFromParcel(android.os.Parcel parcel) {
            android.hardware.tv.tuner.FrontendIsdbs3Settings frontendIsdbs3Settings = new android.hardware.tv.tuner.FrontendIsdbs3Settings();
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.hardware.tv.tuner.FrontendIsdbs3Settings[] newArray(int i) {
            return new android.hardware.tv.tuner.FrontendIsdbs3Settings[i];
        }
    };
