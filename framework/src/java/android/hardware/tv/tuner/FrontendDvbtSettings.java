...
public class FrontendDvbtSettings implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.hardware.tv.tuner.FrontendDvbtSettings> CREATOR = new android.os.Parcelable.Creator<android.hardware.tv.tuner.FrontendDvbtSettings>() { // from class: android.hardware.tv.tuner.FrontendDvbtSettings.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.hardware.tv.tuner.FrontendDvbtSettings createFromParcel(android.os.Parcel parcel) {
            android.hardware.tv.tuner.FrontendDvbtSettings frontendDvbtSettings = new android.hardware.tv.tuner.FrontendDvbtSettings();
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.hardware.tv.tuner.FrontendDvbtSettings[] newArray(int i) {
            return new android.hardware.tv.tuner.FrontendDvbtSettings[i];
        }
    };
