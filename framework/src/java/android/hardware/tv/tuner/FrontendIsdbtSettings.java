...
public class FrontendIsdbtSettings implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.hardware.tv.tuner.FrontendIsdbtSettings> CREATOR = new android.os.Parcelable.Creator<android.hardware.tv.tuner.FrontendIsdbtSettings>() { // from class: android.hardware.tv.tuner.FrontendIsdbtSettings.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.hardware.tv.tuner.FrontendIsdbtSettings createFromParcel(android.os.Parcel parcel) {
            android.hardware.tv.tuner.FrontendIsdbtSettings frontendIsdbtSettings = new android.hardware.tv.tuner.FrontendIsdbtSettings();
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.hardware.tv.tuner.FrontendIsdbtSettings[] newArray(int i) {
            return new android.hardware.tv.tuner.FrontendIsdbtSettings[i];
        }
    };
    ...
    public final void readFromParcel(android.os.Parcel parcel) {
        ...
        try {
            ...
            if (parcel.dataPosition() - dataPosition >= readInt) {
                ...
                this.layerSettings = (android.hardware.tv.tuner.FrontendIsdbtLayerSettings[]) parcel.createTypedArray(android.hardware.tv.tuner.FrontendIsdbtLayerSettings.CREATOR);
                if (dataPosition > Integer.MAX_VALUE - readInt) {
                    throw new android.os.BadParcelableException("Overflow in the size of parcelable");
                }
                parcel.setDataPosition(dataPosition + readInt);
    ...
    public int describeContents() {
        return describeContents(this.layerSettings) | 0;
    }
