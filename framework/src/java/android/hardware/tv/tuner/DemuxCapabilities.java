...
public class DemuxCapabilities implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.hardware.tv.tuner.DemuxCapabilities> CREATOR = new android.os.Parcelable.Creator<android.hardware.tv.tuner.DemuxCapabilities>() { // from class: android.hardware.tv.tuner.DemuxCapabilities.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.hardware.tv.tuner.DemuxCapabilities createFromParcel(android.os.Parcel parcel) {
            android.hardware.tv.tuner.DemuxCapabilities demuxCapabilities = new android.hardware.tv.tuner.DemuxCapabilities();
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.hardware.tv.tuner.DemuxCapabilities[] newArray(int i) {
            return new android.hardware.tv.tuner.DemuxCapabilities[i];
        }
    };
    public int[] linkCaps;
