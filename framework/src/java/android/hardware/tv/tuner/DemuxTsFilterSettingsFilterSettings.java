...
public final class DemuxTsFilterSettingsFilterSettings implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.hardware.tv.tuner.DemuxTsFilterSettingsFilterSettings> CREATOR = new android.os.Parcelable.Creator<android.hardware.tv.tuner.DemuxTsFilterSettingsFilterSettings>() { // from class: android.hardware.tv.tuner.DemuxTsFilterSettingsFilterSettings.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.hardware.tv.tuner.DemuxTsFilterSettingsFilterSettings createFromParcel(android.os.Parcel parcel) {
            return new android.hardware.tv.tuner.DemuxTsFilterSettingsFilterSettings(parcel);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.hardware.tv.tuner.DemuxTsFilterSettingsFilterSettings[] newArray(int i) {
            return new android.hardware.tv.tuner.DemuxTsFilterSettingsFilterSettings[i];
        }
    };
    ...
    private DemuxTsFilterSettingsFilterSettings(android.os.Parcel parcel) {
        readFromParcel(parcel);
    }

    private DemuxTsFilterSettingsFilterSettings(int i, java.lang.Object obj) {
        this._tag = i;
        this._value = obj;
    }
    ...
    public static android.hardware.tv.tuner.DemuxTsFilterSettingsFilterSettings noinit(boolean z) {
        return new android.hardware.tv.tuner.DemuxTsFilterSettingsFilterSettings(0, java.lang.Boolean.valueOf(z));
    }
    ...
    public static android.hardware.tv.tuner.DemuxTsFilterSettingsFilterSettings section(android.hardware.tv.tuner.DemuxFilterSectionSettings demuxFilterSectionSettings) {
        return new android.hardware.tv.tuner.DemuxTsFilterSettingsFilterSettings(1, demuxFilterSectionSettings);
    }
    ...
    public static android.hardware.tv.tuner.DemuxTsFilterSettingsFilterSettings av(android.hardware.tv.tuner.DemuxFilterAvSettings demuxFilterAvSettings) {
        return new android.hardware.tv.tuner.DemuxTsFilterSettingsFilterSettings(2, demuxFilterAvSettings);
    }
    ...
    public static android.hardware.tv.tuner.DemuxTsFilterSettingsFilterSettings pesData(android.hardware.tv.tuner.DemuxFilterPesDataSettings demuxFilterPesDataSettings) {
        return new android.hardware.tv.tuner.DemuxTsFilterSettingsFilterSettings(3, demuxFilterPesDataSettings);
    }
    ...
    public static android.hardware.tv.tuner.DemuxTsFilterSettingsFilterSettings record(android.hardware.tv.tuner.DemuxFilterRecordSettings demuxFilterRecordSettings) {
        return new android.hardware.tv.tuner.DemuxTsFilterSettingsFilterSettings(4, demuxFilterRecordSettings);
    }
