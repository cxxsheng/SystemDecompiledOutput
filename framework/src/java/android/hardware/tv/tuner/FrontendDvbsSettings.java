...
public class FrontendDvbsSettings implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.hardware.tv.tuner.FrontendDvbsSettings> CREATOR = new android.os.Parcelable.Creator<android.hardware.tv.tuner.FrontendDvbsSettings>() { // from class: android.hardware.tv.tuner.FrontendDvbsSettings.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.hardware.tv.tuner.FrontendDvbsSettings createFromParcel(android.os.Parcel parcel) {
            android.hardware.tv.tuner.FrontendDvbsSettings frontendDvbsSettings = new android.hardware.tv.tuner.FrontendDvbsSettings();
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.hardware.tv.tuner.FrontendDvbsSettings[] newArray(int i) {
            return new android.hardware.tv.tuner.FrontendDvbsSettings[i];
        }
    };
    ...
    public final void readFromParcel(android.os.Parcel parcel) {
        ...
        try {
            ...
            this.coderate = (android.hardware.tv.tuner.FrontendDvbsCodeRate) parcel.readTypedObject(android.hardware.tv.tuner.FrontendDvbsCodeRate.CREATOR);
            if (parcel.dataPosition() - dataPosition >= readInt) {
                if (dataPosition > Integer.MAX_VALUE - readInt) {
                    throw new android.os.BadParcelableException("Overflow in the size of parcelable");
                }
    ...
    public int describeContents() {
        return describeContents(this.coderate) | 0;
    }
