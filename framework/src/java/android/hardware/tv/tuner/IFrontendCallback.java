...
public interface IFrontendCallback extends android.os.IInterface {
    ...
    void onScanMessage(int i, android.hardware.tv.tuner.FrontendScanMessage frontendScanMessage) throws android.os.RemoteException;
    ...
    public static class Default implements android.hardware.tv.tuner.IFrontendCallback {
        ...
        @Override // android.hardware.tv.tuner.IFrontendCallback
        public void onScanMessage(int i, android.hardware.tv.tuner.FrontendScanMessage frontendScanMessage) throws android.os.RemoteException {
        }
    ...
    public static abstract class Stub extends android.os.Binder implements android.hardware.tv.tuner.IFrontendCallback {
        ...
        public static android.hardware.tv.tuner.IFrontendCallback asInterface(android.os.IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            android.os.IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.tv.tuner.IFrontendCallback)) {
                return (android.hardware.tv.tuner.IFrontendCallback) queryLocalInterface;
            }
            return new android.hardware.tv.tuner.IFrontendCallback.Stub.Proxy(iBinder);
        }
        ...
        public boolean onTransact(int i, android.os.Parcel parcel, android.os.Parcel parcel2, int i2) throws android.os.RemoteException {
            ...
            switch (i) {
                ...
                case 2:
                    ...
                    android.hardware.tv.tuner.FrontendScanMessage frontendScanMessage = (android.hardware.tv.tuner.FrontendScanMessage) parcel.readTypedObject(android.hardware.tv.tuner.FrontendScanMessage.CREATOR);
                    parcel.enforceNoDataAvail();
