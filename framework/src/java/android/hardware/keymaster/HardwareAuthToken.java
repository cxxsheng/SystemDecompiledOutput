...
public class HardwareAuthToken implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.hardware.keymaster.HardwareAuthToken> CREATOR = new android.os.Parcelable.Creator<android.hardware.keymaster.HardwareAuthToken>() { // from class: android.hardware.keymaster.HardwareAuthToken.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.hardware.keymaster.HardwareAuthToken createFromParcel(android.os.Parcel parcel) {
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.hardware.keymaster.HardwareAuthToken[] newArray(int i) {
            return new android.hardware.keymaster.HardwareAuthToken[i];
        }
    };
    public byte[] mac;
