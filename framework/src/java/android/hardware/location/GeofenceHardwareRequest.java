...
public final class GeofenceHardwareRequest {
    ...
    public static android.hardware.location.GeofenceHardwareRequest createCircularGeofence(double d, double d2, double d3) {
        android.hardware.location.GeofenceHardwareRequest geofenceHardwareRequest = new android.hardware.location.GeofenceHardwareRequest();
    ...
    public void setSourceTechnologies(int i) {
        int i2 = i & 31;
        if (i2 == 0) {
            throw new java.lang.IllegalArgumentException("At least one valid source technology must be set.");
        }
