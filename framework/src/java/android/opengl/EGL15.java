...
public final class EGL15 {
    ...
    public static native int eglClientWaitSync(android.opengl.EGLDisplay eGLDisplay, android.opengl.EGLSync eGLSync, int i, long j);

    public static native android.opengl.EGLImage eglCreateImage(android.opengl.EGLDisplay eGLDisplay, android.opengl.EGLContext eGLContext, int i, long j, long[] jArr, int i2);

    public static native android.opengl.EGLSurface eglCreatePlatformPixmapSurface(android.opengl.EGLDisplay eGLDisplay, android.opengl.EGLConfig eGLConfig, java.nio.Buffer buffer, long[] jArr, int i);

    public static native android.opengl.EGLSurface eglCreatePlatformWindowSurface(android.opengl.EGLDisplay eGLDisplay, android.opengl.EGLConfig eGLConfig, java.nio.Buffer buffer, long[] jArr, int i);

    public static native android.opengl.EGLSync eglCreateSync(android.opengl.EGLDisplay eGLDisplay, int i, long[] jArr, int i2);

    public static native boolean eglDestroyImage(android.opengl.EGLDisplay eGLDisplay, android.opengl.EGLImage eGLImage);

    public static native boolean eglDestroySync(android.opengl.EGLDisplay eGLDisplay, android.opengl.EGLSync eGLSync);

    public static native android.opengl.EGLDisplay eglGetPlatformDisplay(int i, long j, long[] jArr, int i2);

    public static native boolean eglGetSyncAttrib(android.opengl.EGLDisplay eGLDisplay, android.opengl.EGLSync eGLSync, int i, long[] jArr, int i2);

    public static native boolean eglWaitSync(android.opengl.EGLDisplay eGLDisplay, android.opengl.EGLSync eGLSync, int i);
