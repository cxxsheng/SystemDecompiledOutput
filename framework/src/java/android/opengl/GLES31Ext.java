...
public class GLES31Ext {
    ...
    public static native void glDebugMessageCallbackKHR(android.opengl.GLES31Ext.DebugProcKHR debugProcKHR);

    public static native void glDebugMessageControlKHR(int i, int i2, int i3, int i4, java.nio.IntBuffer intBuffer, boolean z);

    public static native void glDebugMessageControlKHR(int i, int i2, int i3, int i4, int[] iArr, int i5, boolean z);

    public static native void glDebugMessageInsertKHR(int i, int i2, int i3, int i4, java.lang.String str);
    ...
    public static native int glGetDebugMessageLogKHR(int i, java.nio.IntBuffer intBuffer, java.nio.IntBuffer intBuffer2, java.nio.IntBuffer intBuffer3, java.nio.IntBuffer intBuffer4, java.nio.IntBuffer intBuffer5, java.nio.ByteBuffer byteBuffer);

    public static native java.lang.String[] glGetDebugMessageLogKHR(int i, java.nio.IntBuffer intBuffer, java.nio.IntBuffer intBuffer2, java.nio.IntBuffer intBuffer3, java.nio.IntBuffer intBuffer4);

    public static native java.lang.String[] glGetDebugMessageLogKHR(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4, int[] iArr4, int i5);

    public static native java.lang.String glGetObjectLabelKHR(int i, int i2);

    public static native java.lang.String glGetObjectPtrLabelKHR(long j);

    public static native void glGetSamplerParameterIivEXT(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glGetSamplerParameterIivEXT(int i, int i2, int[] iArr, int i3);

    public static native void glGetSamplerParameterIuivEXT(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glGetSamplerParameterIuivEXT(int i, int i2, int[] iArr, int i3);

    public static native void glGetTexParameterIivEXT(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glGetTexParameterIivEXT(int i, int i2, int[] iArr, int i3);

    public static native void glGetTexParameterIuivEXT(int i, int i2, java.nio.IntBuffer intBuffer);
    ...
    public static native void glObjectLabelKHR(int i, int i2, int i3, java.lang.String str);

    public static native void glObjectPtrLabelKHR(long j, java.lang.String str);
    ...
    public static native void glPushDebugGroupKHR(int i, int i2, int i3, java.lang.String str);

    public static native void glSamplerParameterIivEXT(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glSamplerParameterIivEXT(int i, int i2, int[] iArr, int i3);

    public static native void glSamplerParameterIuivEXT(int i, int i2, java.nio.IntBuffer intBuffer);
    ...
    public static native void glTexParameterIivEXT(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glTexParameterIivEXT(int i, int i2, int[] iArr, int i3);

    public static native void glTexParameterIuivEXT(int i, int i2, java.nio.IntBuffer intBuffer);
