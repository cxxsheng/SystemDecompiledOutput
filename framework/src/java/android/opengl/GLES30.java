...
public class GLES30 extends android.opengl.GLES20 {
    ...
    public static native void glClearBufferfv(int i, int i2, java.nio.FloatBuffer floatBuffer);

    public static native void glClearBufferfv(int i, int i2, float[] fArr, int i3);

    public static native void glClearBufferiv(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glClearBufferiv(int i, int i2, int[] iArr, int i3);

    public static native void glClearBufferuiv(int i, int i2, java.nio.IntBuffer intBuffer);
    ...
    public static native void glCompressedTexImage3D(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, java.nio.Buffer buffer);
    ...
    public static native void glCompressedTexSubImage3D(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, java.nio.Buffer buffer);
    ...
    public static native void glDeleteQueries(int i, java.nio.IntBuffer intBuffer);

    public static native void glDeleteQueries(int i, int[] iArr, int i2);

    public static native void glDeleteSamplers(int i, java.nio.IntBuffer intBuffer);

    public static native void glDeleteSamplers(int i, int[] iArr, int i2);

    public static native void glDeleteSync(long j);

    public static native void glDeleteTransformFeedbacks(int i, java.nio.IntBuffer intBuffer);

    public static native void glDeleteTransformFeedbacks(int i, int[] iArr, int i2);

    public static native void glDeleteVertexArrays(int i, java.nio.IntBuffer intBuffer);
    ...
    public static native void glDrawBuffers(int i, java.nio.IntBuffer intBuffer);
    ...
    public static native void glDrawElementsInstanced(int i, int i2, int i3, java.nio.Buffer buffer, int i4);

    public static native void glDrawRangeElements(int i, int i2, int i3, int i4, int i5, int i6);

    public static native void glDrawRangeElements(int i, int i2, int i3, int i4, int i5, java.nio.Buffer buffer);
    ...
    public static native void glGenQueries(int i, java.nio.IntBuffer intBuffer);

    public static native void glGenQueries(int i, int[] iArr, int i2);

    public static native void glGenSamplers(int i, java.nio.IntBuffer intBuffer);

    public static native void glGenSamplers(int i, int[] iArr, int i2);

    public static native void glGenTransformFeedbacks(int i, java.nio.IntBuffer intBuffer);

    public static native void glGenTransformFeedbacks(int i, int[] iArr, int i2);

    public static native void glGenVertexArrays(int i, java.nio.IntBuffer intBuffer);

    public static native void glGenVertexArrays(int i, int[] iArr, int i2);

    public static native java.lang.String glGetActiveUniformBlockName(int i, int i2);

    public static native void glGetActiveUniformBlockName(int i, int i2, int i3, int[] iArr, int i4, byte[] bArr, int i5);

    public static native void glGetActiveUniformBlockName(int i, int i2, java.nio.Buffer buffer, java.nio.Buffer buffer2);

    public static native void glGetActiveUniformBlockiv(int i, int i2, int i3, java.nio.IntBuffer intBuffer);

    public static native void glGetActiveUniformBlockiv(int i, int i2, int i3, int[] iArr, int i4);

    public static native void glGetActiveUniformsiv(int i, int i2, java.nio.IntBuffer intBuffer, int i3, java.nio.IntBuffer intBuffer2);

    public static native void glGetActiveUniformsiv(int i, int i2, int[] iArr, int i3, int i4, int[] iArr2, int i5);

    public static native void glGetBufferParameteri64v(int i, int i2, java.nio.LongBuffer longBuffer);

    public static native void glGetBufferParameteri64v(int i, int i2, long[] jArr, int i3);

    public static native java.nio.Buffer glGetBufferPointerv(int i, int i2);

    public static native int glGetFragDataLocation(int i, java.lang.String str);

    public static native void glGetInteger64i_v(int i, int i2, java.nio.LongBuffer longBuffer);

    public static native void glGetInteger64i_v(int i, int i2, long[] jArr, int i3);

    public static native void glGetInteger64v(int i, java.nio.LongBuffer longBuffer);

    public static native void glGetInteger64v(int i, long[] jArr, int i2);

    public static native void glGetIntegeri_v(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glGetIntegeri_v(int i, int i2, int[] iArr, int i3);

    public static native void glGetInternalformativ(int i, int i2, int i3, int i4, java.nio.IntBuffer intBuffer);

    public static native void glGetInternalformativ(int i, int i2, int i3, int i4, int[] iArr, int i5);

    public static native void glGetProgramBinary(int i, int i2, java.nio.IntBuffer intBuffer, java.nio.IntBuffer intBuffer2, java.nio.Buffer buffer);

    public static native void glGetProgramBinary(int i, int i2, int[] iArr, int i3, int[] iArr2, int i4, java.nio.Buffer buffer);

    public static native void glGetQueryObjectuiv(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glGetQueryObjectuiv(int i, int i2, int[] iArr, int i3);

    public static native void glGetQueryiv(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glGetQueryiv(int i, int i2, int[] iArr, int i3);

    public static native void glGetSamplerParameterfv(int i, int i2, java.nio.FloatBuffer floatBuffer);

    public static native void glGetSamplerParameterfv(int i, int i2, float[] fArr, int i3);

    public static native void glGetSamplerParameteriv(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glGetSamplerParameteriv(int i, int i2, int[] iArr, int i3);

    public static native java.lang.String glGetStringi(int i, int i2);

    public static native void glGetSynciv(long j, int i, int i2, java.nio.IntBuffer intBuffer, java.nio.IntBuffer intBuffer2);

    public static native void glGetSynciv(long j, int i, int i2, int[] iArr, int i3, int[] iArr2, int i4);

    public static native java.lang.String glGetTransformFeedbackVarying(int i, int i2, java.nio.IntBuffer intBuffer, java.nio.IntBuffer intBuffer2);

    public static native java.lang.String glGetTransformFeedbackVarying(int i, int i2, int[] iArr, int i3, int[] iArr2, int i4);

    public static native void glGetTransformFeedbackVarying(int i, int i2, int i3, java.nio.IntBuffer intBuffer, java.nio.IntBuffer intBuffer2, java.nio.IntBuffer intBuffer3, byte b);

    public static native void glGetTransformFeedbackVarying(int i, int i2, int i3, java.nio.IntBuffer intBuffer, java.nio.IntBuffer intBuffer2, java.nio.IntBuffer intBuffer3, java.nio.ByteBuffer byteBuffer);
    ...
    public static native int glGetUniformBlockIndex(int i, java.lang.String str);

    public static native void glGetUniformIndices(int i, java.lang.String[] strArr, java.nio.IntBuffer intBuffer);

    public static native void glGetUniformIndices(int i, java.lang.String[] strArr, int[] iArr, int i2);

    public static native void glGetUniformuiv(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glGetUniformuiv(int i, int i2, int[] iArr, int i3);

    public static native void glGetVertexAttribIiv(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glGetVertexAttribIiv(int i, int i2, int[] iArr, int i3);

    public static native void glGetVertexAttribIuiv(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glGetVertexAttribIuiv(int i, int i2, int[] iArr, int i3);

    public static native void glInvalidateFramebuffer(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glInvalidateFramebuffer(int i, int i2, int[] iArr, int i3);

    public static native void glInvalidateSubFramebuffer(int i, int i2, java.nio.IntBuffer intBuffer, int i3, int i4, int i5, int i6);
    ...
    public static native java.nio.Buffer glMapBufferRange(int i, int i2, int i3, int i4);

    public static native void glPauseTransformFeedback();

    public static native void glProgramBinary(int i, int i2, java.nio.Buffer buffer, int i3);
    ...
    public static native void glSamplerParameterfv(int i, int i2, java.nio.FloatBuffer floatBuffer);
    ...
    public static native void glSamplerParameteriv(int i, int i2, java.nio.IntBuffer intBuffer);
    ...
    public static native void glTexImage3D(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, java.nio.Buffer buffer);
    ...
    public static native void glTexSubImage3D(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, java.nio.Buffer buffer);

    public static native void glTransformFeedbackVaryings(int i, java.lang.String[] strArr, int i2);

    public static native void glUniform1ui(int i, int i2);

    public static native void glUniform1uiv(int i, int i2, java.nio.IntBuffer intBuffer);
    ...
    public static native void glUniform2uiv(int i, int i2, java.nio.IntBuffer intBuffer);
    ...
    public static native void glUniform3uiv(int i, int i2, java.nio.IntBuffer intBuffer);
    ...
    public static native void glUniform4uiv(int i, int i2, java.nio.IntBuffer intBuffer);
    ...
    public static native void glUniformMatrix2x3fv(int i, int i2, boolean z, java.nio.FloatBuffer floatBuffer);

    public static native void glUniformMatrix2x3fv(int i, int i2, boolean z, float[] fArr, int i3);

    public static native void glUniformMatrix2x4fv(int i, int i2, boolean z, java.nio.FloatBuffer floatBuffer);

    public static native void glUniformMatrix2x4fv(int i, int i2, boolean z, float[] fArr, int i3);

    public static native void glUniformMatrix3x2fv(int i, int i2, boolean z, java.nio.FloatBuffer floatBuffer);

    public static native void glUniformMatrix3x2fv(int i, int i2, boolean z, float[] fArr, int i3);

    public static native void glUniformMatrix3x4fv(int i, int i2, boolean z, java.nio.FloatBuffer floatBuffer);

    public static native void glUniformMatrix3x4fv(int i, int i2, boolean z, float[] fArr, int i3);

    public static native void glUniformMatrix4x2fv(int i, int i2, boolean z, java.nio.FloatBuffer floatBuffer);

    public static native void glUniformMatrix4x2fv(int i, int i2, boolean z, float[] fArr, int i3);

    public static native void glUniformMatrix4x3fv(int i, int i2, boolean z, java.nio.FloatBuffer floatBuffer);
    ...
    public static native void glVertexAttribI4iv(int i, java.nio.IntBuffer intBuffer);
    ...
    public static native void glVertexAttribI4uiv(int i, java.nio.IntBuffer intBuffer);
    ...
    private static native void glVertexAttribIPointerBounds(int i, int i2, int i3, int i4, java.nio.Buffer buffer, int i5);
    ...
    public static void glVertexAttribIPointer(int i, int i2, int i3, int i4, java.nio.Buffer buffer) {
