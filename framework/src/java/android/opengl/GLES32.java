...
public class GLES32 extends android.opengl.GLES31 {
    ...
    public interface DebugProc {
        void onMessage(int i, int i2, int i3, int i4, java.lang.String str);
    }
    ...
    public static native void glDebugMessageCallback(android.opengl.GLES32.DebugProc debugProc);

    public static native void glDebugMessageControl(int i, int i2, int i3, int i4, java.nio.IntBuffer intBuffer, boolean z);

    public static native void glDebugMessageControl(int i, int i2, int i3, int i4, int[] iArr, int i5, boolean z);

    public static native void glDebugMessageInsert(int i, int i2, int i3, int i4, int i5, java.lang.String str);

    public static native void glDisablei(int i, int i2);

    public static native void glDrawElementsBaseVertex(int i, int i2, int i3, java.nio.Buffer buffer, int i4);

    public static native void glDrawElementsInstancedBaseVertex(int i, int i2, int i3, int i4, int i5, int i6);

    public static native void glDrawElementsInstancedBaseVertex(int i, int i2, int i3, java.nio.Buffer buffer, int i4, int i5);

    public static native void glDrawRangeElementsBaseVertex(int i, int i2, int i3, int i4, int i5, java.nio.Buffer buffer, int i6);
    ...
    public static native int glGetDebugMessageLog(int i, java.nio.IntBuffer intBuffer, java.nio.IntBuffer intBuffer2, java.nio.IntBuffer intBuffer3, java.nio.IntBuffer intBuffer4, java.nio.IntBuffer intBuffer5, java.nio.ByteBuffer byteBuffer);

    public static native java.lang.String[] glGetDebugMessageLog(int i, java.nio.IntBuffer intBuffer, java.nio.IntBuffer intBuffer2, java.nio.IntBuffer intBuffer3, java.nio.IntBuffer intBuffer4);

    public static native java.lang.String[] glGetDebugMessageLog(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4, int[] iArr4, int i5);

    public static native int glGetGraphicsResetStatus();

    public static native java.lang.String glGetObjectLabel(int i, int i2);

    public static native java.lang.String glGetObjectPtrLabel(long j);

    public static native long glGetPointerv(int i);

    public static native void glGetSamplerParameterIiv(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glGetSamplerParameterIiv(int i, int i2, int[] iArr, int i3);

    public static native void glGetSamplerParameterIuiv(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glGetSamplerParameterIuiv(int i, int i2, int[] iArr, int i3);

    public static native void glGetTexParameterIiv(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glGetTexParameterIiv(int i, int i2, int[] iArr, int i3);

    public static native void glGetTexParameterIuiv(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glGetTexParameterIuiv(int i, int i2, int[] iArr, int i3);

    public static native void glGetnUniformfv(int i, int i2, int i3, java.nio.FloatBuffer floatBuffer);

    public static native void glGetnUniformfv(int i, int i2, int i3, float[] fArr, int i4);

    public static native void glGetnUniformiv(int i, int i2, int i3, java.nio.IntBuffer intBuffer);

    public static native void glGetnUniformiv(int i, int i2, int i3, int[] iArr, int i4);

    public static native void glGetnUniformuiv(int i, int i2, int i3, java.nio.IntBuffer intBuffer);
    ...
    public static native void glObjectLabel(int i, int i2, int i3, java.lang.String str);

    public static native void glObjectPtrLabel(long j, java.lang.String str);
    ...
    public static native void glPushDebugGroup(int i, int i2, int i3, java.lang.String str);

    public static native void glReadnPixels(int i, int i2, int i3, int i4, int i5, int i6, int i7, java.nio.Buffer buffer);

    public static native void glSamplerParameterIiv(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glSamplerParameterIiv(int i, int i2, int[] iArr, int i3);

    public static native void glSamplerParameterIuiv(int i, int i2, java.nio.IntBuffer intBuffer);
    ...
    public static native void glTexParameterIiv(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glTexParameterIiv(int i, int i2, int[] iArr, int i3);

    public static native void glTexParameterIuiv(int i, int i2, java.nio.IntBuffer intBuffer);
