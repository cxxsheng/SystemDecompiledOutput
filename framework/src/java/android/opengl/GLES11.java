...
public class GLES11 extends android.opengl.GLES10 {
    ...
    public static native void glClipPlanef(int i, java.nio.FloatBuffer floatBuffer);

    public static native void glClipPlanef(int i, float[] fArr, int i2);

    public static native void glClipPlanex(int i, java.nio.IntBuffer intBuffer);
    ...
    public static native void glGetClipPlanef(int i, java.nio.FloatBuffer floatBuffer);

    public static native void glGetClipPlanef(int i, float[] fArr, int i2);

    public static native void glGetClipPlanex(int i, java.nio.IntBuffer intBuffer);

    public static native void glGetClipPlanex(int i, int[] iArr, int i2);

    public static native void glGetFixedv(int i, java.nio.IntBuffer intBuffer);
    ...
    public static native void glGetLightfv(int i, int i2, java.nio.FloatBuffer floatBuffer);

    public static native void glGetLightfv(int i, int i2, float[] fArr, int i3);

    public static native void glGetLightxv(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glGetLightxv(int i, int i2, int[] iArr, int i3);

    public static native void glGetMaterialfv(int i, int i2, java.nio.FloatBuffer floatBuffer);

    public static native void glGetMaterialfv(int i, int i2, float[] fArr, int i3);

    public static native void glGetMaterialxv(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glGetMaterialxv(int i, int i2, int[] iArr, int i3);

    public static native void glGetTexEnvfv(int i, int i2, java.nio.FloatBuffer floatBuffer);

    public static native void glGetTexEnvfv(int i, int i2, float[] fArr, int i3);

    public static native void glGetTexEnviv(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glGetTexEnviv(int i, int i2, int[] iArr, int i3);

    public static native void glGetTexEnvxv(int i, int i2, java.nio.IntBuffer intBuffer);
    ...
    public static native void glGetTexParameterxv(int i, int i2, java.nio.IntBuffer intBuffer);
    ...
    public static native void glPointParameterfv(int i, java.nio.FloatBuffer floatBuffer);
    ...
    public static native void glPointParameterxv(int i, java.nio.IntBuffer intBuffer);

    public static native void glPointParameterxv(int i, int[] iArr, int i2);

    private static native void glPointSizePointerOESBounds(int i, int i2, java.nio.Buffer buffer, int i3);
    ...
    public static native void glTexEnviv(int i, int i2, java.nio.IntBuffer intBuffer);
    ...
    public static native void glTexParameterxv(int i, int i2, java.nio.IntBuffer intBuffer);
    ...
    public static void glPointSizePointerOES(int i, int i2, java.nio.Buffer buffer) {
