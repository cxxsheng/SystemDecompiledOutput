...
public class GLES20 {
    ...
    public static native void glBindAttribLocation(int i, int i2, java.lang.String str);
    ...
    public static native void glBufferData(int i, int i2, java.nio.Buffer buffer, int i3);

    public static native void glBufferSubData(int i, int i2, int i3, java.nio.Buffer buffer);
    ...
    public static native void glCompressedTexImage2D(int i, int i2, int i3, int i4, int i5, int i6, int i7, java.nio.Buffer buffer);

    public static native void glCompressedTexSubImage2D(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, java.nio.Buffer buffer);
    ...
    public static native void glDeleteBuffers(int i, java.nio.IntBuffer intBuffer);

    public static native void glDeleteBuffers(int i, int[] iArr, int i2);

    public static native void glDeleteFramebuffers(int i, java.nio.IntBuffer intBuffer);

    public static native void glDeleteFramebuffers(int i, int[] iArr, int i2);

    public static native void glDeleteProgram(int i);

    public static native void glDeleteRenderbuffers(int i, java.nio.IntBuffer intBuffer);

    public static native void glDeleteRenderbuffers(int i, int[] iArr, int i2);

    public static native void glDeleteShader(int i);

    public static native void glDeleteTextures(int i, java.nio.IntBuffer intBuffer);
    ...
    public static native void glDrawElements(int i, int i2, int i3, java.nio.Buffer buffer);
    ...
    public static native void glGenBuffers(int i, java.nio.IntBuffer intBuffer);

    public static native void glGenBuffers(int i, int[] iArr, int i2);

    public static native void glGenFramebuffers(int i, java.nio.IntBuffer intBuffer);

    public static native void glGenFramebuffers(int i, int[] iArr, int i2);

    public static native void glGenRenderbuffers(int i, java.nio.IntBuffer intBuffer);

    public static native void glGenRenderbuffers(int i, int[] iArr, int i2);

    public static native void glGenTextures(int i, java.nio.IntBuffer intBuffer);

    public static native void glGenTextures(int i, int[] iArr, int i2);

    public static native void glGenerateMipmap(int i);

    public static native java.lang.String glGetActiveAttrib(int i, int i2, java.nio.IntBuffer intBuffer, java.nio.IntBuffer intBuffer2);

    public static native java.lang.String glGetActiveAttrib(int i, int i2, int[] iArr, int i3, int[] iArr2, int i4);

    public static native void glGetActiveAttrib(int i, int i2, int i3, java.nio.IntBuffer intBuffer, java.nio.IntBuffer intBuffer2, java.nio.IntBuffer intBuffer3, byte b);
    ...
    public static native java.lang.String glGetActiveUniform(int i, int i2, java.nio.IntBuffer intBuffer, java.nio.IntBuffer intBuffer2);

    public static native java.lang.String glGetActiveUniform(int i, int i2, int[] iArr, int i3, int[] iArr2, int i4);

    public static native void glGetActiveUniform(int i, int i2, int i3, java.nio.IntBuffer intBuffer, java.nio.IntBuffer intBuffer2, java.nio.IntBuffer intBuffer3, byte b);
    ...
    public static native void glGetAttachedShaders(int i, int i2, java.nio.IntBuffer intBuffer, java.nio.IntBuffer intBuffer2);

    public static native void glGetAttachedShaders(int i, int i2, int[] iArr, int i3, int[] iArr2, int i4);

    public static native int glGetAttribLocation(int i, java.lang.String str);

    public static native void glGetBooleanv(int i, java.nio.IntBuffer intBuffer);

    public static native void glGetBooleanv(int i, boolean[] zArr, int i2);

    public static native void glGetBufferParameteriv(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glGetBufferParameteriv(int i, int i2, int[] iArr, int i3);

    public static native int glGetError();

    public static native void glGetFloatv(int i, java.nio.FloatBuffer floatBuffer);

    public static native void glGetFloatv(int i, float[] fArr, int i2);

    public static native void glGetFramebufferAttachmentParameteriv(int i, int i2, int i3, java.nio.IntBuffer intBuffer);

    public static native void glGetFramebufferAttachmentParameteriv(int i, int i2, int i3, int[] iArr, int i4);

    public static native void glGetIntegerv(int i, java.nio.IntBuffer intBuffer);

    public static native void glGetIntegerv(int i, int[] iArr, int i2);

    public static native java.lang.String glGetProgramInfoLog(int i);

    public static native void glGetProgramiv(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glGetProgramiv(int i, int i2, int[] iArr, int i3);

    public static native void glGetRenderbufferParameteriv(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glGetRenderbufferParameteriv(int i, int i2, int[] iArr, int i3);

    public static native java.lang.String glGetShaderInfoLog(int i);

    public static native void glGetShaderPrecisionFormat(int i, int i2, java.nio.IntBuffer intBuffer, java.nio.IntBuffer intBuffer2);

    public static native void glGetShaderPrecisionFormat(int i, int i2, int[] iArr, int i3, int[] iArr2, int i4);

    public static native java.lang.String glGetShaderSource(int i);

    public static native void glGetShaderSource(int i, int i2, java.nio.IntBuffer intBuffer, byte b);

    public static native void glGetShaderSource(int i, int i2, int[] iArr, int i3, byte[] bArr, int i4);

    public static native void glGetShaderiv(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glGetShaderiv(int i, int i2, int[] iArr, int i3);

    public static native java.lang.String glGetString(int i);

    public static native void glGetTexParameterfv(int i, int i2, java.nio.FloatBuffer floatBuffer);

    public static native void glGetTexParameterfv(int i, int i2, float[] fArr, int i3);

    public static native void glGetTexParameteriv(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glGetTexParameteriv(int i, int i2, int[] iArr, int i3);

    public static native int glGetUniformLocation(int i, java.lang.String str);

    public static native void glGetUniformfv(int i, int i2, java.nio.FloatBuffer floatBuffer);

    public static native void glGetUniformfv(int i, int i2, float[] fArr, int i3);

    public static native void glGetUniformiv(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glGetUniformiv(int i, int i2, int[] iArr, int i3);

    public static native void glGetVertexAttribfv(int i, int i2, java.nio.FloatBuffer floatBuffer);

    public static native void glGetVertexAttribfv(int i, int i2, float[] fArr, int i3);

    public static native void glGetVertexAttribiv(int i, int i2, java.nio.IntBuffer intBuffer);
    ...
    public static native void glReadPixels(int i, int i2, int i3, int i4, int i5, int i6, java.nio.Buffer buffer);
    ...
    public static native void glShaderBinary(int i, java.nio.IntBuffer intBuffer, int i2, java.nio.Buffer buffer, int i3);

    public static native void glShaderBinary(int i, int[] iArr, int i2, int i3, java.nio.Buffer buffer, int i4);

    public static native void glShaderSource(int i, java.lang.String str);
    ...
    public static native void glTexImage2D(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, java.nio.Buffer buffer);

    public static native void glTexParameterf(int i, int i2, float f);

    public static native void glTexParameterfv(int i, int i2, java.nio.FloatBuffer floatBuffer);
    ...
    public static native void glTexParameteriv(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glTexParameteriv(int i, int i2, int[] iArr, int i3);

    public static native void glTexSubImage2D(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, java.nio.Buffer buffer);

    public static native void glUniform1f(int i, float f);

    public static native void glUniform1fv(int i, int i2, java.nio.FloatBuffer floatBuffer);

    public static native void glUniform1fv(int i, int i2, float[] fArr, int i3);

    public static native void glUniform1i(int i, int i2);

    public static native void glUniform1iv(int i, int i2, java.nio.IntBuffer intBuffer);
    ...
    public static native void glUniform2fv(int i, int i2, java.nio.FloatBuffer floatBuffer);
    ...
    public static native void glUniform2iv(int i, int i2, java.nio.IntBuffer intBuffer);
    ...
    public static native void glUniform3fv(int i, int i2, java.nio.FloatBuffer floatBuffer);
    ...
    public static native void glUniform3iv(int i, int i2, java.nio.IntBuffer intBuffer);
    ...
    public static native void glUniform4fv(int i, int i2, java.nio.FloatBuffer floatBuffer);
    ...
    public static native void glUniform4iv(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glUniform4iv(int i, int i2, int[] iArr, int i3);

    public static native void glUniformMatrix2fv(int i, int i2, boolean z, java.nio.FloatBuffer floatBuffer);

    public static native void glUniformMatrix2fv(int i, int i2, boolean z, float[] fArr, int i3);

    public static native void glUniformMatrix3fv(int i, int i2, boolean z, java.nio.FloatBuffer floatBuffer);

    public static native void glUniformMatrix3fv(int i, int i2, boolean z, float[] fArr, int i3);

    public static native void glUniformMatrix4fv(int i, int i2, boolean z, java.nio.FloatBuffer floatBuffer);
    ...
    public static native void glVertexAttrib1fv(int i, java.nio.FloatBuffer floatBuffer);
    ...
    public static native void glVertexAttrib2fv(int i, java.nio.FloatBuffer floatBuffer);
    ...
    public static native void glVertexAttrib3fv(int i, java.nio.FloatBuffer floatBuffer);
    ...
    public static native void glVertexAttrib4fv(int i, java.nio.FloatBuffer floatBuffer);
    ...
    private static native void glVertexAttribPointerBounds(int i, int i2, int i3, boolean z, int i4, java.nio.Buffer buffer, int i5);
    ...
    public static void glVertexAttribPointer(int i, int i2, int i3, boolean z, int i4, java.nio.Buffer buffer) {
