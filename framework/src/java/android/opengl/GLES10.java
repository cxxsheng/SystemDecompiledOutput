...
public class GLES10 {
    ...
    private static native void glColorPointerBounds(int i, int i2, int i3, java.nio.Buffer buffer, int i4);
    ...
    public static native void glFogfv(int i, java.nio.FloatBuffer floatBuffer);

    public static native void glFogfv(int i, float[] fArr, int i2);

    public static native void glFogx(int i, int i2);

    public static native void glFogxv(int i, java.nio.IntBuffer intBuffer);
    ...
    public static native void glLoadMatrixf(java.nio.FloatBuffer floatBuffer);

    public static native void glLoadMatrixf(float[] fArr, int i);

    public static native void glLoadMatrixx(java.nio.IntBuffer intBuffer);
    ...
    public static native void glMaterialfv(int i, int i2, java.nio.FloatBuffer floatBuffer);
    ...
    public static native void glMaterialxv(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glMaterialxv(int i, int i2, int[] iArr, int i3);

    public static native void glMatrixMode(int i);

    public static native void glMultMatrixf(java.nio.FloatBuffer floatBuffer);

    public static native void glMultMatrixf(float[] fArr, int i);

    public static native void glMultMatrixx(java.nio.IntBuffer intBuffer);
    ...
    private static native void glNormalPointerBounds(int i, int i2, java.nio.Buffer buffer, int i3);
    ...
    private static native void glTexCoordPointerBounds(int i, int i2, int i3, java.nio.Buffer buffer, int i4);

    public static native void glTexEnvf(int i, int i2, float f);

    public static native void glTexEnvfv(int i, int i2, java.nio.FloatBuffer floatBuffer);
    ...
    public static native void glTexEnvxv(int i, int i2, java.nio.IntBuffer intBuffer);
    ...
    private static native void glVertexPointerBounds(int i, int i2, int i3, java.nio.Buffer buffer, int i4);
    ...
    public static void glColorPointer(int i, int i2, int i3, java.nio.Buffer buffer) {
    ...
    public static void glNormalPointer(int i, int i2, java.nio.Buffer buffer) {
    ...
    public static void glTexCoordPointer(int i, int i2, int i3, java.nio.Buffer buffer) {
    ...
    public static void glVertexPointer(int i, int i2, int i3, java.nio.Buffer buffer) {
