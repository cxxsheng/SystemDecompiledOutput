...
public class GLES11Ext {
    ...
    public static native void glClipPlanefOES(int i, java.nio.FloatBuffer floatBuffer);

    public static native void glClipPlanefOES(int i, float[] fArr, int i2);

    public static native void glClipPlanexOES(int i, java.nio.IntBuffer intBuffer);
    ...
    public static native void glDeleteFramebuffersOES(int i, java.nio.IntBuffer intBuffer);

    public static native void glDeleteFramebuffersOES(int i, int[] iArr, int i2);

    public static native void glDeleteRenderbuffersOES(int i, java.nio.IntBuffer intBuffer);
    ...
    public static native void glDrawTexfvOES(java.nio.FloatBuffer floatBuffer);
    ...
    public static native void glDrawTexivOES(java.nio.IntBuffer intBuffer);
    ...
    public static native void glDrawTexsvOES(java.nio.ShortBuffer shortBuffer);
    ...
    public static native void glDrawTexxvOES(java.nio.IntBuffer intBuffer);

    public static native void glDrawTexxvOES(int[] iArr, int i);

    public static native void glEGLImageTargetRenderbufferStorageOES(int i, java.nio.Buffer buffer);

    public static native void glEGLImageTargetTexture2DOES(int i, java.nio.Buffer buffer);

    public static native void glFogxOES(int i, int i2);

    public static native void glFogxvOES(int i, java.nio.IntBuffer intBuffer);
    ...
    public static native void glGenFramebuffersOES(int i, java.nio.IntBuffer intBuffer);

    public static native void glGenFramebuffersOES(int i, int[] iArr, int i2);

    public static native void glGenRenderbuffersOES(int i, java.nio.IntBuffer intBuffer);

    public static native void glGenRenderbuffersOES(int i, int[] iArr, int i2);

    public static native void glGenerateMipmapOES(int i);

    public static native void glGetClipPlanefOES(int i, java.nio.FloatBuffer floatBuffer);

    public static native void glGetClipPlanefOES(int i, float[] fArr, int i2);

    public static native void glGetClipPlanexOES(int i, java.nio.IntBuffer intBuffer);

    public static native void glGetClipPlanexOES(int i, int[] iArr, int i2);

    public static native void glGetFixedvOES(int i, java.nio.IntBuffer intBuffer);

    public static native void glGetFixedvOES(int i, int[] iArr, int i2);

    public static native void glGetFramebufferAttachmentParameterivOES(int i, int i2, int i3, java.nio.IntBuffer intBuffer);

    public static native void glGetFramebufferAttachmentParameterivOES(int i, int i2, int i3, int[] iArr, int i4);

    public static native void glGetLightxvOES(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glGetLightxvOES(int i, int i2, int[] iArr, int i3);

    public static native void glGetMaterialxvOES(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glGetMaterialxvOES(int i, int i2, int[] iArr, int i3);

    public static native void glGetRenderbufferParameterivOES(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glGetRenderbufferParameterivOES(int i, int i2, int[] iArr, int i3);

    public static native void glGetTexEnvxvOES(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glGetTexEnvxvOES(int i, int i2, int[] iArr, int i3);

    public static native void glGetTexGenfvOES(int i, int i2, java.nio.FloatBuffer floatBuffer);

    public static native void glGetTexGenfvOES(int i, int i2, float[] fArr, int i3);

    public static native void glGetTexGenivOES(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glGetTexGenivOES(int i, int i2, int[] iArr, int i3);

    public static native void glGetTexGenxvOES(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glGetTexGenxvOES(int i, int i2, int[] iArr, int i3);

    public static native void glGetTexParameterxvOES(int i, int i2, java.nio.IntBuffer intBuffer);
    ...
    public static native void glLightModelxvOES(int i, java.nio.IntBuffer intBuffer);
    ...
    public static native void glLightxvOES(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glLightxvOES(int i, int i2, int[] iArr, int i3);

    public static native void glLineWidthxOES(int i);

    public static native void glLoadMatrixxOES(java.nio.IntBuffer intBuffer);
    ...
    public static native void glMaterialxvOES(int i, int i2, java.nio.IntBuffer intBuffer);

    public static native void glMaterialxvOES(int i, int i2, int[] iArr, int i3);

    private static native void glMatrixIndexPointerOESBounds(int i, int i2, int i3, java.nio.Buffer buffer, int i4);

    public static native void glMultMatrixxOES(java.nio.IntBuffer intBuffer);
    ...
    public static native void glPointParameterxvOES(int i, java.nio.IntBuffer intBuffer);
    ...
    public static native void glTexEnvxvOES(int i, int i2, java.nio.IntBuffer intBuffer);
    ...
    public static native void glTexGenfvOES(int i, int i2, java.nio.FloatBuffer floatBuffer);
    ...
    public static native void glTexGenivOES(int i, int i2, java.nio.IntBuffer intBuffer);
    ...
    public static native void glTexGenxvOES(int i, int i2, java.nio.IntBuffer intBuffer);
    ...
    public static native void glTexParameterxvOES(int i, int i2, java.nio.IntBuffer intBuffer);
    ...
    private static native void glWeightPointerOESBounds(int i, int i2, int i3, java.nio.Buffer buffer, int i4);

    static {
        _nativeClassInit();
    }

    public static void glMatrixIndexPointerOES(int i, int i2, int i3, java.nio.Buffer buffer) {
    ...
    public static void glWeightPointerOES(int i, int i2, int i3, java.nio.Buffer buffer) {
