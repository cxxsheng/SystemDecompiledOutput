...
public interface IGetOtaStatusCallback extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements android.service.euicc.IGetOtaStatusCallback {
        ...
        public static android.service.euicc.IGetOtaStatusCallback asInterface(android.os.IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            android.os.IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof android.service.euicc.IGetOtaStatusCallback)) {
                return (android.service.euicc.IGetOtaStatusCallback) queryLocalInterface;
            }
            return new android.service.euicc.IGetOtaStatusCallback.Stub.Proxy(iBinder);
        }
        ...
        private static class Proxy implements android.service.euicc.IGetOtaStatusCallback {
            ...
            public java.lang.String getInterfaceDescriptor() {
                return android.service.euicc.IGetOtaStatusCallback.Stub.DESCRIPTOR;
            }
            ...
            public void onSuccess(int i) throws android.os.RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(android.service.euicc.IGetOtaStatusCallback.Stub.DESCRIPTOR);
                    obtain.writeInt(i);
