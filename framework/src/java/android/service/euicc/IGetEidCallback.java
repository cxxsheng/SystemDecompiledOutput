...
public interface IGetEidCallback extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements android.service.euicc.IGetEidCallback {
        ...
        public static android.service.euicc.IGetEidCallback asInterface(android.os.IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            android.os.IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof android.service.euicc.IGetEidCallback)) {
                return (android.service.euicc.IGetEidCallback) queryLocalInterface;
            }
            return new android.service.euicc.IGetEidCallback.Stub.Proxy(iBinder);
        }
        ...
        private static class Proxy implements android.service.euicc.IGetEidCallback {
            ...
            public java.lang.String getInterfaceDescriptor() {
                return android.service.euicc.IGetEidCallback.Stub.DESCRIPTOR;
            }
            ...
            public void onSuccess(java.lang.String str) throws android.os.RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(android.service.euicc.IGetEidCallback.Stub.DESCRIPTOR);
