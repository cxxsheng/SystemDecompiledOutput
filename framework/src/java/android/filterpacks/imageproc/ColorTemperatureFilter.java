...
public class ColorTemperatureFilter extends android.filterfw.core.Filter {
    private final java.lang.String mColorTemperatureShader;
    ...
    public ColorTemperatureFilter(java.lang.String str) {
        super(str);
        this.mScale = 0.5f;
        this.mTileSize = 640;
        this.mTarget = 0;
    ...
    private void updateParameters() {
        this.mProgram.setHostValue("scale", java.lang.Float.valueOf((this.mScale * 2.0f) - 1.0f));
    }
