...
public class SharpenFilter extends android.filterfw.core.Filter {
    ...
    public SharpenFilter(java.lang.String str) {
        super(str);
        this.mScale = 0.0f;
        this.mTileSize = 640;
        this.mWidth = 0;
    ...
    private void updateFrameSize(int i, int i2) {
        ...
        if (this.mProgram != null) {
            this.mProgram.setHostValue("stepsizeX", java.lang.Float.valueOf(1.0f / this.mWidth));
            this.mProgram.setHostValue("stepsizeY", java.lang.Float.valueOf(1.0f / this.mHeight));
            updateParameters();
        }
    }

    private void updateParameters() {
        this.mProgram.setHostValue("scale", java.lang.Float.valueOf(this.mScale));
    }
