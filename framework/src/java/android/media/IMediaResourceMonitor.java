...
public interface IMediaResourceMonitor extends android.os.IInterface {
    void notifyResourceGranted(int i, int i2) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.media.IMediaResourceMonitor {
        ...
        public static android.media.IMediaResourceMonitor asInterface(android.os.IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            android.os.IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof android.media.IMediaResourceMonitor)) {
                return (android.media.IMediaResourceMonitor) queryLocalInterface;
            }
            return new android.media.IMediaResourceMonitor.Stub.Proxy(iBinder);
        }
        ...
        private static class Proxy implements android.media.IMediaResourceMonitor {
            ...
            public java.lang.String getInterfaceDescriptor() {
                return android.media.IMediaResourceMonitor.Stub.DESCRIPTOR;
            }
            ...
            public void notifyResourceGranted(int i, int i2) throws android.os.RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(android.media.IMediaResourceMonitor.Stub.DESCRIPTOR);
                    obtain.writeInt(i);
                    obtain.writeInt(i2);
