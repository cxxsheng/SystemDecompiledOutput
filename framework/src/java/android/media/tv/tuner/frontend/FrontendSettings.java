...
public abstract class FrontendSettings {
    ...
    public void setSpectralInversion(int i) {
        if (android.media.tv.tuner.TunerVersionChecker.checkHigherOrEqualVersionTo(65537, "setSpectralInversion")) {
    ...
    public void setEndFrequencyLong(long j) {
        if (android.media.tv.tuner.TunerVersionChecker.checkHigherOrEqualVersionTo(65537, "setEndFrequency")) {
            if (j < 1) {
                throw new java.lang.IllegalArgumentException("endFrequency must be greater than 0");
            }
