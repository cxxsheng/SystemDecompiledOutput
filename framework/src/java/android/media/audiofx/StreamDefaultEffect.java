...
public class StreamDefaultEffect extends android.media.audiofx.DefaultEffect {
    ...
    public StreamDefaultEffect(java.util.UUID uuid, java.util.UUID uuid2, int i, int i2) {
        int[] iArr = new int[1];
        int native_setup = native_setup(uuid.toString(), uuid2.toString(), i, i2, android.app.ActivityThread.currentOpPackageName(), iArr);
        if (native_setup != 0) {
            android.util.Log.e(TAG, "Error code " + native_setup + " when initializing StreamDefaultEffect");
            switch (native_setup) {
                case -5:
                    throw new java.lang.UnsupportedOperationException("Effect library not loaded");
                case -4:
                    throw new java.lang.IllegalArgumentException("Stream usage, type uuid, or implementation uuid not supported.");
                default:
