...
public interface ICancellationSignal extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements android.os.ICancellationSignal {
        ...
        public static android.os.ICancellationSignal asInterface(android.os.IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            android.os.IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof android.os.ICancellationSignal)) {
                return (android.os.ICancellationSignal) queryLocalInterface;
            }
            return new android.os.ICancellationSignal.Stub.Proxy(iBinder);
        }
        ...
        private static class Proxy implements android.os.ICancellationSignal {
            ...
            public java.lang.String getInterfaceDescriptor() {
                return android.os.ICancellationSignal.Stub.DESCRIPTOR;
            }
            ...
            public void cancel() throws android.os.RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(android.os.ICancellationSignal.Stub.DESCRIPTOR);
