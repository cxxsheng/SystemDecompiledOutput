...
public class CreateAppDataArgs implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.os.CreateAppDataArgs> CREATOR = new android.os.Parcelable.Creator<android.os.CreateAppDataArgs>() { // from class: android.os.CreateAppDataArgs.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.os.CreateAppDataArgs createFromParcel(android.os.Parcel parcel) {
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.os.CreateAppDataArgs[] newArray(int i) {
            return new android.os.CreateAppDataArgs[i];
        }
    };
