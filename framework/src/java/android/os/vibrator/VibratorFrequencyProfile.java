...
public final class VibratorFrequencyProfile {
    ...
    public VibratorFrequencyProfile(android.os.VibratorInfo.FrequencyProfile frequencyProfile) {
        com.android.internal.util.Preconditions.checkArgument(!frequencyProfile.isEmpty(), "Frequency profile must have a non-empty frequency range");
