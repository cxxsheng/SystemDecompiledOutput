...
public interface IPredictionCallback extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements android.app.prediction.IPredictionCallback {
        ...
        public Stub() {
            attachInterface(this, android.app.prediction.IPredictionCallback.DESCRIPTOR);
        }

        public static android.app.prediction.IPredictionCallback asInterface(android.os.IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            android.os.IInterface queryLocalInterface = iBinder.queryLocalInterface(android.app.prediction.IPredictionCallback.DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof android.app.prediction.IPredictionCallback)) {
                return (android.app.prediction.IPredictionCallback) queryLocalInterface;
            }
            return new android.app.prediction.IPredictionCallback.Stub.Proxy(iBinder);
        }
        ...
        public boolean onTransact(int i, android.os.Parcel parcel, android.os.Parcel parcel2, int i2) throws android.os.RemoteException {
            if (i >= 1 && i <= 16777215) {
                parcel.enforceInterface(android.app.prediction.IPredictionCallback.DESCRIPTOR);
            }
            if (i == 1598968902) {
                parcel2.writeString(android.app.prediction.IPredictionCallback.DESCRIPTOR);
                return true;
            }
            switch (i) {
                case 1:
        ...
        private static class Proxy implements android.app.prediction.IPredictionCallback {
            ...
            public java.lang.String getInterfaceDescriptor() {
                return android.app.prediction.IPredictionCallback.DESCRIPTOR;
            }
            ...
            public void onResult(android.content.pm.ParceledListSlice parceledListSlice) throws android.os.RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(android.app.prediction.IPredictionCallback.DESCRIPTOR);
