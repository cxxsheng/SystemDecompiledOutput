...
public interface ITransientNotification extends android.os.IInterface {
    ...
    void show(android.os.IBinder iBinder) throws android.os.RemoteException;

    public static class Default implements android.app.ITransientNotification {
        @Override // android.app.ITransientNotification
        public void show(android.os.IBinder iBinder) throws android.os.RemoteException {
        }
    ...
    public static abstract class Stub extends android.os.Binder implements android.app.ITransientNotification {
        ...
        public static android.app.ITransientNotification asInterface(android.os.IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            android.os.IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof android.app.ITransientNotification)) {
                return (android.app.ITransientNotification) queryLocalInterface;
            }
            return new android.app.ITransientNotification.Stub.Proxy(iBinder);
        }
        ...
        private static class Proxy implements android.app.ITransientNotification {
            ...
            public java.lang.String getInterfaceDescriptor() {
                return android.app.ITransientNotification.Stub.DESCRIPTOR;
            }
            ...
            public void show(android.os.IBinder iBinder) throws android.os.RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(android.app.ITransientNotification.Stub.DESCRIPTOR);
