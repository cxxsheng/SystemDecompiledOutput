...
public interface IBackupManagerMonitor extends android.os.IInterface {
    void onEvent(android.os.Bundle bundle) throws android.os.RemoteException;
    ...
    public static abstract class Stub extends android.os.Binder implements android.app.backup.IBackupManagerMonitor {
        ...
        public static android.app.backup.IBackupManagerMonitor asInterface(android.os.IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            android.os.IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof android.app.backup.IBackupManagerMonitor)) {
                return (android.app.backup.IBackupManagerMonitor) queryLocalInterface;
            }
            return new android.app.backup.IBackupManagerMonitor.Stub.Proxy(iBinder);
        }
        ...
        private static class Proxy implements android.app.backup.IBackupManagerMonitor {
            ...
            public java.lang.String getInterfaceDescriptor() {
                return android.app.backup.IBackupManagerMonitor.Stub.DESCRIPTOR;
            }
            ...
            public void onEvent(android.os.Bundle bundle) throws android.os.RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(android.app.backup.IBackupManagerMonitor.Stub.DESCRIPTOR);
