...
public interface ISelectBackupTransportCallback extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements android.app.backup.ISelectBackupTransportCallback {
        ...
        public static android.app.backup.ISelectBackupTransportCallback asInterface(android.os.IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            android.os.IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof android.app.backup.ISelectBackupTransportCallback)) {
                return (android.app.backup.ISelectBackupTransportCallback) queryLocalInterface;
            }
            return new android.app.backup.ISelectBackupTransportCallback.Stub.Proxy(iBinder);
        }
        ...
        private static class Proxy implements android.app.backup.ISelectBackupTransportCallback {
            ...
            public java.lang.String getInterfaceDescriptor() {
                return android.app.backup.ISelectBackupTransportCallback.Stub.DESCRIPTOR;
            }
            ...
            public void onSuccess(java.lang.String str) throws android.os.RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(android.app.backup.ISelectBackupTransportCallback.Stub.DESCRIPTOR);
