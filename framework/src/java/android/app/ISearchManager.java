...
public interface ISearchManager extends android.os.IInterface {
    java.util.List<android.content.pm.ResolveInfo> getGlobalSearchActivities() throws android.os.RemoteException;

    android.content.ComponentName getGlobalSearchActivity() throws android.os.RemoteException;

    android.app.SearchableInfo getSearchableInfo(android.content.ComponentName componentName) throws android.os.RemoteException;

    java.util.List<android.app.SearchableInfo> getSearchablesInGlobalSearch() throws android.os.RemoteException;

    android.content.ComponentName getWebSearchActivity() throws android.os.RemoteException;

    void launchAssist(int i, android.os.Bundle bundle) throws android.os.RemoteException;

    public static class Default implements android.app.ISearchManager {
        @Override // android.app.ISearchManager
        public android.app.SearchableInfo getSearchableInfo(android.content.ComponentName componentName) throws android.os.RemoteException {
            return null;
        }
        ...
        @Override // android.app.ISearchManager
        public void launchAssist(int i, android.os.Bundle bundle) throws android.os.RemoteException {
        }
    ...
    public static abstract class Stub extends android.os.Binder implements android.app.ISearchManager {
        ...
        public static android.app.ISearchManager asInterface(android.os.IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            android.os.IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof android.app.ISearchManager)) {
                return (android.app.ISearchManager) queryLocalInterface;
            }
            return new android.app.ISearchManager.Stub.Proxy(iBinder);
        }
        ...
        public boolean onTransact(int i, android.os.Parcel parcel, android.os.Parcel parcel2, int i2) throws android.os.RemoteException {
            ...
            switch (i) {
                case 1:
                    ...
                    android.app.SearchableInfo searchableInfo = getSearchableInfo(componentName);
                    parcel2.writeNoException();
                    parcel2.writeTypedObject(searchableInfo, 1);
                    return true;
                case 2:
                    java.util.List<android.app.SearchableInfo> searchablesInGlobalSearch = getSearchablesInGlobalSearch();
                    parcel2.writeNoException();
                    parcel2.writeTypedList(searchablesInGlobalSearch, 1);
                    return true;
                case 3:
                    java.util.List<android.content.pm.ResolveInfo> globalSearchActivities = getGlobalSearchActivities();
                    parcel2.writeNoException();
                ...
                case 4:
                    ...
                    return true;
                case 5:
                    android.content.ComponentName webSearchActivity = getWebSearchActivity();
                    parcel2.writeNoException();
        ...
        private static class Proxy implements android.app.ISearchManager {
            ...
            public java.lang.String getInterfaceDescriptor() {
                return android.app.ISearchManager.Stub.DESCRIPTOR;
            }
            ...
            public android.app.SearchableInfo getSearchableInfo(android.content.ComponentName componentName) throws android.os.RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(android.app.ISearchManager.Stub.DESCRIPTOR);
                    obtain.writeTypedObject(componentName, 0);
                    this.mRemote.transact(1, obtain, obtain2, 0);
                    obtain2.readException();
                    return (android.app.SearchableInfo) obtain2.readTypedObject(android.app.SearchableInfo.CREATOR);
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
            ...
            public java.util.List<android.app.SearchableInfo> getSearchablesInGlobalSearch() throws android.os.RemoteException {
                ...
                try {
                    ...
                    obtain2.readException();
                    return obtain2.createTypedArrayList(android.app.SearchableInfo.CREATOR);
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
            ...
            public java.util.List<android.content.pm.ResolveInfo> getGlobalSearchActivities() throws android.os.RemoteException {
                ...
                try {
                    ...
                    obtain2.readException();
                    return obtain2.createTypedArrayList(android.content.pm.ResolveInfo.CREATOR);
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
