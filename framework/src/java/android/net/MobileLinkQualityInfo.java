...
public class MobileLinkQualityInfo extends android.net.LinkQualityInfo {
    ...
    public static android.net.MobileLinkQualityInfo createFromParcelBody(android.os.Parcel parcel) {
        android.net.MobileLinkQualityInfo mobileLinkQualityInfo = new android.net.MobileLinkQualityInfo();
