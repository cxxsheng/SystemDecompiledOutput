...
public abstract class TimedEvent<T> {
    ...
    public static <T> java.util.Map<T, java.lang.Double> averageTimings(java.util.Collection<? extends android.telecom.Logging.TimedEvent<T>> collection) {
        java.util.HashMap hashMap = new java.util.HashMap();
        java.util.HashMap hashMap2 = new java.util.HashMap();
        for (android.telecom.Logging.TimedEvent<T> timedEvent : collection) {
