...
public interface IPackageDeleteObserver2 extends android.os.IInterface {
    void onPackageDeleted(java.lang.String str, int i, java.lang.String str2) throws android.os.RemoteException;
    ...
    public static class Default implements android.content.pm.IPackageDeleteObserver2 {
        ...
        @Override // android.content.pm.IPackageDeleteObserver2
        public void onPackageDeleted(java.lang.String str, int i, java.lang.String str2) throws android.os.RemoteException {
        }
    ...
    public static abstract class Stub extends android.os.Binder implements android.content.pm.IPackageDeleteObserver2 {
        ...
        public static android.content.pm.IPackageDeleteObserver2 asInterface(android.os.IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            android.os.IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof android.content.pm.IPackageDeleteObserver2)) {
                return (android.content.pm.IPackageDeleteObserver2) queryLocalInterface;
            }
            return new android.content.pm.IPackageDeleteObserver2.Stub.Proxy(iBinder);
        }
        ...
        private static class Proxy implements android.content.pm.IPackageDeleteObserver2 {
            ...
            public java.lang.String getInterfaceDescriptor() {
                return android.content.pm.IPackageDeleteObserver2.Stub.DESCRIPTOR;
            }
            ...
            public void onUserActionRequired(android.content.Intent intent) throws android.os.RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(android.content.pm.IPackageDeleteObserver2.Stub.DESCRIPTOR);
