...
class AndroidKeyStoreBCWorkaroundProvider extends java.security.Provider {
    ...
    AndroidKeyStoreBCWorkaroundProvider() {
        ...
        putMacImpl(android.security.keystore.KeyProperties.KEY_ALGORITHM_HMAC_SHA1, "android.security.keystore2.AndroidKeyStoreHmacSpi$HmacSHA1");
        put("Alg.Alias.Mac.1.2.840.113549.2.7", android.security.keystore.KeyProperties.KEY_ALGORITHM_HMAC_SHA1);
        put("Alg.Alias.Mac.HMAC-SHA1", android.security.keystore.KeyProperties.KEY_ALGORITHM_HMAC_SHA1);
        put("Alg.Alias.Mac.HMAC/SHA1", android.security.keystore.KeyProperties.KEY_ALGORITHM_HMAC_SHA1);
        putMacImpl(android.security.keystore.KeyProperties.KEY_ALGORITHM_HMAC_SHA224, "android.security.keystore2.AndroidKeyStoreHmacSpi$HmacSHA224");
        put("Alg.Alias.Mac.1.2.840.113549.2.9", android.security.keystore.KeyProperties.KEY_ALGORITHM_HMAC_SHA224);
        put("Alg.Alias.Mac.HMAC-SHA224", android.security.keystore.KeyProperties.KEY_ALGORITHM_HMAC_SHA224);
        put("Alg.Alias.Mac.HMAC/SHA224", android.security.keystore.KeyProperties.KEY_ALGORITHM_HMAC_SHA224);
        putMacImpl(android.security.keystore.KeyProperties.KEY_ALGORITHM_HMAC_SHA256, "android.security.keystore2.AndroidKeyStoreHmacSpi$HmacSHA256");
        put("Alg.Alias.Mac.1.2.840.113549.2.9", android.security.keystore.KeyProperties.KEY_ALGORITHM_HMAC_SHA256);
        put("Alg.Alias.Mac.HMAC-SHA256", android.security.keystore.KeyProperties.KEY_ALGORITHM_HMAC_SHA256);
        put("Alg.Alias.Mac.HMAC/SHA256", android.security.keystore.KeyProperties.KEY_ALGORITHM_HMAC_SHA256);
        putMacImpl(android.security.keystore.KeyProperties.KEY_ALGORITHM_HMAC_SHA384, "android.security.keystore2.AndroidKeyStoreHmacSpi$HmacSHA384");
        put("Alg.Alias.Mac.1.2.840.113549.2.10", android.security.keystore.KeyProperties.KEY_ALGORITHM_HMAC_SHA384);
        put("Alg.Alias.Mac.HMAC-SHA384", android.security.keystore.KeyProperties.KEY_ALGORITHM_HMAC_SHA384);
        put("Alg.Alias.Mac.HMAC/SHA384", android.security.keystore.KeyProperties.KEY_ALGORITHM_HMAC_SHA384);
        putMacImpl(android.security.keystore.KeyProperties.KEY_ALGORITHM_HMAC_SHA512, "android.security.keystore2.AndroidKeyStoreHmacSpi$HmacSHA512");
        put("Alg.Alias.Mac.1.2.840.113549.2.11", android.security.keystore.KeyProperties.KEY_ALGORITHM_HMAC_SHA512);
        put("Alg.Alias.Mac.HMAC-SHA512", android.security.keystore.KeyProperties.KEY_ALGORITHM_HMAC_SHA512);
        put("Alg.Alias.Mac.HMAC/SHA512", android.security.keystore.KeyProperties.KEY_ALGORITHM_HMAC_SHA512);
    ...
    private void putMacImpl(java.lang.String str, java.lang.String str2) {
        put("Mac." + str, str2);
        put("Mac." + str + " SupportedKeyClasses", KEYSTORE_SECRET_KEY_CLASS_NAME);
    }

    private void putSymmetricCipherImpl(java.lang.String str, java.lang.String str2) {
        put("Cipher." + str, str2);
        put("Cipher." + str + " SupportedKeyClasses", KEYSTORE_SECRET_KEY_CLASS_NAME);
    }

    private void putAsymmetricCipherImpl(java.lang.String str, java.lang.String str2) {
        put("Cipher." + str, str2);
        put("Cipher." + str + " SupportedKeyClasses", KEYSTORE_PRIVATE_KEY_CLASS_NAME);
    }

    private void putSignatureImpl(java.lang.String str, java.lang.String str2) {
    ...
    public static java.lang.String[] getSupportedEcdsaSignatureDigests() {
        return new java.lang.String[]{android.security.keystore.KeyProperties.DIGEST_NONE, "SHA-1", android.security.keystore.KeyProperties.DIGEST_SHA224, "SHA-256", android.security.keystore.KeyProperties.DIGEST_SHA384, android.security.keystore.KeyProperties.DIGEST_SHA512};
    }

    public static java.lang.String[] getSupportedRsaSignatureWithPkcs1PaddingDigests() {
        return new java.lang.String[]{android.security.keystore.KeyProperties.DIGEST_NONE, android.security.keystore.KeyProperties.DIGEST_MD5, "SHA-1", android.security.keystore.KeyProperties.DIGEST_SHA224, "SHA-256", android.security.keystore.KeyProperties.DIGEST_SHA384, android.security.keystore.KeyProperties.DIGEST_SHA512};
    }
}
