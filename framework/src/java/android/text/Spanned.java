...
public interface Spanned extends java.lang.CharSequence {
    ...
    int getSpanEnd(java.lang.Object obj);

    int getSpanFlags(java.lang.Object obj);

    int getSpanStart(java.lang.Object obj);

    <T> T[] getSpans(int i, int i2, java.lang.Class<T> cls);

    int nextSpanTransition(int i, int i2, java.lang.Class cls);
}
