...
public class PackedIntVector {
    ...
    public void insertAt(int i, int[] iArr) {
        if (i < 0 || i > size()) {
            throw new java.lang.IndexOutOfBoundsException("row " + i);
        }
        if (iArr != null && iArr.length < width()) {
            throw new java.lang.IndexOutOfBoundsException("value count " + iArr.length);
        }
        moveRowGapTo(i);
    ...
    private final void growBuffer() {
        int i = this.mColumns;
        int[] newUnpaddedIntArray = com.android.internal.util.ArrayUtils.newUnpaddedIntArray(com.android.internal.util.GrowingArrayUtils.growSize(size()) * i);
        int length = newUnpaddedIntArray.length / i;
        int[] iArr = this.mValueGap;
        int i2 = this.mRowGapStart;
        int i3 = this.mRows - (this.mRowGapLength + i2);
        if (this.mValues != null) {
            java.lang.System.arraycopy(this.mValues, 0, newUnpaddedIntArray, 0, i * i2);
            java.lang.System.arraycopy(this.mValues, (this.mRows - i3) * i, newUnpaddedIntArray, (length - i3) * i, i3 * i);
        }
