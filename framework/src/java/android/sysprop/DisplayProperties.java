...
public final class DisplayProperties {
    ...
    public static java.util.Optional<java.lang.Boolean> debug_force_msaa() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get("debug.egl.force_msaa")));
    }

    public static void debug_force_msaa(java.lang.Boolean bool) {
        android.os.SystemProperties.set("debug.egl.force_msaa", bool == null ? "" : bool.toString());
    }

    public static java.util.Optional<java.lang.String> debug_opengl_trace() {
        return java.util.Optional.ofNullable(tryParseString(android.os.SystemProperties.get("debug.egl.trace")));
    }

    public static void debug_opengl_trace(java.lang.String str) {
        android.os.SystemProperties.set("debug.egl.trace", str == null ? "" : str.toString());
    }

    public static java.util.Optional<java.lang.Boolean> debug_force_rtl() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get(android.provider.Settings.Global.DEVELOPMENT_FORCE_RTL)));
    }

    public static void debug_force_rtl(java.lang.Boolean bool) {
        android.os.SystemProperties.set(android.provider.Settings.Global.DEVELOPMENT_FORCE_RTL, bool == null ? "" : bool.toString());
    }

    public static java.util.Optional<java.lang.Boolean> debug_layout() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get("debug.layout")));
    }

    public static void debug_layout(java.lang.Boolean bool) {
        android.os.SystemProperties.set("debug.layout", bool == null ? "" : bool.toString());
    }

    public static java.util.Optional<java.lang.String> debug_vri_package() {
        return java.util.Optional.ofNullable(tryParseString(android.os.SystemProperties.get("persist.debug.vri_package")));
    }

    public static void debug_vri_package(java.lang.String str) {
        android.os.SystemProperties.set("persist.debug.vri_package", str == null ? "" : str.toString());
    }
}
