...
public final class DeviceProperties {
    ...
    public static java.util.Optional<java.lang.Integer> media_performance_class() {
        return java.util.Optional.ofNullable(tryParseInteger(android.os.SystemProperties.get("ro.odm.build.media_performance_class")));
    }
}
