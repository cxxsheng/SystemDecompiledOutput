...
public final class InputProperties {
    ...
    public static java.util.Optional<java.lang.Boolean> simulate_stylus_with_touch() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get("debug.input.simulate_stylus_with_touch")));
    }

    public static java.util.Optional<java.lang.Boolean> enable_touchpad_gestures_library() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get("persist.input.touchpad.gestures_library.enabled")));
    }

    public static java.util.Optional<java.lang.Boolean> enable_motion_prediction() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get("persist.input.enable_motion_prediction")));
    }

    public static java.util.Optional<java.lang.Boolean> enable_keyboard_backlight_control() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get("persist.input.keyboard.backlight_control.enabled")));
    }

    public static java.util.Optional<java.lang.Boolean> force_enable_stylus_pointer_icon() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get("persist.debug.input.force_enable_stylus_pointer_icon")));
    }

    public static java.util.Optional<java.lang.Boolean> enable_keyboard_backlight_animation() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get("persist.input.keyboard.backlight_animation.enabled")));
    }

    public static java.util.Optional<java.lang.Boolean> enable_input_device_usage_metrics() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get("persist.debug.input.enable_input_device_usage_metrics")));
    }

    public static java.util.Optional<java.lang.Boolean> enable_keyboard_backlight_custom_levels() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get("persist.input.keyboard.backlight_custom_levels.enabled")));
    }

    public static java.util.Optional<java.lang.Boolean> enable_ambient_keyboard_backlight_control() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get("persist.input.keyboard.ambient_backlight_control.enabled")));
    }
}
