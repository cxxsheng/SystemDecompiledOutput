...
public final class HypervisorProperties {
    ...
    public static java.util.Optional<java.lang.String> hypervisor_version() {
        return java.util.Optional.ofNullable(tryParseString(android.os.SystemProperties.get("ro.boot.hypervisor.version")));
    }

    public static java.util.Optional<java.lang.Boolean> hypervisor_vm_supported() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get("ro.boot.hypervisor.vm.supported")));
    }

    public static java.util.Optional<java.lang.Boolean> hypervisor_protected_vm_supported() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get("ro.boot.hypervisor.protected_vm.supported")));
    }
}
