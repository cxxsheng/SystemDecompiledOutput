...
public final class OtaProperties {
    ...
    public static java.util.Optional<java.lang.Boolean> warm_reset() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get("ota.warm_reset")));
    }

    public static void warm_reset(java.lang.Boolean bool) {
        android.os.SystemProperties.set("ota.warm_reset", bool == null ? "" : bool.booleanValue() ? "1" : android.media.AudioSystem.LEGACY_REMOTE_SUBMIX_ADDRESS);
    }

    public static java.util.Optional<java.lang.String> ab_ota_partitions() {
        return java.util.Optional.ofNullable(tryParseString(android.os.SystemProperties.get("ro.product.ab_ota_partitions")));
    }

    public static java.util.Optional<java.lang.Boolean> virtual_ab_enabled() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get("ro.virtual_ab.enabled")));
    }

    public static java.util.Optional<java.lang.Boolean> virtual_ab_retrofit() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get("ro.virtual_ab.retrofit")));
    }

    public static java.util.Optional<java.lang.String> other_vbmeta_digest() {
        return java.util.Optional.ofNullable(tryParseString(android.os.SystemProperties.get("ota.other.vbmeta_digest")));
    }

    public static void other_vbmeta_digest(java.lang.String str) {
        android.os.SystemProperties.set("ota.other.vbmeta_digest", str == null ? "" : str.toString());
    }
}
