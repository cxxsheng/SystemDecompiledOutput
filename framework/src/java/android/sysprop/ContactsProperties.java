...
public final class ContactsProperties {
    ...
    public static java.util.Optional<java.lang.Boolean> aggregate_contacts() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get("sync.contacts.aggregate")));
    }

    public static java.util.Optional<java.lang.Boolean> debug_scan_all_packages() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get("debug.cp2.scan_all_packages")));
    }

    public static java.util.Optional<java.lang.Integer> display_photo_size() {
        return java.util.Optional.ofNullable(tryParseInteger(android.os.SystemProperties.get("contacts.display_photo_size")));
    }

    public static java.util.Optional<java.lang.Boolean> keep_stale_account_data() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get("debug.contacts.ksad")));
    }

    public static java.util.Optional<java.lang.Integer> thumbnail_size() {
        return java.util.Optional.ofNullable(tryParseInteger(android.os.SystemProperties.get("contacts.thumbnail_size")));
    }
}
