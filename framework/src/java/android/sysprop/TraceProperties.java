...
public final class TraceProperties {
    ...
    public static java.util.Optional<java.lang.Boolean> user_initiated() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get("debug.atrace.user_initiated")));
    }

    public static void user_initiated(java.lang.Boolean bool) {
        android.os.SystemProperties.set("debug.atrace.user_initiated", bool == null ? "" : bool.booleanValue() ? "1" : android.media.AudioSystem.LEGACY_REMOTE_SUBMIX_ADDRESS);
    }
}
