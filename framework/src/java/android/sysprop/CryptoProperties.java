...
public final class CryptoProperties {
    ...
    public enum type_values {
        ...
        type_values(java.lang.String str) {
            this.propValue = str;
        }
    ...
    public static java.util.Optional<android.sysprop.CryptoProperties.type_values> type() {
        return java.util.Optional.ofNullable((android.sysprop.CryptoProperties.type_values) tryParseEnum(android.sysprop.CryptoProperties.type_values.class, android.os.SystemProperties.get("ro.crypto.type")));
    }

    public static void type(android.sysprop.CryptoProperties.type_values type_valuesVar) {
        android.os.SystemProperties.set("ro.crypto.type", type_valuesVar == null ? "" : type_valuesVar.getPropValue());
    }
    ...
    public enum state_values {
        ...
        state_values(java.lang.String str) {
            this.propValue = str;
        }
    ...
    public static java.util.Optional<android.sysprop.CryptoProperties.state_values> state() {
        return java.util.Optional.ofNullable((android.sysprop.CryptoProperties.state_values) tryParseEnum(android.sysprop.CryptoProperties.state_values.class, android.os.SystemProperties.get("ro.crypto.state")));
    }
}
