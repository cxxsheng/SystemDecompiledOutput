...
public final class NetworkProperties {
    ...
    public static java.util.Optional<java.lang.Integer> tcp_init_rwnd() {
        return java.util.Optional.ofNullable(tryParseInteger(android.os.SystemProperties.get("net.tcp_def_init_rwnd")));
    }

    public static void tcp_init_rwnd(java.lang.Integer num) {
        android.os.SystemProperties.set("net.tcp_def_init_rwnd", num == null ? "" : num.toString());
    }

    public static java.util.Optional<java.lang.Boolean> isCellular464XlatEnabled() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get("net.464xlat.cellular.enabled")));
    }
}
