...
public final class ApkVerityProperties {
    ...
    public static java.util.Optional<java.lang.Integer> apk_verity_mode() {
        return java.util.Optional.ofNullable(tryParseInteger(android.os.SystemProperties.get("ro.apk_verity.mode")));
    }

    public static void apk_verity_mode(java.lang.Integer num) {
        android.os.SystemProperties.set("ro.apk_verity.mode", num == null ? "" : num.toString());
    }
}
