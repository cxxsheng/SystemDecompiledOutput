...
public final class InitProperties {
    ...
    public static java.util.Optional<java.lang.Boolean> userspace_reboot_in_progress() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get("sys.init.userspace_reboot.in_progress")));
    }

    public static void userspace_reboot_in_progress(java.lang.Boolean bool) {
        android.os.SystemProperties.set("sys.init.userspace_reboot.in_progress", bool == null ? "" : bool.booleanValue() ? "1" : android.media.AudioSystem.LEGACY_REMOTE_SUBMIX_ADDRESS);
    }

    public static java.util.Optional<java.lang.Boolean> is_userspace_reboot_supported() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get("init.userspace_reboot.is_supported")));
    }
}
