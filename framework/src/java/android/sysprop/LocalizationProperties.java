...
public final class LocalizationProperties {
    ...
    public static java.util.Optional<java.lang.String> locale_filter() {
        return java.util.Optional.ofNullable(tryParseString(android.os.SystemProperties.get("ro.localization.locale_filter")));
    }
}
