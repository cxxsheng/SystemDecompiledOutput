...
public final class MemoryProperties {
    ...
    public static java.util.Optional<java.lang.String> memory_ddr_size() {
        return java.util.Optional.ofNullable(tryParseString(android.os.SystemProperties.get("ro.boot.ddr_size")));
    }
}
