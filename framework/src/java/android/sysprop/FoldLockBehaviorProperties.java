...
public final class FoldLockBehaviorProperties {
    ...
    public static java.util.Optional<java.lang.Boolean> fold_lock_setting_enabled() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get("persist.fold_lock_setting_enabled")));
    }

    public static java.util.Optional<java.lang.Boolean> fold_grace_period_enabled() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get("persist.fold_grace_period_enabled")));
    }
}
