...
public final class NfcProperties {
    ...
    public static java.util.Optional<java.lang.Boolean> debug_enabled() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get("persist.nfc.debug_enabled")));
    }

    public static void debug_enabled(java.lang.Boolean bool) {
        android.os.SystemProperties.set("persist.nfc.debug_enabled", bool == null ? "" : bool.toString());
    }
    ...
    public static java.util.Optional<android.sysprop.NfcProperties.snoop_log_mode_values> snoop_log_mode() {
        return java.util.Optional.ofNullable((android.sysprop.NfcProperties.snoop_log_mode_values) tryParseEnum(android.sysprop.NfcProperties.snoop_log_mode_values.class, android.os.SystemProperties.get("persist.nfc.snoop_log_mode")));
    }

    public static void snoop_log_mode(android.sysprop.NfcProperties.snoop_log_mode_values snoop_log_mode_valuesVar) {
        android.os.SystemProperties.set("persist.nfc.snoop_log_mode", snoop_log_mode_valuesVar == null ? "" : snoop_log_mode_valuesVar.getPropValue());
    }

    public static java.util.Optional<java.lang.Boolean> vendor_debug_enabled() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get("persist.nfc.vendor_debug_enabled")));
    }

    public static void vendor_debug_enabled(java.lang.Boolean bool) {
        android.os.SystemProperties.set("persist.nfc.vendor_debug_enabled", bool == null ? "" : bool.toString());
    }

    public static java.util.Optional<java.lang.Boolean> skipNdefRead() {
        java.lang.String str = android.os.SystemProperties.get("nfc.dta.skip_ndef_read");
        if ("".equals(str)) {
            android.util.Log.v("NfcProperties", "prop nfc.dta.skip_ndef_read doesn't exist; fallback to legacy prop nfc.dta.skipNdefRead");
            str = android.os.SystemProperties.get("nfc.dta.skipNdefRead");
        }
        return java.util.Optional.ofNullable(tryParseBoolean(str));
    }

    public static java.util.Optional<java.lang.Boolean> initialized() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get("nfc.initialized")));
    }

    public static void initialized(java.lang.Boolean bool) {
        android.os.SystemProperties.set("nfc.initialized", bool == null ? "" : bool.toString());
    }
}
