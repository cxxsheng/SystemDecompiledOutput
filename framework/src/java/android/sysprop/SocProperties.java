...
public final class SocProperties {
    ...
    public static java.util.Optional<java.lang.String> soc_manufacturer() {
        return java.util.Optional.ofNullable(tryParseString(android.os.SystemProperties.get("ro.soc.manufacturer")));
    }

    public static java.util.Optional<java.lang.String> soc_model() {
        return java.util.Optional.ofNullable(tryParseString(android.os.SystemProperties.get("ro.soc.model")));
    }
}
