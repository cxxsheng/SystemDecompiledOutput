...
public final class VndkProperties {
    ...
    public static java.util.Optional<java.lang.String> vendor_vndk_version() {
        return java.util.Optional.ofNullable(tryParseString(android.os.SystemProperties.get("ro.vndk.version")));
    }

    public static java.util.Optional<java.lang.String> product_vndk_version() {
        return java.util.Optional.ofNullable(tryParseString(android.os.SystemProperties.get("ro.product.vndk.version")));
    }
}
