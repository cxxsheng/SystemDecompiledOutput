...
public final class WifiProperties {
    ...
    public static java.util.Optional<java.lang.Boolean> start_supplicant() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get("ctl.start$supplicant")));
    }

    public static void start_supplicant(java.lang.Boolean bool) {
        android.os.SystemProperties.set("ctl.start$supplicant", bool == null ? "" : bool.toString());
    }

    public static java.util.Optional<java.lang.Boolean> stop_supplicant() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get("ctl.stop$supplicant")));
    }

    public static void stop_supplicant(java.lang.Boolean bool) {
        android.os.SystemProperties.set("ctl.stop$supplicant", bool == null ? "" : bool.toString());
    }
}
