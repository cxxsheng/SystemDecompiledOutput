...
public final class MediaProperties {
    ...
    public static java.util.Optional<java.lang.Integer> swcodec_ion_heapmask() {
        return java.util.Optional.ofNullable(tryParseInteger(android.os.SystemProperties.get("ro.com.android.media.swcodec.ion.heapmask")));
    }

    public static java.util.Optional<java.lang.Integer> swcodec_ion_align() {
        return java.util.Optional.ofNullable(tryParseInteger(android.os.SystemProperties.get("ro.com.android.media.swcodec.ion.align")));
    }

    public static java.util.Optional<java.lang.Integer> swcodec_ion_flags() {
        return java.util.Optional.ofNullable(tryParseInteger(android.os.SystemProperties.get("ro.com.android.media.swcodec.ion.flags")));
    }

    public static java.util.Optional<java.lang.Integer> codec2_dmabuf_padding() {
        return java.util.Optional.ofNullable(tryParseInteger(android.os.SystemProperties.get("media.c2.dmabuf.padding")));
    }

    public static java.util.Optional<java.lang.Integer> resolution_limit_32bit() {
        return java.util.Optional.ofNullable(tryParseInteger(android.os.SystemProperties.get("media.resolution.limit.32bit")));
    }
    ...
    public enum codec2_hal_selection_values {
        ...
        codec2_hal_selection_values(java.lang.String str) {
            this.propValue = str;
        }
    ...
    public static java.util.Optional<android.sysprop.MediaProperties.codec2_hal_selection_values> codec2_hal_selection() {
        return java.util.Optional.ofNullable((android.sysprop.MediaProperties.codec2_hal_selection_values) tryParseEnum(android.sysprop.MediaProperties.codec2_hal_selection_values.class, android.os.SystemProperties.get("media.c2.hal.selection")));
    }
}
