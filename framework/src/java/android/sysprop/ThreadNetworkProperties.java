...
public final class ThreadNetworkProperties {
    ...
    public static java.util.Optional<java.lang.String> country_code() {
        return java.util.Optional.ofNullable(tryParseString(android.os.SystemProperties.get("threadnetwork.country_code")));
    }
}
