...
public final class WidevineProperties {
    ...
    public static java.util.Optional<java.lang.Boolean> forcel3_enabled() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get("persist.drm.forcel3.enabled")));
    }

    public static void forcel3_enabled(java.lang.Boolean bool) {
        android.os.SystemProperties.set("persist.drm.forcel3.enabled", bool == null ? "" : bool.toString());
    }
}
