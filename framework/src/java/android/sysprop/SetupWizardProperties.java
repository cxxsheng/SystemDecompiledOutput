...
public final class SetupWizardProperties {
    ...
    public static java.util.Optional<java.lang.String> theme() {
        return java.util.Optional.ofNullable(tryParseString(android.os.SystemProperties.get("setupwizard.theme")));
    }

    public static void theme(java.lang.String str) {
        android.os.SystemProperties.set("setupwizard.theme", str == null ? "" : str.toString());
    }

    public static java.util.List<java.lang.String> esim_cid_ignore() {
        return tryParseList(new java.util.function.Function() { // from class: android.sysprop.SetupWizardProperties$$ExternalSyntheticLambda0
            @Override // java.util.function.Function
            public final java.lang.Object apply(java.lang.Object obj) {
                java.lang.String tryParseString;
                tryParseString = android.sysprop.SetupWizardProperties.tryParseString((java.lang.String) obj);
                return tryParseString;
            }
        }, android.os.SystemProperties.get("ro.setupwizard.esim_cid_ignore"));
    }
}
