    ...
    public int getObjectHandle() {
        switch (this.mEventCode) {
            ...
            case EVENT_OBJECT_REFERENCES_CHANGED /* 51203 */:
                return this.mParameter1;
            default:
                throw new android.mtp.MtpEvent.IllegalParameterAccess("objectHandle", this.mEventCode);
        }
    }
    ...
    public int getStorageId() {
        switch (this.mEventCode) {
            ...
            case 16396:
                return this.mParameter1;
            default:
                throw new android.mtp.MtpEvent.IllegalParameterAccess("storageID", this.mEventCode);
        }
    }
    ...
    public int getDevicePropCode() {
        switch (this.mEventCode) {
            case 16390:
                return this.mParameter1;
            default:
                throw new android.mtp.MtpEvent.IllegalParameterAccess("devicePropCode", this.mEventCode);
        }
    }
    ...
    public int getTransactionId() {
        switch (this.mEventCode) {
            case 16397:
                return this.mParameter1;
            default:
                throw new android.mtp.MtpEvent.IllegalParameterAccess("transactionID", this.mEventCode);
        }
    }
    ...
    public int getObjectPropCode() {
        switch (this.mEventCode) {
            ...
            case EVENT_OBJECT_PROP_DESC_CHANGED /* 51202 */:
                return this.mParameter1;
            default:
                throw new android.mtp.MtpEvent.IllegalParameterAccess("objectPropCode", this.mEventCode);
        }
    }
    ...
    public int getObjectFormatCode() {
        switch (this.mEventCode) {
            case EVENT_OBJECT_PROP_DESC_CHANGED /* 51202 */:
                return this.mParameter2;
            default:
                throw new android.mtp.MtpEvent.IllegalParameterAccess("objectFormatCode", this.mEventCode);
        }
    }

    private static class IllegalParameterAccess extends java.lang.UnsupportedOperationException {
        public IllegalParameterAccess(java.lang.String str, int i) {
            super("Cannot obtain " + str + " for the event: " + i + android.media.MediaMetrics.SEPARATOR);
        }
    }
}
