...
class JapanesePhoneNumberFormatter {
    ...
    public static void format(android.text.Editable editable) {
        int i;
        ...
        while (true) {
            ...
            if (java.lang.Character.isDigit(charAt)) {
                ...
                if (s < 0) {
                    ...
                    int abs = (java.lang.Math.abs((int) s) % 10) + i;
                    if (length2 > abs) {
                        editable.insert(abs, com.android.internal.content.NativeLibraryHelper.CLEAR_ABI_OVERRIDE);
                    }
                    int abs2 = (java.lang.Math.abs((int) s) / 10) + i;
                    if (length2 > abs2) {
                        editable.insert(abs2, com.android.internal.content.NativeLibraryHelper.CLEAR_ABI_OVERRIDE);
                    }
                } else {
                    i3++;
                }
        ...
        if (length2 > 3 && i == 3) {
            editable.insert(i, com.android.internal.content.NativeLibraryHelper.CLEAR_ABI_OVERRIDE);
        }
    }
}
