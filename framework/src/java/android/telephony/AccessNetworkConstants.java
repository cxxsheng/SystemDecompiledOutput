...
public final class AccessNetworkConstants {
    private static final java.lang.String TAG = android.telephony.AccessNetworkConstants.class.getSimpleName();
    ...
    public static java.lang.String transportTypeToString(int i) {
        switch (i) {
            case -1:
                return "INVALID";
            case 0:
        ...
        public static int fromString(java.lang.String str) {
            ...
            switch (c) {
                ...
                case 6:
                    return 6;
                default:
                    throw new java.lang.IllegalArgumentException("Invalid access network type " + str);
            }
        }
    }
    ...
    enum GeranBandArfcnFrequency {
        ...
        GERAN_ARFCN_FREQUENCY_BAND_DCS1800(12, 1710200, 512, 512, com.android.internal.logging.nano.MetricsProto.MetricsEvent.ACTION_APPOP_DENIED_ACCESS_NOTIFICATIONS, 95),
        GERAN_ARFCN_FREQUENCY_BAND_PCS1900(13, 1850200, 512, 512, com.android.internal.logging.nano.MetricsProto.MetricsEvent.PROVISIONING_TERMS_COUNT, 80),
    ...
    enum UtranBandArfcnFrequency {
        ...
        UTRAN_ARFCN_FREQUENCY_BAND_3(3, 1575000, 1162, 1513, 1525000, com.android.internal.logging.nano.MetricsProto.MetricsEvent.ACTION_TEXT_SELECTION_MENU_ITEM_ASSIST, com.android.internal.logging.nano.MetricsProto.MetricsEvent.ROTATION_SUGGESTION_SHOWN),
        UTRAN_ARFCN_FREQUENCY_BAND_4(4, 1805000, 1537, 1738, 1450000, 1312, 1513),
        UTRAN_ARFCN_FREQUENCY_BAND_5(5, 0, 4357, 4458, 0, 4132, 4233),
        UTRAN_ARFCN_FREQUENCY_BAND_6(6, 0, com.android.internal.telephony.gsm.SmsCbConstants.MESSAGE_ID_CMAS_ALERT_EXTREME_EXPECTED_LIKELY_LANGUAGE, 4413, 0, 4162, 4188),
        ...
        UTRAN_ARFCN_FREQUENCY_BAND_10(10, 1490000, android.bluetooth.hci.BluetoothHciProtoEnums.CMD_WRITE_AUTOMATIC_FLUSH_TIMEOUT, 3388, 1135000, 2887, android.bluetooth.hci.BluetoothHciProtoEnums.CMD_WRITE_ERRONEOUS_DATA_RPT),
        ...
        UTRAN_ARFCN_FREQUENCY_BAND_14(14, -63000, android.mtp.MtpConstants.OPERATION_GET_DEVICE_PROP_VALUE, 4143, 12000, 3892, 3918),
        UTRAN_ARFCN_FREQUENCY_BAND_19(19, 735000, com.android.internal.logging.nano.MetricsProto.MetricsEvent.ACTION_PERMISSION_DENIED_RECEIVE_SMS, 763, 770000, 312, 363),
    ...
    enum EutranBandArfcnFrequency {
        ...
        EUTRAN_ARFCN_FREQUENCY_BAND_4(4, 2110000, android.app.settings.SettingsEnums.SETTINGS_LANGUAGES_CATEGORY, 2399, 1710000, 19950, 20399),
        ...
        EUTRAN_ARFCN_FREQUENCY_BAND_23(23, 2180000, 7500, 7699, android.view.WindowManagerPolicyConstants.WINDOW_FREEZE_LAYER, 25500, 25699),
        ...
        EUTRAN_ARFCN_FREQUENCY_BAND_33(33, 1900000, 36000, android.opengl.GLES11Ext.GL_TEXTURE_BINDING_EXTERNAL_OES, 1900000, 36000, android.opengl.GLES11Ext.GL_TEXTURE_BINDING_EXTERNAL_OES),
        EUTRAN_ARFCN_FREQUENCY_BAND_34(34, android.view.WindowManagerPolicyConstants.SCREEN_FREEZE_LAYER_BASE, android.opengl.GLES11Ext.GL_REQUIRED_TEXTURE_IMAGE_UNITS_OES, android.opengl.GLES20.GL_MAX_FRAGMENT_UNIFORM_VECTORS, android.view.WindowManagerPolicyConstants.SCREEN_FREEZE_LAYER_BASE, android.opengl.GLES11Ext.GL_REQUIRED_TEXTURE_IMAGE_UNITS_OES, android.opengl.GLES20.GL_MAX_FRAGMENT_UNIFORM_VECTORS),
