...
public final class DataFailCause {
    ...
    private static final java.util.Map<java.lang.Integer, java.lang.String> sFailCauseMap = new java.util.HashMap();
    private static final java.util.HashMap<java.lang.Integer, java.util.Set<java.lang.Integer>> sPermanentFailureCache;

    static {
        sFailCauseMap.put(0, android.security.keystore.KeyProperties.DIGEST_NONE);
        ...
        sFailCauseMap.put(java.lang.Integer.valueOf(IWLAN_NON_3GPP_ACCESS_TO_EPC_NOT_ALLOWED), "IWLAN_NON_3GPP_ACCESS_TO_EPC_NOT_ALLOWED");
        sFailCauseMap.put(java.lang.Integer.valueOf(IWLAN_USER_UNKNOWN), "IWLAN_USER_UNKNOWN");
        sFailCauseMap.put(java.lang.Integer.valueOf(IWLAN_NO_APN_SUBSCRIPTION), "IWLAN_NO_APN_SUBSCRIPTION");
        sFailCauseMap.put(java.lang.Integer.valueOf(IWLAN_AUTHORIZATION_REJECTED), "IWLAN_AUTHORIZATION_REJECTED");
        sFailCauseMap.put(java.lang.Integer.valueOf(IWLAN_ILLEGAL_ME), "IWLAN_ILLEGAL_ME");
        sFailCauseMap.put(java.lang.Integer.valueOf(IWLAN_NETWORK_FAILURE), "IWLAN_NETWORK_FAILURE");
        sFailCauseMap.put(java.lang.Integer.valueOf(IWLAN_RAT_TYPE_NOT_ALLOWED), "IWLAN_RAT_TYPE_NOT_ALLOWED");
        sFailCauseMap.put(java.lang.Integer.valueOf(IWLAN_IMEI_NOT_ACCEPTED), "IWLAN_IMEI_NOT_ACCEPTED");
        sFailCauseMap.put(java.lang.Integer.valueOf(IWLAN_PLMN_NOT_ALLOWED), "IWLAN_PLMN_NOT_ALLOWED");
        sFailCauseMap.put(java.lang.Integer.valueOf(IWLAN_UNAUTHENTICATED_EMERGENCY_NOT_SUPPORTED), "IWLAN_UNAUTHENTICATED_EMERGENCY_NOT_SUPPORTED");
        ...
        sFailCauseMap.put(java.lang.Integer.valueOf(HANDOVER_FAILED), "HANDOVER_FAILED");
        sFailCauseMap.put(java.lang.Integer.valueOf(DUPLICATE_CID), "DUPLICATE_CID");
        sFailCauseMap.put(java.lang.Integer.valueOf(NO_DEFAULT_DATA), "NO_DEFAULT_DATA");
        sFailCauseMap.put(java.lang.Integer.valueOf(SERVICE_TEMPORARILY_UNAVAILABLE), "SERVICE_TEMPORARILY_UNAVAILABLE");
        sFailCauseMap.put(java.lang.Integer.valueOf(REQUEST_NOT_SUPPORTED), "REQUEST_NOT_SUPPORTED");
        sFailCauseMap.put(java.lang.Integer.valueOf(NO_RETRY_FAILURE), "NO_RETRY_FAILURE");
        sPermanentFailureCache = new java.util.HashMap<>();
    }

    private DataFailCause() {
    }

    public static boolean isRadioRestartFailure(android.content.Context context, final int i, int i2) {
        ...
        if (carrierConfigManager != null && (configForSubId = carrierConfigManager.getConfigForSubId(i2)) != null) {
            if (i == 36 && configForSubId.getBoolean(android.telephony.CarrierConfigManager.KEY_RESTART_RADIO_ON_PDP_FAIL_REGULAR_DEACTIVATION_BOOL)) {
                return true;
            }
            int[] intArray = configForSubId.getIntArray(android.telephony.CarrierConfigManager.KEY_RADIO_RESTART_FAILURE_CAUSES_INT_ARRAY);
            if (intArray != null) {
                return java.util.Arrays.stream(intArray).anyMatch(new java.util.function.IntPredicate() { // from class: android.telephony.DataFailCause$$ExternalSyntheticLambda0
                    @Override // java.util.function.IntPredicate
                    public final boolean test(int i3) {
                        return android.telephony.DataFailCause.lambda$isRadioRestartFailure$0(i, i3);
                    }
                });
            }
            return false;
    ...
    public static boolean isPermanentFailure(android.content.Context context, int i, int i2) {
        boolean contains;
        android.os.PersistableBundle configForSubId;
        java.lang.String[] stringArray;
        synchronized (sPermanentFailureCache) {
            java.util.Set<java.lang.Integer> set = sPermanentFailureCache.get(java.lang.Integer.valueOf(i2));
            if (set == null) {
                android.telephony.CarrierConfigManager carrierConfigManager = (android.telephony.CarrierConfigManager) context.getSystemService("carrier_config");
                if (carrierConfigManager != null && (configForSubId = carrierConfigManager.getConfigForSubId(i2)) != null && (stringArray = configForSubId.getStringArray(android.telephony.CarrierConfigManager.KEY_CARRIER_DATA_CALL_PERMANENT_FAILURE_STRINGS)) != null) {
                    set = new java.util.HashSet<>();
                    for (java.util.Map.Entry<java.lang.Integer, java.lang.String> entry : sFailCauseMap.entrySet()) {
                        if (com.android.internal.telephony.util.ArrayUtils.contains(stringArray, entry.getValue())) {
                ...
                if (set == null) {
                    ...
                    hashSet.add(65538);
                    hashSet.add(-3);
                    hashSet.add(java.lang.Integer.valueOf(DUPLICATE_CID));
                    hashSet.add(2253);
                    hashSet.add(2254);
                    set = hashSet;
                }
                set.add(java.lang.Integer.valueOf(NO_RETRY_FAILURE));
                sPermanentFailureCache.put(java.lang.Integer.valueOf(i2), set);
            }
            contains = set.contains(java.lang.Integer.valueOf(i));
        }
        return contains;
    }
    ...
    public static java.lang.String toString(int i) {
        return sFailCauseMap.getOrDefault(java.lang.Integer.valueOf(i), "UNKNOWN") + "(0x" + java.lang.Integer.toHexString(i) + android.inputmethodservice.navigationbar.NavigationBarInflaterView.KEY_CODE_END;
    }

    public static int getFailCause(int i) {
        if (sFailCauseMap.containsKey(java.lang.Integer.valueOf(i))) {
            return i;
        }
        return 65536;
    }
    ...
    public static boolean isFailCauseExisting(int i) {
        return sFailCauseMap.containsKey(java.lang.Integer.valueOf(i));
    }
}
