...
public final class ImsStreamMediaProfile implements android.os.Parcelable {
    ...
    public static final android.os.Parcelable.Creator<android.telephony.ims.ImsStreamMediaProfile> CREATOR = new android.os.Parcelable.Creator<android.telephony.ims.ImsStreamMediaProfile>() { // from class: android.telephony.ims.ImsStreamMediaProfile.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.telephony.ims.ImsStreamMediaProfile createFromParcel(android.os.Parcel parcel) {
            return new android.telephony.ims.ImsStreamMediaProfile(parcel);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.telephony.ims.ImsStreamMediaProfile[] newArray(int i) {
            return new android.telephony.ims.ImsStreamMediaProfile[i];
        }
    };
    ...
    private android.telephony.ims.AudioCodecAttributes mAudioCodecAttributes;
    ...
    public ImsStreamMediaProfile(android.os.Parcel parcel) {
    ...
    public void copyFrom(android.telephony.ims.ImsStreamMediaProfile imsStreamMediaProfile) {
    ...
    private void readFromParcel(android.os.Parcel parcel) {
        ...
        this.mAudioCodecAttributes = (android.telephony.ims.AudioCodecAttributes) parcel.readTypedObject(android.telephony.ims.AudioCodecAttributes.CREATOR);
    ...
    public android.telephony.ims.AudioCodecAttributes getAudioCodecAttributes() {
        return this.mAudioCodecAttributes;
    }

    public void setAudioCodecAttributes(android.telephony.ims.AudioCodecAttributes audioCodecAttributes) {
