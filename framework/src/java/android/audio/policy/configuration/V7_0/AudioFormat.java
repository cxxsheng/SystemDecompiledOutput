...
public enum AudioFormat {
    ...
    AudioFormat(java.lang.String str) {
        this.rawName = str;
    }
    ...
    static android.audio.policy.configuration.V7_0.AudioFormat fromString(java.lang.String str) {
        for (android.audio.policy.configuration.V7_0.AudioFormat audioFormat : values()) {
