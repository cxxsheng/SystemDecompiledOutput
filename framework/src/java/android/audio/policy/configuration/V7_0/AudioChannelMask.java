...
public enum AudioChannelMask {
    ...
    AudioChannelMask(java.lang.String str) {
        this.rawName = str;
    }
    ...
    static android.audio.policy.configuration.V7_0.AudioChannelMask fromString(java.lang.String str) {
        for (android.audio.policy.configuration.V7_0.AudioChannelMask audioChannelMask : values()) {
