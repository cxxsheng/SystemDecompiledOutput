...
public enum AudioDevice {
    ...
    AudioDevice(java.lang.String str) {
        this.rawName = str;
    }
    ...
    static android.audio.policy.configuration.V7_0.AudioDevice fromString(java.lang.String str) {
        for (android.audio.policy.configuration.V7_0.AudioDevice audioDevice : values()) {
