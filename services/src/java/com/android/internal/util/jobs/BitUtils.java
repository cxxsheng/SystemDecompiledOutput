...
public final class BitUtils {
    ...
    public static boolean maskedEquals(byte[] bArr, byte[] bArr2, @android.annotation.Nullable byte[] bArr3) {
        if (bArr == null || bArr2 == null) {
            return bArr == bArr2;
        }
        com.android.internal.util.jobs.Preconditions.checkArgument(bArr.length == bArr2.length, "Inputs must be of same size");
        if (bArr3 == null) {
            return java.util.Arrays.equals(bArr, bArr2);
        }
        com.android.internal.util.jobs.Preconditions.checkArgument(bArr.length == bArr3.length, "Mask must be of same size as inputs");
    ...
    public static boolean maskedEquals(java.util.UUID uuid, java.util.UUID uuid2, @android.annotation.Nullable java.util.UUID uuid3) {
        if (uuid3 == null) {
    ...
    public static int uint8(byte b) {
        return b & android.hardware.tv.hdmi.cec.CecDeviceType.INACTIVE;
    }
    ...
    public static int uint16(byte b, byte b2) {
        return ((b & android.hardware.tv.hdmi.cec.CecDeviceType.INACTIVE) << 8) | (b2 & android.hardware.tv.hdmi.cec.CecDeviceType.INACTIVE);
    }
    ...
    public static java.lang.String flagsToString(int i, java.util.function.IntFunction<java.lang.String> intFunction) {
        ...
        android.text.TextUtils.wrap(sb, "[", "]");
        return sb.toString();
    }
