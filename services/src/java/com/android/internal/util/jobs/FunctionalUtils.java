...
public class FunctionalUtils {
    ...
    public static <T> java.util.function.Consumer<T> uncheckExceptions(com.android.internal.util.jobs.FunctionalUtils.ThrowingConsumer<T> throwingConsumer) {
        return throwingConsumer;
    }

    public static <I, O> java.util.function.Function<I, O> uncheckExceptions(com.android.internal.util.jobs.FunctionalUtils.ThrowingFunction<I, O> throwingFunction) {
        return throwingFunction;
    }

    public static java.lang.Runnable uncheckExceptions(com.android.internal.util.jobs.FunctionalUtils.ThrowingRunnable throwingRunnable) {
        return throwingRunnable;
    }

    public static <A, B> java.util.function.BiConsumer<A, B> uncheckExceptions(com.android.internal.util.jobs.FunctionalUtils.ThrowingBiConsumer<A, B> throwingBiConsumer) {
        return throwingBiConsumer;
    }

    public static <T> java.util.function.Supplier<T> uncheckExceptions(com.android.internal.util.jobs.FunctionalUtils.ThrowingSupplier<T> throwingSupplier) {
        return throwingSupplier;
    }

    public static <T> java.util.function.Consumer<T> ignoreRemoteException(com.android.internal.util.jobs.FunctionalUtils.RemoteExceptionIgnoringConsumer<T> remoteExceptionIgnoringConsumer) {
        return remoteExceptionIgnoringConsumer;
    }

    public static java.lang.Runnable handleExceptions(final com.android.internal.util.jobs.FunctionalUtils.ThrowingRunnable throwingRunnable, final java.util.function.Consumer<java.lang.Throwable> consumer) {
        return new java.lang.Runnable() { // from class: com.android.internal.util.jobs.FunctionalUtils$$ExternalSyntheticLambda0
            ...
            public final void run() {
                com.android.internal.util.jobs.FunctionalUtils.lambda$handleExceptions$0(com.android.internal.util.jobs.FunctionalUtils.ThrowingRunnable.this, consumer);
            }
        };
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$handleExceptions$0(com.android.internal.util.jobs.FunctionalUtils.ThrowingRunnable throwingRunnable, java.util.function.Consumer consumer) {
        try {
    ...
    public static java.lang.String getLambdaName(@android.annotation.NonNull java.lang.Object obj) {
        int indexOf;
