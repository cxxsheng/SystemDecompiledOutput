...
public class FingerprintUpdateActiveUserClientLegacy extends com.android.server.biometrics.sensors.HalClientMonitor<android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint> {
    ...
    FingerprintUpdateActiveUserClientLegacy(@android.annotation.NonNull android.content.Context context, @android.annotation.NonNull java.util.function.Supplier<android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint> supplier, int i, @android.annotation.NonNull java.lang.String str, int i2, @android.annotation.NonNull com.android.server.biometrics.log.BiometricLogger biometricLogger, @android.annotation.NonNull com.android.server.biometrics.log.BiometricContext biometricContext, @android.annotation.NonNull java.util.function.Supplier<java.lang.Integer> supplier2, boolean z, @android.annotation.NonNull java.util.Map<java.lang.Integer, java.lang.Long> map, boolean z2) {
    ...
    protected void startHalOperation() {
        try {
            ...
            this.mAuthenticatorIds.put(java.lang.Integer.valueOf(targetUserId), java.lang.Long.valueOf(this.mHasEnrolledBiometrics ? getFreshDaemon().getAuthenticatorId() : 0L));
