...
class ActivityManagerDebugConfig {
    ...
    static final boolean DEBUG_ALLOWLISTS = false;
    ...
    static final boolean DEBUG_FREEZER = false;
    ...
    static final boolean DEBUG_RSS = false;
    ...
    static final java.io.PrintWriter LOG_WRITER_INFO = new java.io.PrintWriter((java.io.Writer) new android.util.LogWriter(4, TAG_AM));
