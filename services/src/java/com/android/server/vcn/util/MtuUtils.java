...
public class MtuUtils {
    ...
    public static int getMtu(@android.annotation.NonNull java.util.List<android.net.ipsec.ike.ChildSaProposal> list, int i, int i2, boolean z) {
        if (i2 <= 0) {
            return 1280;
        }
        int i3 = 0;
        ...
        for (android.net.ipsec.ike.ChildSaProposal childSaProposal : list) {
            ...
            while (it.hasNext()) {
                int intValue = ((java.lang.Integer) it.next().first).intValue();
