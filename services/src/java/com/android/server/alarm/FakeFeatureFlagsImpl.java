...
public class FakeFeatureFlagsImpl implements com.android.server.alarm.FeatureFlags {
    private java.util.Map<java.lang.String, java.lang.Boolean> mFlagMap = new java.util.HashMap(java.util.Map.ofEntries(java.util.Map.entry(com.android.server.alarm.Flags.FLAG_START_USER_BEFORE_SCHEDULED_ALARMS, false), java.util.Map.entry(com.android.server.alarm.Flags.FLAG_USE_FROZEN_STATE_TO_DROP_LISTENER_ALARMS, false)));
    ...
    public boolean startUserBeforeScheduledAlarms() {
        return getValue(com.android.server.alarm.Flags.FLAG_START_USER_BEFORE_SCHEDULED_ALARMS);
    }

    @Override // com.android.server.alarm.FeatureFlags
    @android.compat.annotation.UnsupportedAppUsage
    public boolean useFrozenStateToDropListenerAlarms() {
        return getValue(com.android.server.alarm.Flags.FLAG_USE_FROZEN_STATE_TO_DROP_LISTENER_ALARMS);
    }
