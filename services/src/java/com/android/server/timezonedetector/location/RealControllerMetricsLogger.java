...
final class RealControllerMetricsLogger implements com.android.server.timezonedetector.location.LocationTimeZoneProviderController.MetricsLogger {
    ...
    public void onStateChange(java.lang.String str) {
        com.android.internal.util.FrameworkStatsLog.write(com.android.internal.util.FrameworkStatsLog.LOCATION_TIME_ZONE_PROVIDER_CONTROLLER_STATE_CHANGED, metricsState(str));
    }

    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
    private static int metricsState(java.lang.String str) {
        char c;
        switch (str.hashCode()) {
            case -1166336595:
