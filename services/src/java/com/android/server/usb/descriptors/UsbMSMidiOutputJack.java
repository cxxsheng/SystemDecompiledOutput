...
public final class UsbMSMidiOutputJack extends com.android.server.usb.descriptors.UsbACInterface {
    ...
    public void report(com.android.server.usb.descriptors.report.ReportCanvas reportCanvas) {
        ...
        reportCanvas.writeHeader(3, "MS Midi Output Jack: " + com.android.server.usb.descriptors.report.ReportCanvas.getHexString(getType()) + " SubType: " + com.android.server.usb.descriptors.report.ReportCanvas.getHexString(getSubclass()) + " Length: " + getLength());
    }
}
