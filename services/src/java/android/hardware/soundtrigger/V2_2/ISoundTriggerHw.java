...
public interface ISoundTriggerHw extends android.hardware.soundtrigger.V2_1.ISoundTriggerHw {
    public static final java.lang.String kInterfaceName = "android.hardware.soundtrigger@2.2::ISoundTriggerHw";
    ...
    int getModelState(int i) throws android.os.RemoteException;
    ...
    static android.hardware.soundtrigger.V2_2.ISoundTriggerHw asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.soundtrigger.V2_2.ISoundTriggerHw)) {
            return (android.hardware.soundtrigger.V2_2.ISoundTriggerHw) queryLocalInterface;
        }
        android.hardware.soundtrigger.V2_2.ISoundTriggerHw.Proxy proxy = new android.hardware.soundtrigger.V2_2.ISoundTriggerHw.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.soundtrigger.V2_2.ISoundTriggerHw castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.soundtrigger.V2_2.ISoundTriggerHw getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.soundtrigger.V2_2.ISoundTriggerHw getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.soundtrigger.V2_2.ISoundTriggerHw getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.soundtrigger.V2_2.ISoundTriggerHw getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.soundtrigger.V2_2.ISoundTriggerHw {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.soundtrigger.V2_2.ISoundTriggerHw {
        @Override // android.hardware.soundtrigger.V2_2.ISoundTriggerHw, android.hardware.soundtrigger.V2_1.ISoundTriggerHw, android.hardware.soundtrigger.V2_0.ISoundTriggerHw, android.hidl.base.V1_0.IBase
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.soundtrigger.V2_2.ISoundTriggerHw.kInterfaceName, android.hardware.soundtrigger.V2_1.ISoundTriggerHw.kInterfaceName, android.hardware.soundtrigger.V2_0.ISoundTriggerHw.kInterfaceName, android.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.soundtrigger.V2_2.ISoundTriggerHw.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, final android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                case 1:
                    ...
                    getProperties(new android.hardware.soundtrigger.V2_0.ISoundTriggerHw.getPropertiesCallback() { // from class: android.hardware.soundtrigger.V2_2.ISoundTriggerHw.Stub.1
                ...
                case 2:
                    ...
                    loadSoundModel(soundModel, android.hardware.soundtrigger.V2_0.ISoundTriggerHwCallback.asInterface(hwParcel.readStrongBinder()), hwParcel.readInt32(), new android.hardware.soundtrigger.V2_0.ISoundTriggerHw.loadSoundModelCallback() { // from class: android.hardware.soundtrigger.V2_2.ISoundTriggerHw.Stub.2
                ...
                case 3:
                    ...
                    loadPhraseSoundModel(phraseSoundModel, android.hardware.soundtrigger.V2_0.ISoundTriggerHwCallback.asInterface(hwParcel.readStrongBinder()), hwParcel.readInt32(), new android.hardware.soundtrigger.V2_0.ISoundTriggerHw.loadPhraseSoundModelCallback() { // from class: android.hardware.soundtrigger.V2_2.ISoundTriggerHw.Stub.3
                ...
                case 8:
                    ...
                    loadSoundModel_2_1(soundModel2, android.hardware.soundtrigger.V2_1.ISoundTriggerHwCallback.asInterface(hwParcel.readStrongBinder()), hwParcel.readInt32(), new android.hardware.soundtrigger.V2_1.ISoundTriggerHw.loadSoundModel_2_1Callback() { // from class: android.hardware.soundtrigger.V2_2.ISoundTriggerHw.Stub.4
                ...
                case 9:
                    ...
                    loadPhraseSoundModel_2_1(phraseSoundModel2, android.hardware.soundtrigger.V2_1.ISoundTriggerHwCallback.asInterface(hwParcel.readStrongBinder()), hwParcel.readInt32(), new android.hardware.soundtrigger.V2_1.ISoundTriggerHw.loadPhraseSoundModel_2_1Callback() { // from class: android.hardware.soundtrigger.V2_2.ISoundTriggerHw.Stub.5
