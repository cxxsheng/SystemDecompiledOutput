...
public interface IAuthSecret extends android.hidl.base.V1_0.IBase {
    public static final java.lang.String kInterfaceName = "android.hardware.authsecret@1.0::IAuthSecret";
    ...
    void primaryUserCredential(java.util.ArrayList<java.lang.Byte> arrayList) throws android.os.RemoteException;
    ...
    static android.hardware.authsecret.V1_0.IAuthSecret asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.authsecret.V1_0.IAuthSecret)) {
            return (android.hardware.authsecret.V1_0.IAuthSecret) queryLocalInterface;
        }
        android.hardware.authsecret.V1_0.IAuthSecret.Proxy proxy = new android.hardware.authsecret.V1_0.IAuthSecret.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.authsecret.V1_0.IAuthSecret castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.authsecret.V1_0.IAuthSecret getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.authsecret.V1_0.IAuthSecret getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.authsecret.V1_0.IAuthSecret getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.authsecret.V1_0.IAuthSecret getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.authsecret.V1_0.IAuthSecret {
        ...
        public void primaryUserCredential(java.util.ArrayList<java.lang.Byte> arrayList) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.authsecret.V1_0.IAuthSecret.kInterfaceName);
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.authsecret.V1_0.IAuthSecret {
        @Override // android.hardware.authsecret.V1_0.IAuthSecret, android.hidl.base.V1_0.IBase
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.authsecret.V1_0.IAuthSecret.kInterfaceName, android.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.authsecret.V1_0.IAuthSecret.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                case 1:
                    hwParcel.enforceInterface(android.hardware.authsecret.V1_0.IAuthSecret.kInterfaceName);
