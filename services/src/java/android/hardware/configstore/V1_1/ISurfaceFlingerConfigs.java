...
public interface ISurfaceFlingerConfigs extends android.hardware.configstore.V1_0.ISurfaceFlingerConfigs {
    public static final java.lang.String kInterfaceName = "android.hardware.configstore@1.1::ISurfaceFlingerConfigs";
    ...
    android.hardware.configstore.V1_1.OptionalDisplayOrientation primaryDisplayOrientation() throws android.os.RemoteException;
    ...
    static android.hardware.configstore.V1_1.ISurfaceFlingerConfigs asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.configstore.V1_1.ISurfaceFlingerConfigs)) {
            return (android.hardware.configstore.V1_1.ISurfaceFlingerConfigs) queryLocalInterface;
        }
        android.hardware.configstore.V1_1.ISurfaceFlingerConfigs.Proxy proxy = new android.hardware.configstore.V1_1.ISurfaceFlingerConfigs.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.configstore.V1_1.ISurfaceFlingerConfigs castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.configstore.V1_1.ISurfaceFlingerConfigs getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.configstore.V1_1.ISurfaceFlingerConfigs getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.configstore.V1_1.ISurfaceFlingerConfigs getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.configstore.V1_1.ISurfaceFlingerConfigs getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.configstore.V1_1.ISurfaceFlingerConfigs {
        ...
        public android.hardware.configstore.V1_1.OptionalDisplayOrientation primaryDisplayOrientation() throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.configstore.V1_1.ISurfaceFlingerConfigs.kInterfaceName);
            android.os.HwParcel hwParcel2 = new android.os.HwParcel();
            try {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.configstore.V1_1.ISurfaceFlingerConfigs {
        @Override // android.hardware.configstore.V1_1.ISurfaceFlingerConfigs, android.hardware.configstore.V1_0.ISurfaceFlingerConfigs, android.hidl.base.V1_0.IBase
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.configstore.V1_1.ISurfaceFlingerConfigs.kInterfaceName, android.hardware.configstore.V1_0.ISurfaceFlingerConfigs.kInterfaceName, android.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.configstore.V1_1.ISurfaceFlingerConfigs.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                ...
                case 12:
                    ...
                    return;
                case 13:
                    hwParcel.enforceInterface(android.hardware.configstore.V1_1.ISurfaceFlingerConfigs.kInterfaceName);
                    android.hardware.configstore.V1_1.OptionalDisplayOrientation primaryDisplayOrientation = primaryDisplayOrientation();
                    hwParcel2.writeStatus(0);
