...
public final class OptionalInt64 {
    ...
    public final boolean equals(java.lang.Object obj) {
        ...
        if (obj == null || obj.getClass() != android.hardware.configstore.V1_0.OptionalInt64.class) {
            return false;
        }
        android.hardware.configstore.V1_0.OptionalInt64 optionalInt64 = (android.hardware.configstore.V1_0.OptionalInt64) obj;
    ...
    public static final java.util.ArrayList<android.hardware.configstore.V1_0.OptionalInt64> readVectorFromParcel(android.os.HwParcel hwParcel) {
        java.util.ArrayList<android.hardware.configstore.V1_0.OptionalInt64> arrayList = new java.util.ArrayList<>();
    ...
    public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.hardware.configstore.V1_0.OptionalInt64> arrayList) {
        android.os.HwBlob hwBlob = new android.os.HwBlob(16);
