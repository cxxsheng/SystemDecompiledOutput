...
public final class OptionalInt32 {
    ...
    public final boolean equals(java.lang.Object obj) {
        ...
        if (obj == null || obj.getClass() != android.hardware.configstore.V1_0.OptionalInt32.class) {
            return false;
        }
        android.hardware.configstore.V1_0.OptionalInt32 optionalInt32 = (android.hardware.configstore.V1_0.OptionalInt32) obj;
    ...
    public static final java.util.ArrayList<android.hardware.configstore.V1_0.OptionalInt32> readVectorFromParcel(android.os.HwParcel hwParcel) {
        java.util.ArrayList<android.hardware.configstore.V1_0.OptionalInt32> arrayList = new java.util.ArrayList<>();
        android.os.HwBlob readBuffer = hwParcel.readBuffer(16L);
        int int32 = readBuffer.getInt32(8L);
        android.os.HwBlob readEmbeddedBuffer = hwParcel.readEmbeddedBuffer(int32 * 8, readBuffer.handle(), 0L, true);
        arrayList.clear();
        for (int i = 0; i < int32; i++) {
            android.hardware.configstore.V1_0.OptionalInt32 optionalInt32 = new android.hardware.configstore.V1_0.OptionalInt32();
    ...
    public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.hardware.configstore.V1_0.OptionalInt32> arrayList) {
