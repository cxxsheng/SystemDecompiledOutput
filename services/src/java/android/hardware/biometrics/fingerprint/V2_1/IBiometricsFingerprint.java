...
public interface IBiometricsFingerprint extends android.hidl.base.V1_0.IBase {
    public static final java.lang.String kInterfaceName = "android.hardware.biometrics.fingerprint@2.1::IBiometricsFingerprint";

    @Override // android.hidl.base.V1_0.IBase
    android.os.IHwBinder asBinder();

    int authenticate(long j, int i) throws android.os.RemoteException;
    ...
    int enroll(byte[] bArr, int i, int i2) throws android.os.RemoteException;

    int enumerate() throws android.os.RemoteException;

    long getAuthenticatorId() throws android.os.RemoteException;
    ...
    int postEnroll() throws android.os.RemoteException;

    long preEnroll() throws android.os.RemoteException;

    int remove(int i, int i2) throws android.os.RemoteException;

    int setActiveGroup(int i, java.lang.String str) throws android.os.RemoteException;

    @Override // android.hidl.base.V1_0.IBase
    void setHALInstrumentation() throws android.os.RemoteException;

    long setNotify(android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprintClientCallback iBiometricsFingerprintClientCallback) throws android.os.RemoteException;

    @Override // android.hidl.base.V1_0.IBase
    boolean unlinkToDeath(android.os.IHwBinder.DeathRecipient deathRecipient) throws android.os.RemoteException;

    static android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint)) {
            return (android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint) queryLocalInterface;
        }
        android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint.Proxy proxy = new android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint {
        @Override // android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint, android.hidl.base.V1_0.IBase
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint.kInterfaceName, android.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprint.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
