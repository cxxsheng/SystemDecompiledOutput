...
public interface IBiometricsFingerprintClientCallback extends android.hardware.biometrics.fingerprint.V2_1.IBiometricsFingerprintClientCallback {
    ...
    static android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprintClientCallback asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprintClientCallback)) {
            return (android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprintClientCallback) queryLocalInterface;
        }
        android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprintClientCallback.Proxy proxy = new android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprintClientCallback.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprintClientCallback castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprintClientCallback getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprintClientCallback getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprintClientCallback getService(java.lang.String str) throws android.os.RemoteException {
    ...
    public static final class Proxy implements android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprintClientCallback {
        ...
        public void onAcquired_2_2(long j, int i, int i2) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprintClientCallback.kInterfaceName);
            hwParcel.writeInt64(j);
            hwParcel.writeInt32(i);
            hwParcel.writeInt32(i2);
            android.os.HwParcel hwParcel2 = new android.os.HwParcel();
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprintClientCallback {
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprintClientCallback.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                ...
                case 6:
                    ...
                    return;
                case 7:
                    hwParcel.enforceInterface(android.hardware.biometrics.fingerprint.V2_2.IBiometricsFingerprintClientCallback.kInterfaceName);
