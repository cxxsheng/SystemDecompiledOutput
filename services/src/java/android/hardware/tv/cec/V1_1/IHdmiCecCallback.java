...
public interface IHdmiCecCallback extends android.hardware.tv.cec.V1_0.IHdmiCecCallback {
    public static final java.lang.String kInterfaceName = "android.hardware.tv.cec@1.1::IHdmiCecCallback";
    ...
    void onCecMessage_1_1(android.hardware.tv.cec.V1_1.CecMessage cecMessage) throws android.os.RemoteException;
    ...
    static android.hardware.tv.cec.V1_1.IHdmiCecCallback asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.tv.cec.V1_1.IHdmiCecCallback)) {
            return (android.hardware.tv.cec.V1_1.IHdmiCecCallback) queryLocalInterface;
        }
        android.hardware.tv.cec.V1_1.IHdmiCecCallback.Proxy proxy = new android.hardware.tv.cec.V1_1.IHdmiCecCallback.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.tv.cec.V1_1.IHdmiCecCallback castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.tv.cec.V1_1.IHdmiCecCallback getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.tv.cec.V1_1.IHdmiCecCallback getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.tv.cec.V1_1.IHdmiCecCallback getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.tv.cec.V1_1.IHdmiCecCallback getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.tv.cec.V1_1.IHdmiCecCallback {
        ...
        public void onCecMessage_1_1(android.hardware.tv.cec.V1_1.CecMessage cecMessage) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.tv.cec.V1_1.IHdmiCecCallback.kInterfaceName);
            cecMessage.writeToParcel(hwParcel);
            android.os.HwParcel hwParcel2 = new android.os.HwParcel();
            try {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.tv.cec.V1_1.IHdmiCecCallback {
        @Override // android.hardware.tv.cec.V1_1.IHdmiCecCallback, android.hardware.tv.cec.V1_0.IHdmiCecCallback, android.hidl.base.V1_0.IBase
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.tv.cec.V1_1.IHdmiCecCallback.kInterfaceName, android.hardware.tv.cec.V1_0.IHdmiCecCallback.kInterfaceName, android.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public final java.util.ArrayList<byte[]> getHashChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(new byte[]{-71, 104, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_CLASSSPECIFIC_ENDPOINT, -121, 103, 124, -23, -56, 114, -32, 79, android.hardware.tv.hdmi.cec.CecLogicalAddress.FREE_USE, -97, -42, -55, -57, -118, 86, -82, 121, 92, 7, -53, -8, -59, 1, 0, -32, 53, 29, 76, 68}, new byte[]{-25, 91, 110, -22, 113, 29, 54, -6, -58, 120, -68, -32, 114, -77, -50, -58, 84, 75, 39, -6, -97, 76, -39, 3, -103, -108, 4, -27, -63, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_CAPABILITY, -54, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_CAPABILITY}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_PHYSICAL, -17, 5, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_CLASSSPECIFIC_INTERFACE, -13, -51, 105, 87, 19, -109, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_CLASSSPECIFIC_INTERFACE, -72, 59, 24, -54, 76}));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.tv.cec.V1_1.IHdmiCecCallback.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                ...
                case 2:
                    hwParcel.enforceInterface(android.hardware.tv.cec.V1_0.IHdmiCecCallback.kInterfaceName);
                    android.hardware.tv.cec.V1_0.HotplugEvent hotplugEvent = new android.hardware.tv.cec.V1_0.HotplugEvent();
                    hotplugEvent.readFromParcel(hwParcel);
                    onHotplugEvent(hotplugEvent);
                    return;
                case 3:
                    hwParcel.enforceInterface(android.hardware.tv.cec.V1_1.IHdmiCecCallback.kInterfaceName);
