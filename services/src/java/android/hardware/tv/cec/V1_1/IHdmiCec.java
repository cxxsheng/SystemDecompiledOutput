...
public interface IHdmiCec extends android.hardware.tv.cec.V1_0.IHdmiCec {
    public static final java.lang.String kInterfaceName = "android.hardware.tv.cec@1.1::IHdmiCec";

    int addLogicalAddress_1_1(int i) throws android.os.RemoteException;
    ...
    int sendMessage_1_1(android.hardware.tv.cec.V1_1.CecMessage cecMessage) throws android.os.RemoteException;

    void setCallback_1_1(android.hardware.tv.cec.V1_1.IHdmiCecCallback iHdmiCecCallback) throws android.os.RemoteException;
    ...
    static android.hardware.tv.cec.V1_1.IHdmiCec asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.tv.cec.V1_1.IHdmiCec)) {
            return (android.hardware.tv.cec.V1_1.IHdmiCec) queryLocalInterface;
        }
        android.hardware.tv.cec.V1_1.IHdmiCec.Proxy proxy = new android.hardware.tv.cec.V1_1.IHdmiCec.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.tv.cec.V1_1.IHdmiCec castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.tv.cec.V1_1.IHdmiCec getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.tv.cec.V1_1.IHdmiCec getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.tv.cec.V1_1.IHdmiCec getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.tv.cec.V1_1.IHdmiCec getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.tv.cec.V1_1.IHdmiCec {
        ...
        public int addLogicalAddress_1_1(int i) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.tv.cec.V1_1.IHdmiCec.kInterfaceName);
            hwParcel.writeInt32(i);
            android.os.HwParcel hwParcel2 = new android.os.HwParcel();
            try {
        ...
        @Override // android.hardware.tv.cec.V1_1.IHdmiCec
        public int sendMessage_1_1(android.hardware.tv.cec.V1_1.CecMessage cecMessage) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.tv.cec.V1_1.IHdmiCec.kInterfaceName);
            cecMessage.writeToParcel(hwParcel);
            android.os.HwParcel hwParcel2 = new android.os.HwParcel();
        ...
        @Override // android.hardware.tv.cec.V1_1.IHdmiCec
        public void setCallback_1_1(android.hardware.tv.cec.V1_1.IHdmiCecCallback iHdmiCecCallback) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.tv.cec.V1_1.IHdmiCec.kInterfaceName);
            hwParcel.writeStrongBinder(iHdmiCecCallback == null ? null : iHdmiCecCallback.asBinder());
            android.os.HwParcel hwParcel2 = new android.os.HwParcel();
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.tv.cec.V1_1.IHdmiCec {
        @Override // android.hardware.tv.cec.V1_1.IHdmiCec, android.hardware.tv.cec.V1_0.IHdmiCec, android.hidl.base.V1_0.IBase
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.tv.cec.V1_1.IHdmiCec.kInterfaceName, android.hardware.tv.cec.V1_0.IHdmiCec.kInterfaceName, android.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.tv.cec.V1_1.IHdmiCec.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, final android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                ...
                case 3:
                    hwParcel.enforceInterface(android.hardware.tv.cec.V1_0.IHdmiCec.kInterfaceName);
                    getPhysicalAddress(new android.hardware.tv.cec.V1_0.IHdmiCec.getPhysicalAddressCallback() { // from class: android.hardware.tv.cec.V1_1.IHdmiCec.Stub.1
                ...
                case 12:
                    ...
                    return;
                case 13:
                    hwParcel.enforceInterface(android.hardware.tv.cec.V1_1.IHdmiCec.kInterfaceName);
                ...
                case 14:
                    hwParcel.enforceInterface(android.hardware.tv.cec.V1_1.IHdmiCec.kInterfaceName);
                    android.hardware.tv.cec.V1_1.CecMessage cecMessage2 = new android.hardware.tv.cec.V1_1.CecMessage();
                ...
                case 15:
                    hwParcel.enforceInterface(android.hardware.tv.cec.V1_1.IHdmiCec.kInterfaceName);
                    setCallback_1_1(android.hardware.tv.cec.V1_1.IHdmiCecCallback.asInterface(hwParcel.readStrongBinder()));
                    hwParcel2.writeStatus(0);
                    hwParcel2.send();
                    return;
                case 256067662:
