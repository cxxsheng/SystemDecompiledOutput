...
public final class CecMessage {
    ...
    public final boolean equals(java.lang.Object obj) {
        ...
        if (obj == null || obj.getClass() != android.hardware.tv.cec.V1_1.CecMessage.class) {
            return false;
        }
        android.hardware.tv.cec.V1_1.CecMessage cecMessage = (android.hardware.tv.cec.V1_1.CecMessage) obj;
    ...
    public final java.lang.String toString() {
        return "{.initiator = " + android.hardware.tv.cec.V1_1.CecLogicalAddress.toString(this.initiator) + ", .destination = " + android.hardware.tv.cec.V1_1.CecLogicalAddress.toString(this.destination) + ", .body = " + this.body + "}";
    }
    ...
    public static final java.util.ArrayList<android.hardware.tv.cec.V1_1.CecMessage> readVectorFromParcel(android.os.HwParcel hwParcel) {
        java.util.ArrayList<android.hardware.tv.cec.V1_1.CecMessage> arrayList = new java.util.ArrayList<>();
    ...
    public static final void writeVectorToParcel(android.os.HwParcel hwParcel, java.util.ArrayList<android.hardware.tv.cec.V1_1.CecMessage> arrayList) {
