...
public class DiskStats implements android.os.Parcelable {
    public static final android.os.Parcelable.Creator<android.hardware.health.DiskStats> CREATOR = new android.os.Parcelable.Creator<android.hardware.health.DiskStats>() { // from class: android.hardware.health.DiskStats.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.hardware.health.DiskStats createFromParcel(android.os.Parcel parcel) {
            android.hardware.health.DiskStats diskStats = new android.hardware.health.DiskStats();
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public android.hardware.health.DiskStats[] newArray(int i) {
            return new android.hardware.health.DiskStats[i];
        }
    };
    public long reads = 0;
