...
public interface IHealth extends android.hardware.health.V2_0.IHealth {
    ...
    static android.hardware.health.V2_1.IHealth asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.health.V2_1.IHealth)) {
            return (android.hardware.health.V2_1.IHealth) queryLocalInterface;
        }
        android.hardware.health.V2_1.IHealth.Proxy proxy = new android.hardware.health.V2_1.IHealth.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.health.V2_1.IHealth castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.health.V2_1.IHealth getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.health.V2_1.IHealth getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.health.V2_1.IHealth getService(java.lang.String str) throws android.os.RemoteException {
    ...
    public static final class Proxy implements android.hardware.health.V2_1.IHealth {
        ...
        public void getHealthConfig(android.hardware.health.V2_1.IHealth.getHealthConfigCallback gethealthconfigcallback) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.health.V2_1.IHealth.kInterfaceName);
            android.os.HwParcel hwParcel2 = new android.os.HwParcel();
            try {
        ...
        @Override // android.hardware.health.V2_1.IHealth
        public void getHealthInfo_2_1(android.hardware.health.V2_1.IHealth.getHealthInfo_2_1Callback gethealthinfo_2_1callback) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.health.V2_1.IHealth.kInterfaceName);
            android.os.HwParcel hwParcel2 = new android.os.HwParcel();
            try {
        ...
        @Override // android.hardware.health.V2_1.IHealth
        public void shouldKeepScreenOn(android.hardware.health.V2_1.IHealth.shouldKeepScreenOnCallback shouldkeepscreenoncallback) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.health.V2_1.IHealth.kInterfaceName);
            android.os.HwParcel hwParcel2 = new android.os.HwParcel();
            try {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.health.V2_1.IHealth {
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.health.V2_1.IHealth.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, final android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                ...
                case 12:
                    ...
                    return;
                case 13:
                    hwParcel.enforceInterface(android.hardware.health.V2_1.IHealth.kInterfaceName);
                    getHealthConfig(new android.hardware.health.V2_1.IHealth.getHealthConfigCallback() { // from class: android.hardware.health.V2_1.IHealth.Stub.10
                        ...
                        public void onValues(int i3, android.hardware.health.V2_1.HealthConfig healthConfig) {
                            hwParcel2.writeStatus(0);
                            hwParcel2.writeInt32(i3);
                ...
                case 14:
                    ...
                    getHealthInfo_2_1(new android.hardware.health.V2_1.IHealth.getHealthInfo_2_1Callback() { // from class: android.hardware.health.V2_1.IHealth.Stub.11
                        ...
                        public void onValues(int i3, android.hardware.health.V2_1.HealthInfo healthInfo) {
                            hwParcel2.writeStatus(0);
                            hwParcel2.writeInt32(i3);
                            healthInfo.writeToParcel(hwParcel2);
                            hwParcel2.send();
