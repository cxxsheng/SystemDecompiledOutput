...
public interface IWeaver extends android.hidl.base.V1_0.IBase {
    public static final java.lang.String kInterfaceName = "android.hardware.weaver@1.0::IWeaver";

    @java.lang.FunctionalInterface
    public interface getConfigCallback {
        void onValues(int i, android.hardware.weaver.V1_0.WeaverConfig weaverConfig);
    }

    @java.lang.FunctionalInterface
    public interface readCallback {
        void onValues(int i, android.hardware.weaver.V1_0.WeaverReadResponse weaverReadResponse);
    }
    ...
    void getConfig(android.hardware.weaver.V1_0.IWeaver.getConfigCallback getconfigcallback) throws android.os.RemoteException;
    ...
    void read(int i, java.util.ArrayList<java.lang.Byte> arrayList, android.hardware.weaver.V1_0.IWeaver.readCallback readcallback) throws android.os.RemoteException;
    ...
    int write(int i, java.util.ArrayList<java.lang.Byte> arrayList, java.util.ArrayList<java.lang.Byte> arrayList2) throws android.os.RemoteException;

    static android.hardware.weaver.V1_0.IWeaver asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.weaver.V1_0.IWeaver)) {
            return (android.hardware.weaver.V1_0.IWeaver) queryLocalInterface;
        }
        android.hardware.weaver.V1_0.IWeaver.Proxy proxy = new android.hardware.weaver.V1_0.IWeaver.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.weaver.V1_0.IWeaver castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.weaver.V1_0.IWeaver getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.weaver.V1_0.IWeaver getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.weaver.V1_0.IWeaver getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.weaver.V1_0.IWeaver getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.weaver.V1_0.IWeaver {
        ...
        public void getConfig(android.hardware.weaver.V1_0.IWeaver.getConfigCallback getconfigcallback) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.weaver.V1_0.IWeaver.kInterfaceName);
        ...
        @Override // android.hardware.weaver.V1_0.IWeaver
        public int write(int i, java.util.ArrayList<java.lang.Byte> arrayList, java.util.ArrayList<java.lang.Byte> arrayList2) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.weaver.V1_0.IWeaver.kInterfaceName);
        ...
        @Override // android.hardware.weaver.V1_0.IWeaver
        public void read(int i, java.util.ArrayList<java.lang.Byte> arrayList, android.hardware.weaver.V1_0.IWeaver.readCallback readcallback) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.weaver.V1_0.IWeaver.kInterfaceName);
            hwParcel.writeInt32(i);
            hwParcel.writeInt8Vector(arrayList);
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.weaver.V1_0.IWeaver {
        @Override // android.hardware.weaver.V1_0.IWeaver, android.hidl.base.V1_0.IBase
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.weaver.V1_0.IWeaver.kInterfaceName, android.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.weaver.V1_0.IWeaver.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, final android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                case 1:
                    hwParcel.enforceInterface(android.hardware.weaver.V1_0.IWeaver.kInterfaceName);
                    getConfig(new android.hardware.weaver.V1_0.IWeaver.getConfigCallback() { // from class: android.hardware.weaver.V1_0.IWeaver.Stub.1
                        @Override // android.hardware.weaver.V1_0.IWeaver.getConfigCallback
                        public void onValues(int i3, android.hardware.weaver.V1_0.WeaverConfig weaverConfig) {
                ...
                case 3:
                    hwParcel.enforceInterface(android.hardware.weaver.V1_0.IWeaver.kInterfaceName);
                    read(hwParcel.readInt32(), hwParcel.readInt8Vector(), new android.hardware.weaver.V1_0.IWeaver.readCallback() { // from class: android.hardware.weaver.V1_0.IWeaver.Stub.2
                        @Override // android.hardware.weaver.V1_0.IWeaver.readCallback
                        public void onValues(int i3, android.hardware.weaver.V1_0.WeaverReadResponse weaverReadResponse) {
                            hwParcel2.writeStatus(0);
                            hwParcel2.writeInt32(i3);
