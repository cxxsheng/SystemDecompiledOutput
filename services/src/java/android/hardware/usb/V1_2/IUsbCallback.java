...
public interface IUsbCallback extends android.hardware.usb.V1_1.IUsbCallback {
    public static final java.lang.String kInterfaceName = "android.hardware.usb@1.2::IUsbCallback";
    ...
    void notifyPortStatusChange_1_2(java.util.ArrayList<android.hardware.usb.V1_2.PortStatus> arrayList, int i) throws android.os.RemoteException;
    ...
    static android.hardware.usb.V1_2.IUsbCallback asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.usb.V1_2.IUsbCallback)) {
            return (android.hardware.usb.V1_2.IUsbCallback) queryLocalInterface;
        }
        android.hardware.usb.V1_2.IUsbCallback.Proxy proxy = new android.hardware.usb.V1_2.IUsbCallback.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.usb.V1_2.IUsbCallback castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.usb.V1_2.IUsbCallback getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.usb.V1_2.IUsbCallback getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.usb.V1_2.IUsbCallback getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.usb.V1_2.IUsbCallback getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.usb.V1_2.IUsbCallback {
        ...
        public void notifyPortStatusChange_1_1(java.util.ArrayList<android.hardware.usb.V1_1.PortStatus_1_1> arrayList, int i) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.usb.V1_1.IUsbCallback.kInterfaceName);
            android.hardware.usb.V1_1.PortStatus_1_1.writeVectorToParcel(hwParcel, arrayList);
            hwParcel.writeInt32(i);
            android.os.HwParcel hwParcel2 = new android.os.HwParcel();
            try {
        ...
        public void notifyPortStatusChange_1_2(java.util.ArrayList<android.hardware.usb.V1_2.PortStatus> arrayList, int i) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.usb.V1_2.IUsbCallback.kInterfaceName);
            android.hardware.usb.V1_2.PortStatus.writeVectorToParcel(hwParcel, arrayList);
            hwParcel.writeInt32(i);
            android.os.HwParcel hwParcel2 = new android.os.HwParcel();
            try {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.usb.V1_2.IUsbCallback {
        @Override // android.hardware.usb.V1_2.IUsbCallback, android.hardware.usb.V1_1.IUsbCallback, android.hardware.usb.V1_0.IUsbCallback, android.hidl.base.V1_0.IBase
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.usb.V1_2.IUsbCallback.kInterfaceName, android.hardware.usb.V1_1.IUsbCallback.kInterfaceName, android.hardware.usb.V1_0.IUsbCallback.kInterfaceName, android.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public final java.util.ArrayList<byte[]> getHashChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(new byte[]{70, -103, 108, -46, -95, -58, 98, 97, -89, 90, 31, 110, -54, -38, 119, -18, -75, -122, 30, -78, 100, -6, 57, -71, -106, 84, -113, -32, -89, -14, 45, -45}, new byte[]{19, -91, Byte.MIN_VALUE, -29, 90, -16, 18, 112, -95, -23, 119, 65, 119, -59, 29, -75, 29, -122, 114, -26, 19, -101, -96, 8, 81, -26, 84, -26, -118, 77, 125, -1}, new byte[]{75, -25, -120, 30, 65, 27, -92, 39, -124, -65, 91, 115, 84, -63, 74, -32, -49, 22, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_CAPABILITY, 4, -45, -108, 51, -86, -20, -86, -80, -47, -98, -87, -109, 84}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_PHYSICAL, -17, 5, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_CLASSSPECIFIC_INTERFACE, -13, -51, 105, 87, 19, -109, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_CLASSSPECIFIC_INTERFACE, -72, 59, 24, -54, 76}));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.usb.V1_2.IUsbCallback.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                ...
                case 3:
                    ...
                    notifyPortStatusChange_1_1(android.hardware.usb.V1_1.PortStatus_1_1.readVectorFromParcel(hwParcel), hwParcel.readInt32());
                    return;
                case 4:
                    hwParcel.enforceInterface(android.hardware.usb.V1_2.IUsbCallback.kInterfaceName);
                    notifyPortStatusChange_1_2(android.hardware.usb.V1_2.PortStatus.readVectorFromParcel(hwParcel), hwParcel.readInt32());
                    return;
                case 256067662:
