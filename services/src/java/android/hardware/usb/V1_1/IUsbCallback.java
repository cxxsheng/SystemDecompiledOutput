...
public interface IUsbCallback extends android.hardware.usb.V1_0.IUsbCallback {
    public static final java.lang.String kInterfaceName = "android.hardware.usb@1.1::IUsbCallback";
    ...
    void notifyPortStatusChange_1_1(java.util.ArrayList<android.hardware.usb.V1_1.PortStatus_1_1> arrayList, int i) throws android.os.RemoteException;
    ...
    static android.hardware.usb.V1_1.IUsbCallback asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.usb.V1_1.IUsbCallback)) {
            return (android.hardware.usb.V1_1.IUsbCallback) queryLocalInterface;
        }
        android.hardware.usb.V1_1.IUsbCallback.Proxy proxy = new android.hardware.usb.V1_1.IUsbCallback.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.usb.V1_1.IUsbCallback castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.usb.V1_1.IUsbCallback getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.usb.V1_1.IUsbCallback getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.usb.V1_1.IUsbCallback getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.usb.V1_1.IUsbCallback getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.usb.V1_1.IUsbCallback {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.usb.V1_1.IUsbCallback {
        @Override // android.hardware.usb.V1_1.IUsbCallback, android.hardware.usb.V1_0.IUsbCallback, android.hidl.base.V1_0.IBase
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.usb.V1_1.IUsbCallback.kInterfaceName, android.hardware.usb.V1_0.IUsbCallback.kInterfaceName, android.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.usb.V1_1.IUsbCallback.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
