...
public interface IUsb extends android.hardware.usb.V1_0.IUsb {
    public static final java.lang.String kInterfaceName = "android.hardware.usb@1.1::IUsb";
    ...
    static android.hardware.usb.V1_1.IUsb asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        ...
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.usb.V1_1.IUsb)) {
            return (android.hardware.usb.V1_1.IUsb) queryLocalInterface;
        }
        android.hardware.usb.V1_1.IUsb.Proxy proxy = new android.hardware.usb.V1_1.IUsb.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.usb.V1_1.IUsb castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.usb.V1_1.IUsb getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.usb.V1_1.IUsb getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.usb.V1_1.IUsb getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.usb.V1_1.IUsb getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.usb.V1_1.IUsb {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.usb.V1_1.IUsb {
        @Override // android.hardware.usb.V1_1.IUsb, android.hardware.usb.V1_0.IUsb, android.hidl.base.V1_0.IBase
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.usb.V1_1.IUsb.kInterfaceName, android.hardware.usb.V1_0.IUsb.kInterfaceName, android.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.usb.V1_1.IUsb.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
