...
public interface IAnnouncementListener extends android.hidl.base.V1_0.IBase {
    public static final java.lang.String kInterfaceName = "android.hardware.broadcastradio@2.0::IAnnouncementListener";
    ...
    void onListUpdated(java.util.ArrayList<android.hardware.broadcastradio.V2_0.Announcement> arrayList) throws android.os.RemoteException;
    ...
    static android.hardware.broadcastradio.V2_0.IAnnouncementListener asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.broadcastradio.V2_0.IAnnouncementListener)) {
            return (android.hardware.broadcastradio.V2_0.IAnnouncementListener) queryLocalInterface;
        }
        android.hardware.broadcastradio.V2_0.IAnnouncementListener.Proxy proxy = new android.hardware.broadcastradio.V2_0.IAnnouncementListener.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.broadcastradio.V2_0.IAnnouncementListener castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.broadcastradio.V2_0.IAnnouncementListener getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.broadcastradio.V2_0.IAnnouncementListener getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.broadcastradio.V2_0.IAnnouncementListener getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.broadcastradio.V2_0.IAnnouncementListener getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.broadcastradio.V2_0.IAnnouncementListener {
        ...
        public void onListUpdated(java.util.ArrayList<android.hardware.broadcastradio.V2_0.Announcement> arrayList) throws android.os.RemoteException {
            ...
            hwParcel.writeInterfaceToken(android.hardware.broadcastradio.V2_0.IAnnouncementListener.kInterfaceName);
            android.hardware.broadcastradio.V2_0.Announcement.writeVectorToParcel(hwParcel, arrayList);
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.broadcastradio.V2_0.IAnnouncementListener {
        @Override // android.hardware.broadcastradio.V2_0.IAnnouncementListener, android.hidl.base.V1_0.IBase
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.broadcastradio.V2_0.IAnnouncementListener.kInterfaceName, android.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public final java.util.ArrayList<byte[]> getHashChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(new byte[]{61, -114, -42, 125, Byte.MIN_VALUE, 126, -97, 21, -48, 112, com.android.server.usb.descriptors.UsbASFormat.EXT_FORMAT_TYPE_III, -112, -92, 22, -66, -32, 9, 32, -10, -94, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_HID, -106, -63, 4, -52, -98, 68, 60, -115, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_HID, 125, -8}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_PHYSICAL, -17, 5, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_CLASSSPECIFIC_INTERFACE, -13, -51, 105, 87, 19, -109, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_CLASSSPECIFIC_INTERFACE, -72, 59, 24, -54, 76}));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.broadcastradio.V2_0.IAnnouncementListener.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                case 1:
                    hwParcel.enforceInterface(android.hardware.broadcastradio.V2_0.IAnnouncementListener.kInterfaceName);
                    onListUpdated(android.hardware.broadcastradio.V2_0.Announcement.readVectorFromParcel(hwParcel));
                    return;
                case 256067662:
