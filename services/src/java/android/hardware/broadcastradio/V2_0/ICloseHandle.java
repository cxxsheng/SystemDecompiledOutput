...
public interface ICloseHandle extends android.hidl.base.V1_0.IBase {
    public static final java.lang.String kInterfaceName = "android.hardware.broadcastradio@2.0::ICloseHandle";
    ...
    static android.hardware.broadcastradio.V2_0.ICloseHandle asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.broadcastradio.V2_0.ICloseHandle)) {
            return (android.hardware.broadcastradio.V2_0.ICloseHandle) queryLocalInterface;
        }
        android.hardware.broadcastradio.V2_0.ICloseHandle.Proxy proxy = new android.hardware.broadcastradio.V2_0.ICloseHandle.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.broadcastradio.V2_0.ICloseHandle castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.broadcastradio.V2_0.ICloseHandle getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.broadcastradio.V2_0.ICloseHandle getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.broadcastradio.V2_0.ICloseHandle getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.broadcastradio.V2_0.ICloseHandle getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.broadcastradio.V2_0.ICloseHandle {
        ...
        public void close() throws android.os.RemoteException {
            ...
            hwParcel.writeInterfaceToken(android.hardware.broadcastradio.V2_0.ICloseHandle.kInterfaceName);
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.broadcastradio.V2_0.ICloseHandle {
        @Override // android.hardware.broadcastradio.V2_0.ICloseHandle, android.hidl.base.V1_0.IBase
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.broadcastradio.V2_0.ICloseHandle.kInterfaceName, android.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public final java.util.ArrayList<byte[]> getHashChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(new byte[]{-27, -12, -106, 2, -112, -76, -13, 8, -111, 99, -35, 67, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_CLASSSPECIFIC_ENDPOINT, 30, 26, 3, 44, com.android.server.usb.descriptors.UsbASFormat.EXT_FORMAT_TYPE_I, -23, -67, -73, -106, -25, 90, -121, -4, 124, 88, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_CAPABILITY, -62, 98, -77}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_PHYSICAL, -17, 5, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_CLASSSPECIFIC_INTERFACE, -13, -51, 105, 87, 19, -109, com.android.server.usb.descriptors.UsbDescriptor.DESCRIPTORTYPE_CLASSSPECIFIC_INTERFACE, -72, 59, 24, -54, 76}));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.broadcastradio.V2_0.ICloseHandle.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                case 1:
                    hwParcel.enforceInterface(android.hardware.broadcastradio.V2_0.ICloseHandle.kInterfaceName);
                    close();
