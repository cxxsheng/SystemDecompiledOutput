...
public interface ITunerCallback extends android.hidl.base.V1_0.IBase {
    public static final java.lang.String kInterfaceName = "android.hardware.broadcastradio@2.0::ITunerCallback";
    ...
    void onCurrentProgramInfoChanged(android.hardware.broadcastradio.V2_0.ProgramInfo programInfo) throws android.os.RemoteException;

    void onParametersUpdated(java.util.ArrayList<android.hardware.broadcastradio.V2_0.VendorKeyValue> arrayList) throws android.os.RemoteException;

    void onProgramListUpdated(android.hardware.broadcastradio.V2_0.ProgramListChunk programListChunk) throws android.os.RemoteException;

    void onTuneFailed(int i, android.hardware.broadcastradio.V2_0.ProgramSelector programSelector) throws android.os.RemoteException;
    ...
    static android.hardware.broadcastradio.V2_0.ITunerCallback asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.broadcastradio.V2_0.ITunerCallback)) {
            return (android.hardware.broadcastradio.V2_0.ITunerCallback) queryLocalInterface;
        }
        android.hardware.broadcastradio.V2_0.ITunerCallback.Proxy proxy = new android.hardware.broadcastradio.V2_0.ITunerCallback.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.broadcastradio.V2_0.ITunerCallback castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.broadcastradio.V2_0.ITunerCallback getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.broadcastradio.V2_0.ITunerCallback getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.broadcastradio.V2_0.ITunerCallback getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hardware.broadcastradio.V2_0.ITunerCallback getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hardware.broadcastradio.V2_0.ITunerCallback {
        ...
        public void onTuneFailed(int i, android.hardware.broadcastradio.V2_0.ProgramSelector programSelector) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.broadcastradio.V2_0.ITunerCallback.kInterfaceName);
        ...
        @Override // android.hardware.broadcastradio.V2_0.ITunerCallback
        public void onCurrentProgramInfoChanged(android.hardware.broadcastradio.V2_0.ProgramInfo programInfo) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.broadcastradio.V2_0.ITunerCallback.kInterfaceName);
        ...
        @Override // android.hardware.broadcastradio.V2_0.ITunerCallback
        public void onProgramListUpdated(android.hardware.broadcastradio.V2_0.ProgramListChunk programListChunk) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.broadcastradio.V2_0.ITunerCallback.kInterfaceName);
        ...
        @Override // android.hardware.broadcastradio.V2_0.ITunerCallback
        public void onParametersUpdated(java.util.ArrayList<android.hardware.broadcastradio.V2_0.VendorKeyValue> arrayList) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.broadcastradio.V2_0.ITunerCallback.kInterfaceName);
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.broadcastradio.V2_0.ITunerCallback {
        @Override // android.hardware.broadcastradio.V2_0.ITunerCallback, android.hidl.base.V1_0.IBase
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hardware.broadcastradio.V2_0.ITunerCallback.kInterfaceName, android.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.broadcastradio.V2_0.ITunerCallback.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                case 1:
                    hwParcel.enforceInterface(android.hardware.broadcastradio.V2_0.ITunerCallback.kInterfaceName);
                ...
                case 5:
                    hwParcel.enforceInterface(android.hardware.broadcastradio.V2_0.ITunerCallback.kInterfaceName);
                    onParametersUpdated(android.hardware.broadcastradio.V2_0.VendorKeyValue.readVectorFromParcel(hwParcel));
                    return;
                case 256067662:
