...
public interface ITunerSession extends android.hidl.base.V1_0.IBase {
    ...
    static android.hardware.broadcastradio.V2_0.ITunerSession asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hardware.broadcastradio.V2_0.ITunerSession)) {
            return (android.hardware.broadcastradio.V2_0.ITunerSession) queryLocalInterface;
        }
        android.hardware.broadcastradio.V2_0.ITunerSession.Proxy proxy = new android.hardware.broadcastradio.V2_0.ITunerSession.Proxy(iHwBinder);
        try {
    ...
    static android.hardware.broadcastradio.V2_0.ITunerSession castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hardware.broadcastradio.V2_0.ITunerSession getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hardware.broadcastradio.V2_0.ITunerSession getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hardware.broadcastradio.V2_0.ITunerSession getService(java.lang.String str) throws android.os.RemoteException {
    ...
    public static final class Proxy implements android.hardware.broadcastradio.V2_0.ITunerSession {
        ...
        public int tune(android.hardware.broadcastradio.V2_0.ProgramSelector programSelector) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.broadcastradio.V2_0.ITunerSession.kInterfaceName);
        ...
        @Override // android.hardware.broadcastradio.V2_0.ITunerSession
        public int scan(boolean z, boolean z2) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.broadcastradio.V2_0.ITunerSession.kInterfaceName);
        ...
        @Override // android.hardware.broadcastradio.V2_0.ITunerSession
        public int step(boolean z) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.broadcastradio.V2_0.ITunerSession.kInterfaceName);
            hwParcel.writeBool(z);
            android.os.HwParcel hwParcel2 = new android.os.HwParcel();
        ...
        @Override // android.hardware.broadcastradio.V2_0.ITunerSession
        public int startProgramListUpdates(android.hardware.broadcastradio.V2_0.ProgramFilter programFilter) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.broadcastradio.V2_0.ITunerSession.kInterfaceName);
        ...
        @Override // android.hardware.broadcastradio.V2_0.ITunerSession
        public void isConfigFlagSet(int i, android.hardware.broadcastradio.V2_0.ITunerSession.isConfigFlagSetCallback isconfigflagsetcallback) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.broadcastradio.V2_0.ITunerSession.kInterfaceName);
        ...
        @Override // android.hardware.broadcastradio.V2_0.ITunerSession
        public int setConfigFlag(int i, boolean z) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.broadcastradio.V2_0.ITunerSession.kInterfaceName);
            hwParcel.writeInt32(i);
            hwParcel.writeBool(z);
        ...
        @Override // android.hardware.broadcastradio.V2_0.ITunerSession
        public java.util.ArrayList<android.hardware.broadcastradio.V2_0.VendorKeyValue> setParameters(java.util.ArrayList<android.hardware.broadcastradio.V2_0.VendorKeyValue> arrayList) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.broadcastradio.V2_0.ITunerSession.kInterfaceName);
            android.hardware.broadcastradio.V2_0.VendorKeyValue.writeVectorToParcel(hwParcel, arrayList);
            android.os.HwParcel hwParcel2 = new android.os.HwParcel();
            try {
                this.mRemote.transact(9, hwParcel, hwParcel2, 0);
                hwParcel2.verifySuccess();
                hwParcel.releaseTemporaryStorage();
                return android.hardware.broadcastradio.V2_0.VendorKeyValue.readVectorFromParcel(hwParcel2);
            } finally {
                hwParcel2.release();
            }
        }
        ...
        @Override // android.hardware.broadcastradio.V2_0.ITunerSession
        public java.util.ArrayList<android.hardware.broadcastradio.V2_0.VendorKeyValue> getParameters(java.util.ArrayList<java.lang.String> arrayList) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hardware.broadcastradio.V2_0.ITunerSession.kInterfaceName);
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hardware.broadcastradio.V2_0.ITunerSession {
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hardware.broadcastradio.V2_0.ITunerSession.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, final android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                case 1:
                    hwParcel.enforceInterface(android.hardware.broadcastradio.V2_0.ITunerSession.kInterfaceName);
                ...
                case 7:
                    hwParcel.enforceInterface(android.hardware.broadcastradio.V2_0.ITunerSession.kInterfaceName);
                    isConfigFlagSet(hwParcel.readInt32(), new android.hardware.broadcastradio.V2_0.ITunerSession.isConfigFlagSetCallback() { // from class: android.hardware.broadcastradio.V2_0.ITunerSession.Stub.1
                ...
                case 9:
                    hwParcel.enforceInterface(android.hardware.broadcastradio.V2_0.ITunerSession.kInterfaceName);
                    java.util.ArrayList<android.hardware.broadcastradio.V2_0.VendorKeyValue> parameters = setParameters(android.hardware.broadcastradio.V2_0.VendorKeyValue.readVectorFromParcel(hwParcel));
                    hwParcel2.writeStatus(0);
                    android.hardware.broadcastradio.V2_0.VendorKeyValue.writeVectorToParcel(hwParcel2, parameters);
                    hwParcel2.send();
                    return;
                case 10:
                    hwParcel.enforceInterface(android.hardware.broadcastradio.V2_0.ITunerSession.kInterfaceName);
                    java.util.ArrayList<android.hardware.broadcastradio.V2_0.VendorKeyValue> parameters2 = getParameters(hwParcel.readStringVector());
                    hwParcel2.writeStatus(0);
                    android.hardware.broadcastradio.V2_0.VendorKeyValue.writeVectorToParcel(hwParcel2, parameters2);
                    hwParcel2.send();
                    return;
                case 11:
                    hwParcel.enforceInterface(android.hardware.broadcastradio.V2_0.ITunerSession.kInterfaceName);
