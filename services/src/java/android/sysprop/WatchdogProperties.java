...
public final class WatchdogProperties {
    ...
    public static java.util.Optional<java.lang.Integer> fatal_count() {
        return java.util.Optional.ofNullable(tryParseInteger(android.os.SystemProperties.get("framework_watchdog.fatal_count")));
    }

    public static java.util.Optional<java.lang.Integer> fatal_window_seconds() {
        return java.util.Optional.ofNullable(tryParseInteger(android.os.SystemProperties.get("framework_watchdog.fatal_window.second")));
    }

    public static java.util.Optional<java.lang.Boolean> should_ignore_fatal_count() {
        return java.util.Optional.ofNullable(tryParseBoolean(android.os.SystemProperties.get("persist.debug.framework_watchdog.fatal_ignore")));
    }
}
