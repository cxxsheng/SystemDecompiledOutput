...
public interface IServiceManager extends android.hidl.manager.V1_1.IServiceManager {
    ...
    static android.hidl.manager.V1_2.IServiceManager asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hidl.manager.V1_2.IServiceManager)) {
            return (android.hidl.manager.V1_2.IServiceManager) queryLocalInterface;
        }
        android.hidl.manager.V1_2.IServiceManager.Proxy proxy = new android.hidl.manager.V1_2.IServiceManager.Proxy(iHwBinder);
        try {
    ...
    static android.hidl.manager.V1_2.IServiceManager castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hidl.manager.V1_2.IServiceManager getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hidl.manager.V1_2.IServiceManager getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hidl.manager.V1_2.IServiceManager getService(java.lang.String str) throws android.os.RemoteException {
    ...
    public static final class Proxy implements android.hidl.manager.V1_2.IServiceManager {
        ...
        public boolean registerClientCallback(java.lang.String str, java.lang.String str2, android.hidl.base.V1_0.IBase iBase, android.hidl.manager.V1_2.IClientCallback iClientCallback) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hidl.manager.V1_2.IServiceManager.kInterfaceName);
            hwParcel.writeString(str);
            hwParcel.writeString(str2);
            hwParcel.writeStrongBinder(iBase == null ? null : iBase.asBinder());
        ...
        @Override // android.hidl.manager.V1_2.IServiceManager
        public boolean unregisterClientCallback(android.hidl.base.V1_0.IBase iBase, android.hidl.manager.V1_2.IClientCallback iClientCallback) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hidl.manager.V1_2.IServiceManager.kInterfaceName);
            hwParcel.writeStrongBinder(iBase == null ? null : iBase.asBinder());
            hwParcel.writeStrongBinder(iClientCallback != null ? iClientCallback.asBinder() : null);
        ...
        @Override // android.hidl.manager.V1_2.IServiceManager
        public boolean addWithChain(java.lang.String str, android.hidl.base.V1_0.IBase iBase, java.util.ArrayList<java.lang.String> arrayList) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hidl.manager.V1_2.IServiceManager.kInterfaceName);
            hwParcel.writeString(str);
            hwParcel.writeStrongBinder(iBase == null ? null : iBase.asBinder());
        ...
        @Override // android.hidl.manager.V1_2.IServiceManager
        public boolean tryUnregister(java.lang.String str, java.lang.String str2, android.hidl.base.V1_0.IBase iBase) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hidl.manager.V1_2.IServiceManager.kInterfaceName);
            hwParcel.writeString(str);
            hwParcel.writeString(str2);
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hidl.manager.V1_2.IServiceManager {
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hidl.manager.V1_2.IServiceManager.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                ...
                case 9:
                    ...
                    return;
                case 10:
                    hwParcel.enforceInterface(android.hidl.manager.V1_2.IServiceManager.kInterfaceName);
                    boolean registerClientCallback = registerClientCallback(hwParcel.readString(), hwParcel.readString(), android.hidl.base.V1_0.IBase.asInterface(hwParcel.readStrongBinder()), android.hidl.manager.V1_2.IClientCallback.asInterface(hwParcel.readStrongBinder()));
                    hwParcel2.writeStatus(0);
                ...
                case 11:
                    hwParcel.enforceInterface(android.hidl.manager.V1_2.IServiceManager.kInterfaceName);
                    boolean unregisterClientCallback = unregisterClientCallback(android.hidl.base.V1_0.IBase.asInterface(hwParcel.readStrongBinder()), android.hidl.manager.V1_2.IClientCallback.asInterface(hwParcel.readStrongBinder()));
                    hwParcel2.writeStatus(0);
                ...
                case 12:
                    hwParcel.enforceInterface(android.hidl.manager.V1_2.IServiceManager.kInterfaceName);
                    boolean addWithChain = addWithChain(hwParcel.readString(), android.hidl.base.V1_0.IBase.asInterface(hwParcel.readStrongBinder()), hwParcel.readStringVector());
                    hwParcel2.writeStatus(0);
                ...
                case 14:
                    hwParcel.enforceInterface(android.hidl.manager.V1_2.IServiceManager.kInterfaceName);
                    boolean tryUnregister = tryUnregister(hwParcel.readString(), hwParcel.readString(), android.hidl.base.V1_0.IBase.asInterface(hwParcel.readStrongBinder()));
                    hwParcel2.writeStatus(0);
