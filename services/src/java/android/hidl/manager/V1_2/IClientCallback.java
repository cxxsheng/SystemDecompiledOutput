...
public interface IClientCallback extends android.hidl.base.V1_0.IBase {
    public static final java.lang.String kInterfaceName = "android.hidl.manager@1.2::IClientCallback";
    ...
    void onClients(android.hidl.base.V1_0.IBase iBase, boolean z) throws android.os.RemoteException;
    ...
    static android.hidl.manager.V1_2.IClientCallback asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hidl.manager.V1_2.IClientCallback)) {
            return (android.hidl.manager.V1_2.IClientCallback) queryLocalInterface;
        }
        android.hidl.manager.V1_2.IClientCallback.Proxy proxy = new android.hidl.manager.V1_2.IClientCallback.Proxy(iHwBinder);
        try {
    ...
    static android.hidl.manager.V1_2.IClientCallback castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hidl.manager.V1_2.IClientCallback getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hidl.manager.V1_2.IClientCallback getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hidl.manager.V1_2.IClientCallback getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hidl.manager.V1_2.IClientCallback getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hidl.manager.V1_2.IClientCallback {
        ...
        public void onClients(android.hidl.base.V1_0.IBase iBase, boolean z) throws android.os.RemoteException {
            android.os.HwParcel hwParcel = new android.os.HwParcel();
            hwParcel.writeInterfaceToken(android.hidl.manager.V1_2.IClientCallback.kInterfaceName);
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hidl.manager.V1_2.IClientCallback {
        @Override // android.hidl.manager.V1_2.IClientCallback, android.hidl.base.V1_0.IBase
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hidl.manager.V1_2.IClientCallback.kInterfaceName, android.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hidl.manager.V1_2.IClientCallback.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
        ...
        public void onTransact(int i, android.os.HwParcel hwParcel, android.os.HwParcel hwParcel2, int i2) throws android.os.RemoteException {
            switch (i) {
                case 1:
                    hwParcel.enforceInterface(android.hidl.manager.V1_2.IClientCallback.kInterfaceName);
                    onClients(android.hidl.base.V1_0.IBase.asInterface(hwParcel.readStrongBinder()), hwParcel.readBool());
                    return;
                case 256067662:
