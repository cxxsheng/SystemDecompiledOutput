...
public interface IBase extends android.os.IHwInterface {
    ...
    static android.hidl.base.V1_0.IBase asInterface(android.os.IHwBinder iHwBinder) {
        if (iHwBinder == null) {
            return null;
        }
        android.os.IHwInterface queryLocalInterface = iHwBinder.queryLocalInterface(kInterfaceName);
        if (queryLocalInterface != null && (queryLocalInterface instanceof android.hidl.base.V1_0.IBase)) {
            return (android.hidl.base.V1_0.IBase) queryLocalInterface;
        }
        android.hidl.base.V1_0.IBase.Proxy proxy = new android.hidl.base.V1_0.IBase.Proxy(iHwBinder);
        try {
    ...
    static android.hidl.base.V1_0.IBase castFrom(android.os.IHwInterface iHwInterface) {
    ...
    static android.hidl.base.V1_0.IBase getService(java.lang.String str, boolean z) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str, z));
    }

    static android.hidl.base.V1_0.IBase getService(boolean z) throws android.os.RemoteException {
        return getService("default", z);
    }

    @java.lang.Deprecated
    static android.hidl.base.V1_0.IBase getService(java.lang.String str) throws android.os.RemoteException {
        return asInterface(android.os.HwBinder.getService(kInterfaceName, str));
    }

    @java.lang.Deprecated
    static android.hidl.base.V1_0.IBase getService() throws android.os.RemoteException {
        return getService("default");
    }

    public static final class Proxy implements android.hidl.base.V1_0.IBase {
    ...
    public static abstract class Stub extends android.os.HwBinder implements android.hidl.base.V1_0.IBase {
        @Override // android.hidl.base.V1_0.IBase
        public android.os.IHwBinder asBinder() {
            return this;
        }
        ...
        public final java.util.ArrayList<java.lang.String> interfaceChain() {
            return new java.util.ArrayList<>(java.util.Arrays.asList(android.hidl.base.V1_0.IBase.kInterfaceName));
        }
        ...
        public android.os.IHwInterface queryLocalInterface(java.lang.String str) {
            if (android.hidl.base.V1_0.IBase.kInterfaceName.equals(str)) {
                return this;
            }
            return null;
        }
