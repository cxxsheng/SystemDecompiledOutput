...
public class Array2DRowRealMatrix extends org.apache.commons.math.linear.AbstractRealMatrix implements java.io.Serializable {
    ...
    public Array2DRowRealMatrix(int i, int i2) throws java.lang.IllegalArgumentException {
        super(i, i2);
        this.data = (double[][]) java.lang.reflect.Array.newInstance((java.lang.Class<?>) java.lang.Double.TYPE, i, i2);
    }

    public Array2DRowRealMatrix(double[][] dArr) throws java.lang.IllegalArgumentException, java.lang.NullPointerException {
        copyIn(dArr);
    }

    public Array2DRowRealMatrix(double[][] dArr, boolean z) throws java.lang.IllegalArgumentException, java.lang.NullPointerException {
        if (z) {
            copyIn(dArr);
            return;
        }
    ...
    public org.apache.commons.math.linear.RealMatrix createMatrix(int i, int i2) throws java.lang.IllegalArgumentException {
        return new org.apache.commons.math.linear.Array2DRowRealMatrix(i, i2);
    }
    ...
    public org.apache.commons.math.linear.RealMatrix add(org.apache.commons.math.linear.RealMatrix realMatrix) throws java.lang.IllegalArgumentException {
        try {
            return add((org.apache.commons.math.linear.Array2DRowRealMatrix) realMatrix);
        } catch (java.lang.ClassCastException e) {
            return super.add(realMatrix);
        }
    }

    public org.apache.commons.math.linear.Array2DRowRealMatrix add(org.apache.commons.math.linear.Array2DRowRealMatrix array2DRowRealMatrix) throws java.lang.IllegalArgumentException {
        org.apache.commons.math.linear.MatrixUtils.checkAdditionCompatible(this, array2DRowRealMatrix);
    ...
    public org.apache.commons.math.linear.RealMatrix subtract(org.apache.commons.math.linear.RealMatrix realMatrix) throws java.lang.IllegalArgumentException {
        try {
            return subtract((org.apache.commons.math.linear.Array2DRowRealMatrix) realMatrix);
        } catch (java.lang.ClassCastException e) {
            return super.subtract(realMatrix);
        }
    }

    public org.apache.commons.math.linear.Array2DRowRealMatrix subtract(org.apache.commons.math.linear.Array2DRowRealMatrix array2DRowRealMatrix) throws java.lang.IllegalArgumentException {
        org.apache.commons.math.linear.MatrixUtils.checkSubtractionCompatible(this, array2DRowRealMatrix);
        int rowDimension = getRowDimension();
        int columnDimension = getColumnDimension();
        double[][] dArr = (double[][]) java.lang.reflect.Array.newInstance((java.lang.Class<?>) java.lang.Double.TYPE, rowDimension, columnDimension);
        for (int i = 0; i < rowDimension; i++) {
    ...
    public org.apache.commons.math.linear.RealMatrix multiply(org.apache.commons.math.linear.RealMatrix realMatrix) throws java.lang.IllegalArgumentException {
        try {
            return multiply((org.apache.commons.math.linear.Array2DRowRealMatrix) realMatrix);
        } catch (java.lang.ClassCastException e) {
            return super.multiply(realMatrix);
        }
    }

    public org.apache.commons.math.linear.Array2DRowRealMatrix multiply(org.apache.commons.math.linear.Array2DRowRealMatrix array2DRowRealMatrix) throws java.lang.IllegalArgumentException {
        org.apache.commons.math.linear.MatrixUtils.checkMultiplicationCompatible(this, array2DRowRealMatrix);
        int rowDimension = getRowDimension();
        ...
        while (i2 < rowDimension) {
            ...
            while (i3 < columnDimension) {
                ...
                for (int i4 = i; i4 < columnDimension2; i4++) {
                    d += dArr2[i4] * array2DRowRealMatrix.data[i4][i3];
                }
                dArr3[i3] = d;
                i3++;
                i = 0;
